...
this.plugins=a.plugins;this.pluginsLoading=a.pluginsLoading;this.visibility=d.computed(function(){return a.pluginsLoading()?"visible":"hidden"},this);this.onPluginLoadRequest=i.bind(this.onPluginLoadRequest,this);this.onPluginDisableRequest=i.bind(this.onPluginDisableRequest,this)}function F(){var a=f.data();this.packagesError=d.observable("");this.packages=a.packages;this.packagesLoading=a.packagesLoading;this.packagesReal=a.packagesReal;this.packagesMainUpdatable=a.packagesMainUpdatable;this.packagesCurrent=
...
d.observable(!1);this.licenseExpired=d.observable(0);this.licenseError=d.observable("");this.licenseTrigger=d.observable(!1)}function D(){this.oRequests={}}function q(){this.oRequests={};this.oRequests={}}function A(){this.oEmailsPicsHashes={};this.oServices={}}function ma(){A.call(this)}function G(a){w.call(this,"settings",a);this.menu=d.observableArray([]);this.oCurrentSubScreen=null}function Z(){w.call(this,"login",[O])}function aa(){G.call(this,[V,W])}function u(){this.oLocal=this.oLink=this.oPlugins=
this.oSettings=null;this.isLocalAutocomplete=!0;this.popupVisibility=d.observable(!1);this.iframe=j('<iframe style="display:none" src="javascript:;" />').appendTo("body");E.on("error",function(a){f&&(a&&a.originalEvent&&a.originalEvent.message)&&(c.log(""+a.originalEvent.message+" ("+a.originalEvent.filename+":"+a.originalEvent.lineno+")"),f.remote().jsError(c.emptyFunction,a.originalEvent.message,a.originalEvent.filename,a.originalEvent.lineno))})}function v(){u.call(this);this.oCache=this.oRemote=
this.oData=null}var l={},g={},k={},c={},n={},ba=d.observable(!0),P=d.observable(!0),s=null,Q=h.rainloopAppData||{},ca=h.rainloopI18N||{},da=j("html"),E=j(h),pa=j(h.document),R=[],ea=[],fa=[],S=h.Notification&&h.Notification.requestPermission?h.Notification:null,H=(navigator.userAgent||"").toLowerCase(),na=!1,oa=-1<H.indexOf("iphone")||-1<H.indexOf("ipod")||-1<H.indexOf("ipad"),H=-1<H.indexOf("android"),J=oa||H;da.addClass(J?"mobile":"no-mobile");var f=null;l.Defaults={};l.Values={};l.DataImages={};
...
a+"":""};c.isNonEmptyArray=function(a){return c.isArray(a)&&0<a.length};c.exportPath=function(a,b,e){for(var o=null,a=a.split("."),e=e||h;a.length&&(o=a.shift());)!a.length&&!c.isUnd(b)?e[o]=b:e=e[o]?e[o]:e[o]={}};c.pImport=function(a,b,e){a[b]=e};c.pExport=function(a,b,e){return c.isUnd(a[b])?e:a[b]};c.encodeHtml=function(a){return c.isNormal(a)?a.toString().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""};c.splitPlainText=function(a,
b){for(var e="",o="",d=a,f=0,g=0,b=c.isUnd(b)?100:b;d.length>b;)o=d.substring(0,b),f=o.lastIndexOf(" "),g=o.lastIndexOf("\n"),-1!==g&&(f=g),-1===f&&(f=b),e+=o.substring(0,f)+"\n",d=d.substring(f+1);return e+d};var T={};c.timeOutAction=function(a,b,e){c.isUnd(T[a])&&(T[a]=0);h.clearTimeout(T[a]);T[a]=h.setTimeout(b,e)};var ha={};c.timeOutActionSecond=function(a,b,e){ha[a]||(ha[a]=h.setTimeout(function(){b();ha[a]=0},e))};var x=!1;c.audio=function(a,b){if(!1===x)if(oa)x=null;else{var e=!1,c=!1,d=h.Audio?
...
h.width(),b=b?100*(b.size.width/a):null,null===b&&e&&(b=100*(d.width()/a)),null!==b&&(d.css({width:"",height:"",right:""+(100-b)+"%"}),ga.css({width:"",height:"",left:""+b+"%"}))};a&&d.width(a);d.resizable({minWidth:350,maxWidth:h.width()-250,handles:"e",resize:k,stop:k});k(null,null,!0);E.resize(i.throttle(function(a,b){if(c&&c()){var e=h.width();d.resizable("option","maxWidth",e-250);b&&(b.size&&b.size.width)&&f.local().set(g.ClientSideKeyName.MailBoxListSize,b.size.width);k(null,null,!0)}},400))};
...
i+"']();window.opener['"+i+"']=null}";g.document.getElementsByTagName("head")[0].appendChild(f)};c.settingsSaveHelperFunction=function(a,b,e,d){e=e||null;d=c.isUnd(d)?1E3:c.pInt(d);return function(c,f,h,j,qa){b.call(e,f&&f.Result?g.SaveSettingsStep.TrueResult:g.SaveSettingsStep.FalseResult);a&&a.call(e,c,f,h,j,qa);i.delay(function(){b.call(e,g.SaveSettingsStep.Idle)},d)}};c.settingsSaveHelperSimpleFunction=function(a,b){return c.settingsSaveHelperFunction(null,a,b,1E3)};c.resizeAndCrop=function(a,
...
f.reloadPluginList()};C.prototype.onPluginLoadRequest=function(a,b){g.StorageResultType.Success===a&&(b&&b.Result)&&s.showScreenPopup(N,[b.Result])};C.prototype.onPluginDisableRequest=function(a,b){g.StorageResultType.Success===a&&b&&!b.Result&&b.ErrorCode&&(g.Notification.UnsupportedPluginPackage===b.ErrorCode&&b.ErrorMessage&&""!==b.ErrorMessage?this.pluginsError(b.ErrorMessage):this.pluginsError(c.getNotification(b.ErrorCode)));f.reloadPluginList()};c.addSettingsViewModel(F,"AdminPackages","Packages",
"packages");F.prototype.onShow=function(){this.packagesError("")};F.prototype.onBuild=function(){f.reloadPackagesList()};F.prototype.requestHelper=function(a,b){var e=this;return function(d,h){if(g.StorageResultType.Success!==d||!h||!h.Result)h&&h.ErrorCode?e.packagesError(c.getNotification(h.ErrorCode)):e.packagesError(c.getNotification(b?g.Notification.CantInstallPackage:g.Notification.CantDeletePackage));i.each(f.data().packages(),function(b){b&&(a&&b.loading()&&a.file===b.file)&&(a.loading(!1),
b.loading(!1))});f.reloadPackagesList()}};F.prototype.deletePackage=function(a){a&&(a.loading(!0),f.remote().packageDelete(this.requestHelper(a,!1),a))};F.prototype.installPackage=function(a){a&&(a.loading(!0),f.remote().packageInstall(this.requestHelper(a,!0),a))};X.prototype.populateDataOnStart=function(){var a=f.settingsGet("Languages"),b=f.settingsGet("Themes");c.isArray(a)&&this.languages(a);c.isArray(b)&&this.themes(b);this.mainLanguage(f.settingsGet("Language"));this.mainTheme(f.settingsGet("Theme"));
...
function(a,b,c,d,j,k){var l=function(){g.StorageResultType.Success!==c&&na&&(c=g.StorageResultType.Unload);g.StorageResultType.Success===c&&(d&&!d.Result&&d.Logout)&&(h.__rlah_clear&&h.__rlah_clear(),f.loginAndLogoutReload(!0));a&&(n.runHook("ajax-default-response",[b,g.StorageResultType.Success===c?d:null,c,j,k]),a(c,g.StorageResultType.Success===c?d:null,j,b,k))};switch(c){case "success":c=g.StorageResultType.Success;break;case "abort":c=g.StorageResultType.Abort;break;default:c=g.StorageResultType.Error}g.StorageResultType.Error===
c?i.delay(l,300):l()};D.prototype.ajaxRequest=function(a,b,d,g,k){var l=this,n=""===g,p=(new h.Date).getTime(),q=null,m="",b=b||{},d=c.isNormal(d)?d:2E4,g=c.isUnd(g)?"":c.pString(g),k=c.isArray(k)?k:[];(m=b.Action||"")&&0<k.length&&i.each(k,function(a){l.oRequests[a]&&(l.oRequests[a].__aborted=!0,l.oRequests[a].abort&&l.oRequests[a].abort(),l.oRequests[a]=null)});n&&(b.XToken=f.settingsGet("Token"));q=j.ajax({type:n?"POST":"GET",url:f.link().ajax(g),async:!0,dataType:"json",data:n?b:{},headers:{},
timeout:d,global:!0});q.always(function(d,e){var f=!1;d&&d.Time&&(f=c.pInt(d.Time)>(new h.Date).getTime()-p);m&&l.oRequests[m]&&(l.oRequests[m].__aborted&&(e="abort"),l.oRequests[m]=null);l.defaultResponse(a,m,e,d,f,b)});m&&(0<k.length&&-1<c.inArray(m,k))&&(this.oRequests[m]&&(this.oRequests[m].__aborted=!0,this.oRequests[m].abort&&this.oRequests[m].abort(),this.oRequests[m]=null),this.oRequests[m]=q);return q};D.prototype.defaultRequest=function(a,b,d,f,g,h){d=d||{};d.Action=b;g=c.pString(g);n.runHook("ajax-default-request",
...
d=c.isUnd(this.oEmailsPicsHashes[a])?"":this.oEmailsPicsHashes[a];""===d?(b=b.substr(a.indexOf("@")+1),b=""!==b&&this.oServices[b]?this.oServices[b]:""):b=f.link().getUserPicUrlFromHash(d);return b};A.prototype.setServicesData=function(a){this.oServices=a};A.prototype.setEmailsPicsHashesData=function(a){this.oEmailsPicsHashes=a};i.extend(ma.prototype,A.prototype);i.extend(G.prototype,w.prototype);G.prototype.onRoute=function(a){var b=this,e=null,g=null,h=null,k=null;if(g=i.find(R,function(b){return b&&
b.__rlSettingsData&&a===b.__rlSettingsData.Route}))i.find(ea,function(a){return a&&a===g})&&(g=null),g&&i.find(fa,function(a){return a&&a===g})&&(g=null);g&&(g.__builded&&g.__vm?e=g.__vm:(h=j("#rl-content #rl-settings-subscreen"))&&1===h.length?(e=new g,k=j("<div></div>").addClass("rl-settings-view-model").hide().attr("data-bind",'template: {name: "'+g.__rlSettingsData.Template+'"}, i18nInit: true'),k.appendTo(h),e.data=f.data(),e.viewModelDom=k,e.__rlSettingsData=g.__rlSettingsData,g.__dom=k,g.__builded=
...
b:c.pString(d.subname);return[d.subname]}};return[["{subname}/",a],["{subname}",a],["",a]]};i.extend(Z.prototype,w.prototype);Z.prototype.onShow=function(){f.setTitle("")};i.extend(aa.prototype,G.prototype);aa.prototype.onShow=function(){f.setTitle("")};i.extend(u.prototype,ja.prototype);u.prototype.oSettings=null;u.prototype.oLink=null;u.prototype.download=function(a){J?this.iframe.attr("src",a):h.open(a)};u.prototype.link=function(){null===this.oLink&&(this.oLink=new p);return this.oLink};u.prototype.local=
...
null);i.delay(function(){c.windowResize()},1E3)};i.extend(v.prototype,u.prototype);v.prototype.oData=null;v.prototype.oRemote=null;v.prototype.oCache=null;v.prototype.data=function(){null===this.oData&&(this.oData=new Y);return this.oData};v.prototype.remote=function(){null===this.oRemote&&(this.oRemote=new q);return this.oRemote};v.prototype.cache=function(){null===this.oCache&&(this.oCache=new ma);return this.oCache};v.prototype.reloadDomainList=function(){f.data().domainsLoading(!0);f.remote().domainList(function(a,
b){f.data().domainsLoading(!1);if(g.StorageResultType.Success===a&&b&&b.Result){var c=i.map(b.Result,function(a,b){return{name:b,disabled:d.observable(!a),deleteAccess:d.observable(!1)}},this);f.data().domains(c)}})};v.prototype.reloadPluginList=function(){f.data().pluginsLoading(!0);f.remote().pluginList(function(a,b){f.data().pluginsLoading(!1);if(g.StorageResultType.Success===a&&b&&b.Result){var c=i.map(b.Result,function(a){return{name:a.Name,disabled:d.observable(!a.Enabled),configured:d.observable(!!a.Configured)}},
