...
d.message(null),f.reloadMessageList()};ca.prototype.onStart=function(){var a=f.data(),b=function(){d.windowResize()};(f.settingsGet("AllowAdditionalAccounts")||f.settingsGet("AllowIdentities"))&&f.accountsAndIdentities();i.delay(function(){f.quota()},5E3);i.delay(function(){"INBOX"!==a.currentFolderFullNameRaw()&&f.folderInformation("INBOX")},1E3);i.delay(function(){var b=f.data().spamFolder();b!==a.currentFolderFullNameRaw()&&f.folderInformation(b)},1500);i.delay(function(){var b=f.data().draftFolder();
b!==a.currentFolderFullNameRaw()&&f.folderInformation(b)},2E3);i.delay(function(){f.remote().appDelayStart(d.emptyFunction)},35E3);h.setInterval(function(){f.folderInformation("INBOX")},12E4);h.setInterval(function(){f.quota()},3E5);Q.toggleClass("rl-no-preview-pane",!a.usePreviewPane());a.folderList.subscribe(b);a.messageList.subscribe(b);a.message.subscribe(b);a.usePreviewPane.subscribe(function(a){Q.toggleClass("rl-no-preview-pane",!a)})};ca.prototype.onBuild=function(){m.bMobileDevice||i.defer(function(){d.initLayoutResizer("#rl-resizer-left",
"#rl-resizer-right","#rl-right",350,800,350,350,g.ClientSideKeyName.MailBoxListSize)})};ca.prototype.routes=function(){var a=function(a,c){c[0]=d.pString(c[0]);c[1]=d.pInt(c[1]);c[1]=0>=c[1]?1:c[1];c[2]=d.pString(c[2]);""===a&&(c[0]="Inbox",c[1]=1);return[decodeURI(c[0]),c[1],decodeURI(c[2])]};return[[/^([a-zA-Z0-9]+)\/p([1-9][0-9]*)\/(.+)\/?$/,{normalize_:a}],[/^([a-zA-Z0-9]+)\/p([1-9][0-9]*)\/?$/,{normalize_:a}],[/^([a-zA-Z0-9]+)\/(.+)\/?$/,{normalize_:function(a,c){c[0]=d.pString(c[0]);c[1]=d.pString(c[1]);
""===a&&(c[0]="Inbox");return[decodeURI(c[0]),1,decodeURI(c[1])]}}],[/^([^\/]*)$/,{normalize_:a}]]};i.extend(Qa.prototype,fa.prototype);Qa.prototype.onShow=function(){f.setTitle(this.sSettingsTitle)};i.extend(K.prototype,Ua.prototype);K.prototype.oSettings=null;K.prototype.oLink=null;K.prototype.download=function(a){var b=null,c=null;if((b=navigator.userAgent.toLowerCase())&&(-1<b.indexOf("chrome")||-1<b.indexOf("chrome")))if(b=document.createElement("a"),b.href=a,document.createEvent&&(c=document.createEvent("MouseEvents"))&&
c.initEvent&&b.dispatchEvent)return c.initEvent("click",!0,!0),b.dispatchEvent(c),!0;m.bMobileDevice?(h.open(a,"_self"),h.focus()):this.iframe.attr("src",a);return!0};K.prototype.link=function(){null===this.oLink&&(this.oLink=new C);return this.oLink};K.prototype.local=function(){null===this.oLocal&&(this.oLocal=new xa);return this.oLocal};K.prototype.settingsGet=function(a){null===this.oSettings&&(this.oSettings=d.isNormal(Ga)?Ga:{});return d.isUnd(this.oSettings[a])?null:this.oSettings[a]};K.prototype.settingsSet=
function(a,b){null===this.oSettings&&(this.oSettings=d.isNormal(Ga)?Ga:{});this.oSettings[a]=b};K.prototype.setTitle=function(a){a=(0<a.length?a+" - ":"")+this.settingsGet("Title")||"";a!==h.document.title&&(h.document.title=a)};K.prototype.loginAndLogoutReload=function(a,b){var c=d.pString(this.settingsGet("CustomLogoutLink")),e=!!this.settingsGet("InIframe"),a=d.isUnd(a)?!1:!!a,b=d.isUnd(b)?!1:!!b;a&&(b&&h.close)&&h.close();a&&""!==c&&h.location.href!==c?i.delay(function(){e&&h.parent?h.parent.location.href=
c:h.location.href=c},100):(o.routeOff(),o.setHash(f.link().root(),!0),o.routeOff(),i.delay(function(){e&&h.parent?h.parent.location.reload():h.location.reload()},100))};K.prototype.getAutocomplete=function(a,b,c){c([],a)};K.prototype.bootstart=function(){d.initOnStartOrLangChange(function(){d.initNotificationLanguage()},null);i.delay(function(){d.windowResize()},1E3)};i.extend(B.prototype,K.prototype);B.prototype.oData=null;B.prototype.oRemote=null;B.prototype.oCache=null;B.prototype.data=function(){null===
this.oData&&(this.oData=new U);return this.oData};B.prototype.remote=function(){null===this.oRemote&&(this.oRemote=new s);return this.oRemote};B.prototype.cache=function(){null===this.oCache&&(this.oCache=new x);return this.oCache};B.prototype.reloadFlagsCurrentMessageListAndMessageFromCache=function(){var a=f.cache();i.each(f.data().messageList(),function(b){a.initMessageFlagsFromCache(b)});a.initMessageFlagsFromCache(f.data().message())};B.prototype.reloadMessageList=function(a,b){var c=f.data(),
e=(c.messageListPage()-1)*c.messagesPerPage();(d.isUnd(b)?0:b)&&f.cache().setFolderHash(c.currentFolderFullNameRaw(),"");if(d.isUnd(a)?0:a)c.messageListPage(1),e=0;c.messageListLoading(!0);f.remote().messageList(function(a,b,f){g.StorageResultType.Success===a&&b&&b.Result?(c.messageListError(""),c.messageListLoading(!1),c.setMessageList(b,f)):g.StorageResultType.Unload===a?(c.messageListError(""),c.messageListLoading(!1)):g.StorageResultType.Abort!==a&&(c.messageList([]),c.messageListLoading(!1),
c.messageListError(b&&b.ErrorCode?d.getNotification(b.ErrorCode):d.i18n("NOTIFICATIONS/CANT_GET_MESSAGE_LIST")))},c.currentFolderFullNameRaw(),e,c.messagesPerPage(),c.messageListSearch())};B.prototype.recacheInboxMessageList=function(){f.remote().messageList(d.emptyFunction,"INBOX",0,f.data().messagesPerPage(),"",!0)};B.prototype.folders=function(a,b){this.data().foldersLoading(!0);this.remote().folders(i.bind(function(a,d,e){f.data().foldersLoading(!1);g.StorageResultType.Success===a?(this.data().setFolders(d,
e),b&&b(!0)):b&&b(!1)},this),a)};B.prototype.accountsAndIdentities=function(){var a=f.data();a.accountsLoading(!0);a.identitiesLoading(!0);f.remote().accountsAndIdentities(function(b,c){a.accountsLoading(!1);a.identitiesLoading(!1);if(g.StorageResultType.Success===b&&c.Result){var e=f.settingsGet("ParentEmail"),h=a.accountEmail(),e=""===e?h:e;d.isArray(c.Result.Accounts)&&a.accounts(i.map(c.Result.Accounts,function(a){return new Na(a,a!==e)}));d.isArray(c.Result.Identities)&&a.identities(i.map(c.Result.Identities,
function(a){var b=d.pString(a.Id),c=d.pString(a.Email),b=new ya(b,c,b!==h);b.name(d.pString(a.Name));b.replyTo(d.pString(a.ReplyTo));b.bcc(d.pString(a.Bcc));return b}))}})};B.prototype.quota=function(){this.remote().quota(function(a,b){g.StorageResultType.Success===a&&(b&&b.Result&&d.isArray(b.Result)&&2===b.Result.length&&d.isPosNumeric(b.Result[0],!0)&&d.isPosNumeric(b.Result[1],!0))&&(f.data().userQuota(1024*d.pInt(b.Result[1])),f.data().userUsageSize(1024*d.pInt(b.Result[0])))})};B.prototype.folderInformation=
