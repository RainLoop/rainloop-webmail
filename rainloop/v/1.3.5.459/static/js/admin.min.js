(function(g,j,d,ra,A,i){function n(){this.sBase="#/";this.sCdnStaticDomain=e.settingsGet("CdnStaticDomain");this.sVersion=e.settingsGet("Version");this.sSpecSuffix=e.settingsGet("AuthAccountHash")||"0";this.sServer="./?";this.sCdnStaticDomain=""===this.sCdnStaticDomain?this.sCdnStaticDomain:"/"===this.sCdnStaticDomain.substr(-1)?this.sCdnStaticDomain:this.sCdnStaticDomain+"/"}function N(){}function O(){}function P(){var a=i.find([O,N],function(a){return a.supported()});a&&(this.oDriver=new a)}function sa(){}
function u(a,b){this.sPosition=c.pString(a);this.sTemplate=c.pString(b);this.viewModelName="";this.viewModelVisibility=d.observable(!1);"Popups"===this.sPosition&&(this.modalVisibility=d.observable(!1));this.viewModelDom=null}function x(a,b){this.sScreenName=a;this.aViewModels=c.isArray(b)?b:[]}function q(){this.sDefaultScreenName="";this.oScreens={};this.oCurrentScreen=this.oBoot=null;this.popupVisibility=d.observable(!1);this.popupVisibility.subscribe(function(a){e&&e.popupVisibility(a)})}function t(a,
...
function S(){u.call(this,"Popups","PopupsLanguages");this.exp=d.observable(!1);this.languages=d.computed(function(){var a=e.data().mainLanguage();return i.map(e.data().languages(),function(b){return{key:b,selected:b===a,fullName:c.convertLangName(b)}})})}function T(){u.call(this,"Right","AdminLogin");this.login=d.observable("");this.password=d.observable("");this.loginError=d.observable(!1);this.passwordError=d.observable(!1);this.loginFocus=d.observable(!1);this.login.subscribe(function(){this.loginError(!1)},
...
this);this.saveNewAdminPasswordCommand=c.createCommand(this,function(){this.adminPasswordUpdateError(!1);this.adminPasswordUpdateSuccess(!1);e.remote().saveNewAdminPassword(this.onNewAdminPasswordResponse,{Password:this.adminPassword(),NewPassword:this.adminPasswordNew()})},function(){return""!==this.adminPassword()&&""!==this.adminPasswordNew()})}function ua(){var a=e.data();this.googleEnable=a.googleEnable;this.googleClientID=a.googleClientID;this.googleClientSecret=a.googleClientSecret;this.googleTrigger1=
...
function(a){return a&&""!==a.installed&&!!a.compare})},this);this.packagesAvailableForInstallation=d.computed(function(){return i.filter(this.packages(),function(a){return a&&""===a.installed})},this);this.visibility=d.computed(function(){return a.packagesLoading()?"visible":"hidden"},this)}function ga(){c.initDataConstructorBySettings(this)}function ha(){c.initDataConstructorBySettings(this);this.domainsLoading=d.observable(!1).extend({throttle:100});this.domains=d.observableArray([]);this.pluginsLoading=
...
{};this.oRequests={}}function E(){this.oEmailsPicsHashes={};this.oServices={}}function va(){E.call(this)}function K(a){x.call(this,"settings",a);this.menu=d.observableArray([]);this.oCurrentSubScreen=null}function ia(){x.call(this,"login",[T])}function ja(){K.call(this,[ea,fa]);this.resizeTrigger=d.computed(function(){return!0})}function v(){this.oLocal=this.oLink=this.oPlugins=this.oSettings=null;this.isLocalAutocomplete=!0;this.popupVisibility=d.observable(!1);this.iframe=j('<iframe style="display:none" src="javascript:;" />').appendTo("body");
H.on("error",function(a){e&&(a&&a.originalEvent&&a.originalEvent.message&&-1===c.inArray(a.originalEvent.message,["Uncaught Error: Error calling method on NPObject."]))&&e.remote().jsError(c.emptyFunction,a.originalEvent.message,a.originalEvent.filename,a.originalEvent.lineno,location&&location.toString?location.toString():"",U.attr("class"))})}function w(){v.call(this);this.oCache=this.oRemote=this.oData=null}var l={},f={},k={},c={},m={},V,W,ka,I,la,B,ma=d.observable(!0),X=d.observable(!0),r=null,
Y=g.rainloopAppData||{},na=g.rainloopI18N||{},U=j("html"),H=j(g),wa=j(g.document),Z=[],oa=[],pa=[],aa=g.Notification&&g.Notification.requestPermission?g.Notification:null,e=null;W=V=0;ka=!1;I=(navigator.userAgent||"").toLowerCase();la=-1<I.indexOf("iphone")||-1<I.indexOf("ipod")||-1<I.indexOf("ipad");I=-1<I.indexOf("android");B=la||I;l.Defaults={};l.Values={};l.DataImages={};l.Defaults.MessagesPerPage=20;l.Defaults.MessagesPerPageArray=[10,20,30,50,100];l.Defaults.DefaultAjaxTimeout=2E4;l.Defaults.SearchAjaxTimeout=
...
c.emptyFunction=function(){};c.isNormal=function(a){return!c.isUnd(a)&&!c.isNull(a)};c.windowResize=i.debounce(function(a){c.isUnd(a)?H.resize():g.setTimeout(function(){H.resize()},a)},50);c.isPosNumeric=function(a,b){return c.isNormal(a)?c.isUnd(b)||b?/^[0-9]*$/.test(a.toString()):/^[1-9]+[0-9]*$/.test(a.toString()):!1};c.pInt=function(a){return c.isNormal(a)&&""!==a?g.parseInt(a,10):0};c.pString=function(a){return c.isNormal(a)?a+"":""};c.isNonEmptyArray=function(a){return c.isArray(a)&&0<a.length};
c.exportPath=function(a,b,h){for(var s=null,a=a.split("."),h=h||g;a.length&&(s=a.shift());)!a.length&&!c.isUnd(b)?h[s]=b:h=h[s]?h[s]:h[s]={}};c.pImport=function(a,b,c){a[b]=c};c.pExport=function(a,b,h){return c.isUnd(a[b])?h:a[b]};c.encodeHtml=function(a){return c.isNormal(a)?a.toString().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""};c.splitPlainText=function(a,b){for(var h="",s="",d=a,e=0,f=0,b=c.isUnd(b)?100:b;d.length>b;)s=d.substring(0,
b),e=s.lastIndexOf(" "),f=s.lastIndexOf("\n"),-1!==f&&(e=f),-1===e&&(e=b),h+=s.substring(0,e)+"\n",d=d.substring(e+1);return h+d};var ba={};c.timeOutAction=function(a,b,h){c.isUnd(ba[a])&&(ba[a]=0);g.clearTimeout(ba[a]);ba[a]=g.setTimeout(b,h)};var qa={};c.timeOutActionSecond=function(a,b,c){qa[a]||(qa[a]=g.setTimeout(function(){b();qa[a]=0},c))};var z=!1;c.audio=function(a,b){if(!1===z)if(la)z=null;else{var c=!1,d=!1,e=g.Audio?new g.Audio:null;e&&e.canPlayType&&e.play?((c=""!==e.canPlayType('audio/mpeg; codecs="mp3"'))||
(d=""!==e.canPlayType('audio/ogg; codecs="vorbis"')),c||d?(z=e,z.preload="none",z.loop=!1,z.autoplay=!1,z.muted=!1,z.src=c?a:b):z=null):z=null}return z};c.hos=function(a,b){return a&&Object.hasOwnProperty?Object.hasOwnProperty.call(a,b):!1};c.i18n=function(a,b,h){var d="",a=c.isUnd(na[a])?c.isUnd(h)?a:h:na[a];if(!c.isUnd(b)&&!c.isNull(b))for(d in b)c.hos(b,d)&&(a=a.replace("%"+d+"%",b[d]));return a};c.i18nToNode=function(a){i.defer(function(){j(".i18n",a).each(function(){var a=j(this),h="";(h=a.data("i18n-text"))?
a.text(c.i18n(h)):((h=a.data("i18n-html"))&&a.html(c.i18n(h)),(h=a.data("i18n-placeholder"))&&a.attr("placeholder",c.i18n(h)))})})};c.i18nToDoc=function(){g.rainloopI18N&&(na=g.rainloopI18N||{},c.i18nToNode(wa),X(!X()));g.rainloopI18N={}};c.initOnStartOrLangChange=function(a,b,c){a&&a.call(b);c?X.subscribe(function(){a&&a.call(b);c.call(b)}):a&&X.subscribe(a,b)};c.inFocus=function(){var a=document.activeElement;return a&&("INPUT"===a.tagName||"TEXTAREA"===a.tagName||"IFRAME"===a.tagName||"DIV"===
...
c===f.EventKeyCode.S)a.preventDefault();else if((!b||!b.tagName||!b.tagName.match(/INPUT|TEXTAREA/i))&&a.ctrlKey&&c===f.EventKeyCode.A)g.getSelection?g.getSelection().removeAllRanges():g.document.selection&&g.document.selection.clear&&g.document.selection.clear(),a.preventDefault()}};c.createCommand=function(a,b,h){var s=b?function(){s.canExecute&&s.canExecute()&&b.apply(a,Array.prototype.slice.call(arguments));return!1}:function(){};s.enabled=d.observable(!0);h=c.isUnd(h)?!0:h;s.canExecute=c.isFunc(h)?
d.computed(function(){return s.enabled()&&h.call(a)}):d.computed(function(){return s.enabled()&&!!h});return s};c.initDataConstructorBySettings=function(a){a.ignoreFolderSubscribe=d.observable(!1);a.editorDefaultType=d.observable(f.EditorDefaultType.Html);a.showImages=d.observable(!1);a.showAnimation=d.observable(!1);a.allowThemes=d.observable(!0);a.allowCustomLogin=d.observable(!1);a.allowLanguagesOnSettings=d.observable(!0);a.allowLanguagesOnLogin=d.observable(!0);a.desktopNotifications=d.observable(!1);
a.useThreads=d.observable(!0);a.replySameFolder=d.observable(!0);a.usePreviewPane=d.observable(!0);a.useCheckboxesInList=d.observable(!0);a.showAnimation.subscribe(function(a){B?U.removeClass("rl-anim").addClass("no-rl-anim"):U.toggleClass("rl-anim",a).toggleClass("no-rl-anim",!a)});a.showAnimation.valueHasMutated();a.desktopNotificationsPermisions=d.computed(function(){a.desktopNotifications();var b=f.DesktopNotifications.NotSupported;if(aa&&aa.permission)switch(aa.permission.toLowerCase()){case "granted":b=
...
a.twitterConsumerKey=d.observable("");a.twitterConsumerSecret=d.observable("");a.googleEnable=d.observable(!1);a.googleClientID=d.observable("");a.googleClientSecret=d.observable("");a.dropboxEnable=d.observable(!1);a.dropboxApiKey=d.observable("");a.contactsIsSupported=d.observable(!1);a.contactsIsAllowed=d.observable(!1)};c.createMomentDate=function(a){return d.computed(function(){ma();return this.moment().fromNow()},a)};c.createMomentShortDate=function(a){return d.computed(function(){var a="",
...
e.local().get(f.ClientSideKeyName.ExpandedFolders);i.isArray(c)||(c=[]);b?(c.push(a),c=i.uniq(c)):c=i.without(c,a);e.local().set(f.ClientSideKeyName.ExpandedFolders,c)};c.initLayoutResizer=function(a,b,c,d,f,y,g,ca,da){var f=f||300,y=y||500,g=g||y-f/2,ca=ca||300,p=0,k=j(a),l=j(b),m=j(c),b=e.local().get(da)||g,n=function(a,b,c){if(b||c)a=m.width(),b=b?100*(b.size.width/a):null,null===b&&c&&(b=100*(k.width()/a)),null!==b&&(k.css({width:"",height:"",right:""+(100-b)+"%"}),l.css({width:"",height:"",left:""+
b+"%"}))};b&&k.width(b);p=m.width()-ca;p=y>p?p:y;k.resizable({minWidth:f,maxWidth:p,handles:"e",resize:n,stop:n});n(null,null,!0);H.resize(i.throttle(function(b,c){d&&(d()&&c&&c.element&&c.element[0].id&&"#"+c.element[0].id===""+a)&&(p=m.width()-ca,p=y>p?p:y,k.resizable("option","maxWidth",p),c.size&&c.size.width&&e.local().set(da,c.size.width),n(null,null,!0))},400))};c.initBlockquoteSwitcher=function(a){if(a){var b=j("blockquote:not(.rl-bq-switcher)",a).filter(function(){return 0===j(this).parent().closest("blockquote",
...
c.extendAsViewModel=function(a,b){b&&(b.__name=a,m.regViewModelHook(a,b),i.extend(b.prototype,u.prototype))};c.addSettingsViewModel=function(a,b,c,d,e){a.__rlSettingsData={Label:c,Template:b,Route:d,IsDefault:!!e};Z.push(a)};c.removeSettingsViewModel=function(a){oa.push(a)};c.disableSettingsViewModel=function(a){pa.push(a)};c.convertThemeName=function(a){return c.trim(a.replace(/[^a-zA-Z]/g," ").replace(/([A-Z])/g," $1").replace(/[\s]+/g," "))};c.convertLangName=function(a){return c.i18n("LANGS_NAMES/LANG_"+
...
i+"']){window.opener['"+i+"']();window.opener['"+i+"']=null}";f.document.getElementsByTagName("head")[0].appendChild(e)};c.settingsSaveHelperFunction=function(a,b,h,d){h=h||null;d=c.isUnd(d)?1E3:c.pInt(d);return function(c,e,g,j,da){b.call(h,e&&e.Result?f.SaveSettingsStep.TrueResult:f.SaveSettingsStep.FalseResult);a&&a.call(h,c,e,g,j,da);i.delay(function(){b.call(h,f.SaveSettingsStep.Idle)},d)}};c.settingsSaveHelperSimpleFunction=function(a,b){return c.settingsSaveHelperFunction(null,a,b,1E3)};c.resizeAndCrop=
...
return this};d.observable.fn.validateFunc=function(a){this.hasFuncError=d.observable(!1);c.isFunc(a)&&(this.subscribe(function(b){this.hasFuncError(!a(b))},this),this.valueHasMutated());return this};n.prototype.root=function(){return this.sBase};n.prototype.attachmentDownload=function(a){return this.sServer+"/Raw/"+this.sSpecSuffix+"/Download/"+a};n.prototype.attachmentPreview=function(a){return this.sServer+"/Raw/"+this.sSpecSuffix+"/View/"+a};n.prototype.attachmentPreviewAsPlain=function(a){return this.sServer+
"/Raw/"+this.sSpecSuffix+"/ViewAsPlain/"+a};n.prototype.upload=function(){return this.sServer+"/Upload/"+this.sSpecSuffix+"/"};n.prototype.uploadBackground=function(){return this.sServer+"/UploadBackground/"+this.sSpecSuffix+"/"};n.prototype.append=function(){return this.sServer+"/Append/"+this.sSpecSuffix+"/"};n.prototype.change=function(a){return this.sServer+"/Change/"+this.sSpecSuffix+"/"+g.encodeURIComponent(a)+"/"};n.prototype.ajax=function(a){return this.sServer+"/Ajax/"+this.sSpecSuffix+"/"+
a};n.prototype.messageViewLink=function(a){return this.sServer+"/Raw/"+this.sSpecSuffix+"/ViewAsPlain/"+a};n.prototype.messageDownloadLink=function(a){return this.sServer+"/Raw/"+this.sSpecSuffix+"/Download/"+a};n.prototype.inbox=function(){return this.sBase+"mailbox/Inbox"};n.prototype.settings=function(a){var b=this.sBase+"settings";!c.isUnd(a)&&""!==a&&(b+="/"+a);return b};n.prototype.admin=function(a){var b=this.sBase;switch(a){case "AdminDomains":b+="domains";break;case "AdminSecurity":b+="security";
break;case "AdminLicensing":b+="licensing"}return b};n.prototype.mailBox=function(a,b,h){var b=c.isNormal(b)?c.pInt(b):1,h=c.pString(h),d=this.sBase+"mailbox/";""!==a&&(d+=encodeURI(a));1<b&&(d=d.replace(/[\/]+$/,""),d+="/p"+b);""!==h&&(d=d.replace(/[\/]+$/,""),d+="/"+encodeURI(h));return d};n.prototype.phpInfo=function(){return this.sServer+"Info"};n.prototype.langLink=function(a){return this.sServer+"/Lang/0/"+encodeURI(a)+"/"+this.sVersion+"/"};n.prototype.getUserPicUrlFromHash=function(a){return this.sServer+
"/Raw/"+this.sSpecSuffix+"/UserPic/"+a+"/"+this.sVersion+"/"};n.prototype.emptyContactPic=function(){return(""===this.sCdnStaticDomain?"rainloop/v/":this.sCdnStaticDomain)+this.sVersion+"/static/css/images/empty-contact.png"};n.prototype.sound=function(a){return(""===this.sCdnStaticDomain?"rainloop/v/":this.sCdnStaticDomain)+this.sVersion+"/static/sounds/"+a};n.prototype.themePreviewLink=function(a){return(""===this.sCdnStaticDomain?"rainloop/v/":this.sCdnStaticDomain)+this.sVersion+"/themes/"+encodeURI(a)+
"/images/preview.png"};n.prototype.notificationMailIcon=function(){return(""===this.sCdnStaticDomain?"rainloop/v/":this.sCdnStaticDomain)+this.sVersion+"/static/css/images/icom-message-notification.png"};n.prototype.socialGoogle=function(){return this.sServer+"SocialGoogle"+(""!==this.sSpecSuffix?"/"+this.sSpecSuffix+"/":"")};n.prototype.socialTwitter=function(){return this.sServer+"SocialTwitter"+(""!==this.sSpecSuffix?"/"+this.sSpecSuffix+"/":"")};n.prototype.socialFacebook=function(){return this.sServer+
"SocialFacebook"+(""!==this.sSpecSuffix?"/"+this.sSpecSuffix+"/":"")};m.oViewModelsHooks={};m.oSimpleHooks={};m.regViewModelHook=function(a,b){b&&(b.__hookName=a)};m.addHook=function(a,b){c.isFunc(b)&&(c.isArray(m.oSimpleHooks[a])||(m.oSimpleHooks[a]=[]),m.oSimpleHooks[a].push(b))};m.runHook=function(a,b){c.isArray(m.oSimpleHooks[a])&&(b=b||[],i.each(m.oSimpleHooks[a],function(a){a.apply(null,b)}))};m.mainSettingsGet=function(a){return e?e.settingsGet(a):null};m.remoteRequest=function(a,b,c,d,f,g){e&&
e.remote().defaultRequest(a,b,c,d,f,g)};m.settingsGet=function(a,b){var d=m.mainSettingsGet("Plugins");return(d=d&&c.isUnd(d[a])?null:d[a])?c.isUnd(d[b])?null:d[b]:null};N.supported=function(){return!0};N.prototype.set=function(a,b){var c=j.cookie(l.Values.ClientSideCookieIndexName),d=null;try{(d=null===c?null:JSON.parse(c))||(d={}),d[a]=b,j.cookie(l.Values.ClientSideCookieIndexName,JSON.stringify(d),{expires:30})}catch(e){}return d};N.prototype.get=function(a){var b=j.cookie(l.Values.ClientSideCookieIndexName),
d=null;try{d=(d=null===b?null:JSON.parse(b))&&!c.isUnd(d[a])?d[a]:null}catch(e){}return d};O.supported=function(){return!!g.localStorage};O.prototype.set=function(a,b){var c=g.localStorage[l.Values.ClientSideCookieIndexName]||null,d=null;try{(d=null===c?null:JSON.parse(c))||(d={}),d[a]=b,g.localStorage[l.Values.ClientSideCookieIndexName]=JSON.stringify(d)}catch(e){}return d};O.prototype.get=function(a){var b=g.localStorage[l.Values.ClientSideCookieIndexName]||null,d=null;try{d=(d=null===b?null:JSON.parse(b))&&
!c.isUnd(d[a])?d[a]:null}catch(e){}return d};P.prototype.oDriver=null;P.prototype.set=function(a,b){return this.oDriver?this.oDriver.set("p"+a,b):!1};P.prototype.get=function(a){return this.oDriver?this.oDriver.get("p"+a):null};sa.prototype.bootstart=function(){};u.prototype.sPosition="";u.prototype.sTemplate="";u.prototype.viewModelName="";u.prototype.viewModelDom=null;u.prototype.viewModelTemplate=function(){return this.sTemplate};u.prototype.viewModelPosition=function(){return this.sPosition};
u.prototype.cancelCommand=u.prototype.closeCommand=function(){};x.prototype.oCross=null;x.prototype.sScreenName="";x.prototype.aViewModels=[];x.prototype.viewModels=function(){return this.aViewModels};x.prototype.screenName=function(){return this.sScreenName};x.prototype.routes=function(){return null};x.prototype.__cross=function(){return this.oCross};x.prototype.__start=function(){var a=this.routes(),b=null,d=null;c.isNonEmptyArray(a)&&(d=i.bind(this.onRoute||c.emptyFunction,this),b=ra.create(),
i.each(a,function(a){b.addRoute(a[0],d).rules=a[1]}),this.oCross=b)};q.prototype.sDefaultScreenName="";q.prototype.oScreens={};q.prototype.oBoot=null;q.prototype.oCurrentScreen=null;q.prototype.showLoading=function(){j("#rl-loading").show()};q.prototype.hideLoading=function(){j("#rl-loading").hide()};q.prototype.routeOff=function(){A.changed.active=!1};q.prototype.routeOn=function(){A.changed.active=!0};q.prototype.setBoot=function(a){c.isNormal(a)&&(this.oBoot=a);return this};q.prototype.screen=
...
function(a){if(a.__vm&&a.__dom&&"Popups"!==a.__vm.viewModelPosition()){a.__dom.hide();a.__vm.viewModelVisibility(false);d.delegateRun(a.__vm,"onHide")}})}d.oCurrentScreen=e;if(d.oCurrentScreen){d.delegateRun(d.oCurrentScreen,"onShow");m.runHook("screen-on-show",[d.oCurrentScreen.screenName(),d.oCurrentScreen]);c.isNonEmptyArray(d.oCurrentScreen.viewModels())&&i.each(d.oCurrentScreen.viewModels(),function(a){if(a.__vm&&a.__dom&&"Popups"!==a.__vm.viewModelPosition()){a.__dom.show();a.__vm.viewModelVisibility(true);
d.delegateRun(a.__vm,"onShow");m.runHook("view-model-on-show",[a.__name,a.__vm])}},d)}(f=e.__cross())&&f.parse(b)}))}};q.prototype.startScreens=function(a){i.each(a,function(a){var c=(a=new a)?a.screenName():"";a&&""!==c&&(""===this.sDefaultScreenName&&(this.sDefaultScreenName=c),this.oScreens[c]=a)},this);i.each(this.oScreens,function(a){a&&(!a.__started&&a.__start)&&(a.__started=!0,a.__start(),m.runHook("screen-pre-start",[a.screenName(),a]),this.delegateRun(a,"onStart"),m.runHook("screen-post-start",
[a.screenName(),a]))},this);a=ra.create();a.addRoute(/^([a-zA-Z0-9\-]*)\/?(.*)$/,i.bind(this.screenOnRoute,this));A.initialized.add(a.parse,a);A.changed.add(a.parse,a);A.init()};q.prototype.setHash=function(a,b){a="#"===a.substr(0,1)?a.substr(1):a;a="/"===a.substr(0,1)?a.substr(1):a;(c.isUnd(b)?0:b)?(A.changed.active=!1,A.setHash(a),A.changed.active=!0):(A.changed.active=!0,A.setHash(a))};q.prototype.bootstart=function(){this.oBoot&&this.oBoot.bootstart&&this.oBoot.bootstart();return this};r=new q;
t.newInstanceFromJson=function(a){var b=new t;return b.initByJson(a)?b:null};t.prototype.name="";t.prototype.email="";t.prototype.privateType=null;t.prototype.validate=function(){return""!==this.name||""!==this.email};t.prototype.hash=function(a){return"#"+(a?"":this.name)+"#"+this.email+"#"};t.prototype.clearDuplicateName=function(){this.name===this.email&&(this.name="")};t.prototype.type=function(){if(null===this.privateType&&(this.email&&"@facebook.com"===this.email.substr(-13)&&(this.privateType=
f.EmailType.Facebook),null===this.privateType))this.privateType=f.EmailType.Default;return this.privateType};t.prototype.search=function(a){return-1<(this.name+" "+this.email).toLowerCase().indexOf(a.toLowerCase())};t.prototype.parse=function(a){var a=c.trim(a),b=/(?:"([^"]+)")? ?<?(.*?@[^>,]+)>?,? ?/g.exec(a);b?(this.name=b[1]||"",this.email=b[2]||"",this.clearDuplicateName()):/^[^@]+@[^@]+$/.test(a)&&(this.name="",this.email=a)};t.prototype.initByJson=function(a){var b=!1;a&&"Object/Email"===a["@Object"]&&
(this.name=c.trim(a.Name),this.email=c.trim(a.Email),b=""!==this.email,this.clearDuplicateName());return b};t.prototype.toLine=function(a,b){var d="";""!==this.email&&(b=c.isUnd(b)?!1:!!b,a&&""!==this.name?d=b?'<a href="mailto:'+c.encodeHtml('"'+this.name+'" <'+this.email+">")+'" target="_blank" tabindex="-1">'+c.encodeHtml(this.name)+"</a>":this.name:(d=this.email,""!==this.name?d=b?c.encodeHtml('"'+this.name+'" <')+'<a href="mailto:'+c.encodeHtml('"'+this.name+'" <'+this.email+">")+'" target="_blank" tabindex="-1">'+
c.encodeHtml(d)+"</a>"+c.encodeHtml(">"):'"'+this.name+'" <'+d+">":b&&(d='<a href="mailto:'+c.encodeHtml(this.email)+'" target="_blank" tabindex="-1">'+c.encodeHtml(this.email)+"</a>")));return d};t.prototype.select2Result=function(){var a="",b=e.cache().getUserPic(this.email),a=""!==b?a+('<img class="select2-user-pic pull-left" src="'+c.encodeHtml(b)+'" />'):a+('<img class="select2-user-pic pull-left" src="'+e.link().emptyContactPic()+'" />');f.EmailType.Facebook===this.type()?(a+=""+(0<this.name.length?
this.name:this.email),a+='<i class="icon-facebook pull-right select2-icon-result" />'):a+=""+(0<this.name.length?this.email+' <span class="select2-subname">('+this.name+")</span>":this.email);return a+""};t.prototype.select2Selection=function(a){var b="";if(f.EmailType.Facebook===this.type()){if(b=0<this.name.length?this.name:this.email,""!==b)return j("<pan>").text(b).appendTo(a),a.append('<i class="icon-facebook select2-icon"></i>'),null}else b=0<this.name.length?this.name+" ("+this.email+")":this.email;
...
Q);Q.prototype.onPluginSettingsUpdateResponse=function(a,b){f.StorageResultType.Success===a&&b&&b.Result?this.cancelCommand():(this.saveError(""),b&&b.ErrorCode?this.saveError(c.getNotification(b.ErrorCode)):this.saveError(c.getNotification(f.Notification.CantSavePluginSettings)))};Q.prototype.onShow=function(a){this.name();this.readme();this.configures([]);a&&(this.name(a.Name),this.readme(a.Readme),a=a.Config,c.isNonEmptyArray(a)&&this.configures(i.map(a,function(a){return{value:d.observable(a[0]),
Name:a[1],Type:a[2],Label:a[3],Default:a[4],Desc:a[5]}})))};c.extendAsViewModel("PopupsActivateViewModel",R);R.prototype.onShow=function(){this.domain(e.settingsGet("AdminDomain"));this.activateProcess()||(this.key(""),this.activateText(""),this.activateText.isError(!1),this.activationSuccessed(!1),this.key.focus(!0))};R.prototype.validateSubscriptionKey=function(){var a=this.key();return""===a||!!/^RL[\d]+-[A-Z0-9\-]+Z$/.test(c.trim(a))};c.extendAsViewModel("PopupsLanguagesViewModel",S);S.prototype.onShow=
function(){this.exp(!0)};S.prototype.onHide=function(){this.exp(!1)};S.prototype.changeLanguage=function(a){e.data().mainLanguage(a);this.cancelCommand()};c.extendAsViewModel("AdminLoginViewModel",T);T.prototype.onShow=function(){r.routeOff();i.delay(i.bind(function(){this.loginFocus(!0)},this),100)};T.prototype.onHide=function(){this.loginFocus(!1)};c.extendAsViewModel("AdminMenuViewModel",ea);ea.prototype.link=function(a){return"#/"+a};c.extendAsViewModel("AdminPaneViewModel",fa);fa.prototype.logoutClick=
function(){e.remote().adminLogout(function(){e.loginAndLogoutReload()})};c.addSettingsViewModel(ta,"AdminGeneral","General","general",!0);ta.prototype.onBuild=function(){var a=this;i.delay(function(){var b=c.settingsSaveHelperSimpleFunction(a.titleTrigger,a),d=c.settingsSaveHelperSimpleFunction(a.languageTrigger,a),f=c.settingsSaveHelperSimpleFunction(a.themeTrigger,a);a.title.subscribe(function(a){e.remote().saveAdminConfig(b,{Title:c.trim(a)})});a.language.subscribe(function(a){e.remote().saveAdminConfig(d,
...
this.googleClientSecret(e.settingsGet("GoogleClientSecret"));this.dropboxEnable(!!e.settingsGet("AllowDropboxSocial"));this.dropboxApiKey(e.settingsGet("DropboxApiKey"));this.contactsIsSupported(!!e.settingsGet("ContactsIsSupported"));this.contactsIsAllowed(!!e.settingsGet("ContactsIsAllowed"))};i.extend(ha.prototype,ga.prototype);ha.prototype.populateDataOnStart=function(){ga.prototype.populateDataOnStart.call(this)};G.prototype.oRequests={};G.prototype.defaultResponse=function(a,b,d,j,k,y){var l=
function(){f.StorageResultType.Success!==d&&ka&&(d=f.StorageResultType.Unload);if(f.StorageResultType.Success===d&&j&&!j.Result){if(j&&-1<c.inArray(j.ErrorCode,[f.Notification.AuthError,f.Notification.AccessError,f.Notification.ConnectionError,f.Notification.DomainNotAllowed,f.Notification.AccountNotAllowed,f.Notification.MailServerError,f.Notification.UnknownNotification,f.Notification.UnknownError])&&V++,j&&f.Notification.InvalidToken===j.ErrorCode&&W++,10<W&&e.loginAndLogoutReload(!0),j.Logout||
7<V)g.__rlah_clear&&g.__rlah_clear(),e.loginAndLogoutReload(!0)}else f.StorageResultType.Success===d&&(j&&j.Result)&&(W=V=0);a&&(m.runHook("ajax-default-response",[b,f.StorageResultType.Success===d?j:null,d,k,y]),a(d,f.StorageResultType.Success===d?j:null,k,b,y))};switch(d){case "success":d=f.StorageResultType.Success;break;case "abort":d=f.StorageResultType.Abort;break;default:d=f.StorageResultType.Error}f.StorageResultType.Error===d?i.delay(l,300):l()};G.prototype.ajaxRequest=function(a,b,d,f,k){var l=
this,m=""===f,n=(new g.Date).getTime(),o=null,p="",b=b||{},d=c.isNormal(d)?d:2E4,f=c.isUnd(f)?"":c.pString(f),k=c.isArray(k)?k:[];(p=b.Action||"")&&0<k.length&&i.each(k,function(a){l.oRequests[a]&&(l.oRequests[a].__aborted=!0,l.oRequests[a].abort&&l.oRequests[a].abort(),l.oRequests[a]=null)});m&&(b.XToken=e.settingsGet("Token"));o=j.ajax({type:m?"POST":"GET",url:e.link().ajax(f),async:!0,dataType:"json",data:m?b:{},headers:{},timeout:d,global:!0});o.always(function(d,e){var f=!1;d&&d.Time&&(f=c.pInt(d.Time)>
(new g.Date).getTime()-n);p&&l.oRequests[p]&&(l.oRequests[p].__aborted&&(e="abort"),l.oRequests[p]=null);l.defaultResponse(a,p,e,d,f,b)});p&&(0<k.length&&-1<c.inArray(p,k))&&(this.oRequests[p]&&(this.oRequests[p].__aborted=!0,this.oRequests[p].abort&&this.oRequests[p].abort(),this.oRequests[p]=null),this.oRequests[p]=o);return o};G.prototype.defaultRequest=function(a,b,d,e,f,g){d=d||{};d.Action=b;f=c.pString(f);m.runHook("ajax-default-request",[b,d,f]);this.ajaxRequest(a,d,c.isUnd(e)?l.Defaults.DefaultAjaxTimeout:
...
d=c.isUnd(this.oEmailsPicsHashes[a])?"":this.oEmailsPicsHashes[a];""===d?(b=b.substr(a.indexOf("@")+1),b=""!==b&&this.oServices[b]?this.oServices[b]:""):b=e.link().getUserPicUrlFromHash(d);return b};E.prototype.setServicesData=function(a){this.oServices=a};E.prototype.setEmailsPicsHashesData=function(a){this.oEmailsPicsHashes=a};i.extend(va.prototype,E.prototype);i.extend(K.prototype,x.prototype);K.prototype.onRoute=function(a){var b=this,f=null,g=null,k=null,l=null;if(g=i.find(Z,function(b){return b&&
b.__rlSettingsData&&a===b.__rlSettingsData.Route}))i.find(oa,function(a){return a&&a===g})&&(g=null),g&&i.find(pa,function(a){return a&&a===g})&&(g=null);g&&(g.__builded&&g.__vm?f=g.__vm:(k=j("#rl-content #rl-settings-subscreen"))&&1===k.length?(f=new g,l=j("<div></div>").addClass("rl-settings-view-model").hide().attr("data-bind",'template: {name: "'+g.__rlSettingsData.Template+'"}, i18nInit: true'),l.appendTo(k),f.data=e.data(),f.viewModelDom=l,f.__rlSettingsData=g.__rlSettingsData,g.__dom=l,g.__builded=
...
c.isNormal(Y)?Y:{});this.oSettings[a]=b};v.prototype.setTitle=function(a){a=(0<a.length?a+" - ":"")+this.settingsGet("Title")||"";a!==g.document.title&&(g.document.title=a)};v.prototype.loginAndLogoutReload=function(a,b){var d=c.pString(this.settingsGet("CustomLogoutLink")),f=!!this.settingsGet("InIframe"),a=c.isUnd(a)?!1:!!a,b=c.isUnd(b)?!1:!!b;a&&(b&&g.close)&&g.close();a&&""!==d&&g.location.href!==d?i.defer(function(){f&&g.parent?g.parent.location.href=d:g.location.href=d}):(r.routeOff(),r.setHash(e.link().root(),
!0),r.routeOff(),i.defer(function(){f&&g.parent?g.parent.location.reload():g.location.reload()}))};v.prototype.getAutocomplete=function(a,b,c){c([],a)};v.prototype.bootstart=function(){c.initOnStartOrLangChange(function(){c.initNotificationLanguage()},null);i.delay(function(){c.windowResize()},1E3)};i.extend(w.prototype,v.prototype);w.prototype.oData=null;w.prototype.oRemote=null;w.prototype.oCache=null;w.prototype.data=function(){null===this.oData&&(this.oData=new ha);return this.oData};w.prototype.remote=
function(){null===this.oRemote&&(this.oRemote=new o);return this.oRemote};w.prototype.cache=function(){null===this.oCache&&(this.oCache=new va);return this.oCache};w.prototype.reloadDomainList=function(){e.data().domainsLoading(!0);e.remote().domainList(function(a,b){e.data().domainsLoading(!1);if(f.StorageResultType.Success===a&&b&&b.Result){var c=i.map(b.Result,function(a,b){return{name:b,disabled:d.observable(!a),deleteAccess:d.observable(!1)}},this);e.data().domains(c)}})};w.prototype.reloadPluginList=
...
e.data().licensing(!0)):e.data().licensing(!1)},a)};w.prototype.bootstart=function(){v.prototype.bootstart.call(this);e.data().populateDataOnStart();r.hideLoading();this.settingsGet("AllowAdminPanel")?this.settingsGet("Auth")?r.startScreens([ja]):r.startScreens([ia]):(r.routeOff(),r.setHash(e.link().root(),!0),r.routeOff(),i.defer(function(){g.location.href="/"}));g.SimplePace&&g.SimplePace.set(100)};e=new w;U.addClass(B?"mobile":"no-mobile");H.keydown(c.killCtrlAandS).keyup(c.killCtrlAandS);H.unload(function(){ka=
!0});g.rl=g.rl||{};g.rl.addHook=m.addHook;g.rl.settingsGet=m.mainSettingsGet;g.rl.remoteRequest=m.remoteRequest;g.rl.pluginSettingsGet=m.settingsGet;g.rl.addSettingsViewModel=c.addSettingsViewModel;g.rl.createCommand=c.createCommand;g.rl.EmailModel=t;g.rl.Enums=f;g.__RLBOOT=function(a){j(function(){g.rainloopTEMPLATES&&g.rainloopTEMPLATES[0]?(j("#rl-templates").html(g.rainloopTEMPLATES[0]),g.setInterval(function(){ma(!ma())},6E4),i.delay(function(){g.rainloopAppData={};g.rainloopI18N={};g.rainloopTEMPLATES=
{};r.setBoot(e).bootstart()},50)):a(!1);g.__RLBOOT=null})};g.SimplePace&&g.SimplePace.add(10)})(window,jQuery,ko,crossroads,hasher,_);