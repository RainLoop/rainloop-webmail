...
{FacebookEnable:a?"1":"0"})});a.facebookAppID.subscribe(function(a){f.remote().saveAdminConfig(b,{FacebookAppID:c.trim(a)})});a.facebookAppSecret.subscribe(function(a){f.remote().saveAdminConfig(d,{FacebookAppSecret:c.trim(a)})});a.twitterEnable.subscribe(function(a){f.remote().saveAdminConfig(c.emptyFunction,{TwitterEnable:a?"1":"0"})});a.twitterConsumerKey.subscribe(function(a){f.remote().saveAdminConfig(g,{TwitterConsumerKey:c.trim(a)})});a.twitterConsumerSecret.subscribe(function(a){f.remote().saveAdminConfig(h,
