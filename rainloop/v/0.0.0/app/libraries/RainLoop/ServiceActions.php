...
class ServiceActions
{
	...
	public function ServiceOwnCloudAuth() : string
	{
...
//		sleep(2);
	...
	public function ServiceExternalSso() : string
	{
			...
			!empty($sKey) && $sKey === \trim($this->oHttp->GetRequest('SsoKey', '')))
		{
			...
			$sResult = Api::GetUserSsoHash($sEmail, $sPassword);
