...
0;this.name=this.listName=this.imageHash="";this.emails=[];this.checked=e.observable(!1);this.selected=e.observable(!1);this.deleted=e.observable(!1)}function D(){this.fileName=this.mimeType="";this.estimatedSize=0;this.friendlySize="";this.isLinked=this.isInline=!1;this.mimeIndex=this.uid=this.folder=this.download=this.cidWithOutTags=this.cid=""}function N(a,b,d,l,f,s){this.id=a;this.isInline=c.isUnd(l)?!1:!!l;this.isLinked=c.isUnd(f)?!1:!!f;this.CID=c.isUnd(s)?"":s;this.fromMessage=!1;this.fileName=
...
d===a.uid)&&f.data().message(null);f.data().currentFolderFullNameRaw()===this.draftFolder()&&h.each(f.data().messageList(),function(a){a&&(b===a.folderFullNameRaw&&d===a.uid)&&a.deleted(true)});f.data().messageListIsNotCompleted(!0);f.remote().messagesDelete(function(){f.cache().setFolderHash(b,"");f.reloadMessageList()},this.draftFolder(),[this.draftUid()]);this.bReloadFolder=!1;r.hideScreenPopup(y)},function(){return this.isDraftFolderMessage()});this.sendMessageResponse=h.bind(this.sendMessageResponse,
this);this.saveMessageResponse=h.bind(this.saveMessageResponse,this);this.sendCommand=c.createCommand(this,function(){var a=this.to(),d=f.data().sentFolder(),e=[];if(0===a.length)this.emptyToError(!0);else if(f.data().replySameFolder()&&c.isArray(this.aDraftInfo)&&(3===this.aDraftInfo.length&&c.isNormal(this.aDraftInfo[2])&&0<this.aDraftInfo[2].length)&&(d=this.aDraftInfo[2]),""===d)r.showScreenPopup(X,[g.SetSystemFoldersNotification.Sent]);else{this.sendError(!1);this.sending(!0);this.bReloadFolder=
...
1)/2),!1,"...");g-2===d?k(g-1,!0):g-2>d&&k(Math.round((g+d)/2),!0,"...");1<b&&k(1,!1);g>d&&k(g,!0)}return f},this);this.checkAll=e.computed({read:function(){return 0<f.data().messageListCheckedOrSelected().length},write:function(a){a=!!a;h.each(f.data().messageList(),function(d){d.checked(a)});a||f.data().message(null)}});this.inputMessageListSearchFocus=e.observable(!1);this.sLastSearchValue="";this.inputProxyMessageListSearch=e.computed({read:this.mainMessageListSearch,write:function(a){this.sLastSearchValue=
...
this.messageListEndFolder()},this);this.isTrashFolder=e.computed(function(){return f.data().trashFolder()===this.messageListEndFolder()},this);this.canBeMoved=this.hasCheckedOrSelectedLines;this.clearCommand=c.createCommand(this,function(){r.showScreenPopup(va,[f.data().currentFolder()])});this.multyForwardCommand=c.createCommand(this,function(){r.showScreenPopup(y,[g.ComposeType.ForwardAsAttachment,f.data().messageListCheckedOrSelected()])},this.canBeMoved);this.deleteWithoutMoveCommand=c.createCommand(this,
...
c.createCommand(this,function(){this.changeProcess(!0);this.passwordUpdateError(!1);this.passwordUpdateSuccess(!1);f.remote().changePassword(this.onChangePasswordResponse,this.currentPassword(),this.newPassword())},function(){return!this.changeProcess()&&""!==this.currentPassword()&&""!==this.newPassword()});this.onChangePasswordResponse=h.bind(this.onChangePasswordResponse,this)}function S(){var a=f.data();this.ignoreFolderSubscribe=a.ignoreFolderSubscribe;this.foldersListError=a.foldersListError;
...
this.customThemeUploaderButton=e.observable(null);this.showCustomThemeConfig=e.computed(function(){return"Custom"===this.mainTheme()},this);this.showCustomThemeConfig.subscribe(function(){c.windowResize()});this.themeTrigger=e.observable(g.SaveSettingsStep.Idle).extend({throttle:100});this.oLastAjax=null;this.iTimer=0;f.data().theme.subscribe(function(b){h.each(this.themesObjects(),function(a){a.selected(b===a.name)});var d=i("#rlThemeLink"),l=i("#rlThemeStyle"),e=d.attr("href");e||(e=l.attr("data-href"));
e&&(e=e.toString().replace(/\/-\/[^\/]+\/\-\//,"/-/"+b+"/-/"),e=e.toString().replace(/\/Css\/[^\/]+\/User\//,"/Css/"+("Custom"===b&&j.__rlah?j.__rlah()||"0":"0")+"/User/"),"Json/"!==e.substring(e.length-5,e.length)&&(e+="Json/"),j.clearTimeout(a.iTimer),a.themeTrigger(g.SaveSettingsStep.Animate),this.oLastAjax&&this.oLastAjax.abort&&this.oLastAjax.abort(),this.oLastAjax=i.ajax({url:e,dataType:"json"}).done(function(b){if(b&&c.isArray(b)&&2===b.length){if(d&&d[0]&&(!l||!l[0]))l=i('<style id="rlThemeStyle"></style>'),
d.after(l),d.remove();l&&l[0]&&l.attr("data-href",e).attr("data-theme",b[0]).text(b[1]);a.themeTrigger(g.SaveSettingsStep.TrueResult)}}).always(function(){a.iTimer=j.setTimeout(function(){a.themeTrigger(g.SaveSettingsStep.Idle)},1E3);a.oLastAjax=null}));f.remote().saveSettings(null,{Theme:b})},this)}function Na(){c.initDataConstructorBySettings(this)}function T(){c.initDataConstructorBySettings(this);var a=function(a){return function(){var b=f.cache().getFolderFromCacheList(a());b&&b.type(g.FolderType.User)}},
...
write:function(a){r.setHash(f.link().mailBox(this.currentFolderFullNameHash(),1,c.trim(a.toString())))},owner:this});this.messageListError=e.observable("");this.messageListLoading=e.observable(!1);this.messageListIsNotCompleted=e.observable(!1);this.messageListCompleteLoadingThrottle=e.observable(!1).extend({throttle:200});this.messageListCompleteLoading=e.computed(function(){var a=this.messageListLoading(),b=this.messageListIsNotCompleted();return a||b},this);this.messageListCompleteLoading.subscribe(function(a){this.messageListCompleteLoadingThrottle(a)},
...
!(a instanceof jQuery)&&this.messagesBodiesDom(i(a))},this);this.messageActiveDom=e.observable(null);this.isMessageSelected=e.computed(function(){return null!==this.message()},this);this.currentMessage=e.observable(null);this.message.subscribe(function(a){null===a&&this.currentMessage(null)},this);this.messageListChecked=e.computed(function(){return h.filter(this.messageList(),function(a){return a.checked()})},this);this.messageListCheckedOrSelected=e.computed(function(){var a=this.messageListChecked(),
b=this.currentMessage();return h.union(a,b?[b]:[])},this);this.messageListCheckedUids=e.computed(function(){var a=[];h.each(this.messageListChecked(),function(b){b&&(a.push(b.uid),0<b.threadsLen()&&(0===b.parentUid()&&b.lastInCollapsedThread())&&(a=h.union(a,b.threads())))});return a},this);this.messageListCheckedOrSelectedUidsWithSubMails=e.computed(function(){var a=[];h.each(this.messageListCheckedOrSelected(),function(b){b&&(a.push(b.uid),0<b.threadsLen()&&(0===b.parentUid()&&b.lastInCollapsedThread())&&
(a=h.union(a,b.threads())))});return a},this);this.userQuota=e.observable(0);this.userUsageSize=e.observable(0);this.userUsageProc=e.computed(function(){var a=this.userQuota(),b=this.userUsageSize();return 0<a?Math.ceil(100*(b/a)):0},this);this.useKeyboardShortcuts=e.observable(!0);this.googleActions=e.observable(!1);this.googleLoggined=e.observable(!1);this.googleUserName=e.observable("");this.facebookActions=e.observable(!1);this.facebookLoggined=e.observable(!1);this.facebookUserName=e.observable("");
...
c.i18n("TITLES/SETTINGS")},this,function(){f.setTitle(this.sSettingsTitle)})}function I(){this.oLocal=this.oLink=this.oPlugins=this.oSettings=null;this.isLocalAutocomplete=!0;this.popupVisibility=e.observable(!1);this.iframe=i('<iframe style="display:none" src="javascript:;" />').appendTo("body");R.on("error",function(a){f&&(a&&a.originalEvent&&a.originalEvent.message)&&(c.log(""+a.originalEvent.message+" ("+a.originalEvent.filename+":"+a.originalEvent.lineno+")"),f.remote().jsError(c.emptyFunction,
a.originalEvent.message,a.originalEvent.filename,a.originalEvent.lineno))})}function A(){I.call(this);this.oCache=this.oRemote=this.oData=null;this.iSuggestionsLimit=c.pInt(this.settingsGet("SuggestionsLimit"));this.iSuggestionsLimit=0===this.iSuggestionsLimit?20:this.iSuggestionsLimit;this.quotaDebounce=h.debounce(this.quota,3E4)}var t={},g={},u={},c={},x={},ga={},wa=e.observable(!0),ha=e.observable(!0),r=null,Ba=j.rainloopAppData||{},Pa=j.rainloopI18N||{},Z=i("html"),R=i(j),Ca=i(j.document),Da=
[],Qa=[],Ra=[],ia=j.Notification&&j.Notification.requestPermission?j.Notification:null,Ea=(navigator.userAgent||"").toLowerCase(),Ya=-1<Ea.indexOf("iphone")||-1<Ea.indexOf("ipod")||-1<Ea.indexOf("ipad"),hb=-1<Ea.indexOf("android"),na=Ya||hb;Z.addClass(na?"mobile":"no-mobile");var f=null;t.Defaults={};t.Values={};t.DataImages={};t.Defaults.MessagesPerPage=25;t.Defaults.DefaultAjaxTimeout=2E4;t.Defaults.SearchAjaxTimeout=12E4;t.Defaults.SendMessageAjaxTimeout=2E5;t.Defaults.SaveMessageAjaxTimeout=2E5;
...
CantSaveSettings:501,CantSavePluginSettings:502,DomainAlreadyExists:601,CantInstallPackage:701,CantDeletePackage:702,InvalidPluginPackage:703,UnsupportedPluginPackage:704,LicensingServerIsUnavailable:710,LicensingExpired:711,LicensingBanned:712,AccountAlreadyExists:801,MailServerError:901,UnknownError:999};c.trim=i.trim;c.inArray=i.inArray;c.isArray=h.isArray;c.isFunc=h.isFunction;c.isUnd=h.isUndefined;c.isNull=h.isNull;c.emptyFunction=function(){};c.isNormal=function(a){return!c.isUnd(a)&&!c.isNull(a)};
c.windowResize=h.debounce(function(a){c.isUnd(a)?R.resize():j.setTimeout(function(){R.resize()},a)},50);c.isPosNumeric=function(a,b){return c.isNormal(a)?c.isUnd(b)||b?/^[0-9]*$/.test(a.toString()):/^[1-9]+[0-9]*$/.test(a.toString()):!1};c.pInt=function(a){return c.isNormal(a)&&""!==a?j.parseInt(a,10):0};c.pString=function(a){return c.isNormal(a)?a+"":""};c.isNonEmptyArray=function(a){return c.isArray(a)&&0<a.length};c.exportPath=function(a,b,d){for(var l=null,a=a.split("."),d=d||j;a.length&&(l=a.shift());)!a.length&&
!c.isUnd(b)?d[l]=b:d=d[l]?d[l]:d[l]={}};c.pImport=function(a,b,d){a[b]=d};c.pExport=function(a,b,d){return c.isUnd(a[b])?d:a[b]};c.encodeHtml=function(a){return c.isNormal(a)?a.toString().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""};c.splitPlainText=function(a,b){for(var d="",l="",f=a,e=0,g=0,b=c.isUnd(b)?100:b;f.length>b;)l=f.substring(0,b),e=l.lastIndexOf(" "),g=l.lastIndexOf("\n"),-1!==g&&(e=g),-1===e&&(e=b),d+=l.substring(0,
e)+"\n",f=f.substring(e+1);return d+f};var Fa={};c.timeOutAction=function(a,b,d){c.isUnd(Fa[a])&&(Fa[a]=0);j.clearTimeout(Fa[a]);Fa[a]=j.setTimeout(b,d)};var Sa={};c.timeOutActionSecond=function(a,b,d){Sa[a]||(Sa[a]=j.setTimeout(function(){b();Sa[a]=0},d))};var O=!1;c.audio=function(a,b){if(!1===O)if(Ya)O=null;else{var d=!1,c=!1,f=j.Audio?new j.Audio:null;f&&f.canPlayType&&f.play?((d=""!==f.canPlayType('audio/mpeg; codecs="mp3"'))||(c=""!==f.canPlayType('audio/ogg; codecs="vorbis"')),d||c?(O=f,O.preload=
"none",O.loop=!1,O.autoplay=!1,O.muted=!1,O.src=d?a:b):O=null):O=null}return O};c.hos=function(a,b){return a&&Object.hasOwnProperty?Object.hasOwnProperty.call(a,b):!1};c.i18n=function(a,b,d){var l="",a=c.isUnd(Pa[a])?c.isUnd(d)?a:d:Pa[a];if(!c.isUnd(b)&&!c.isNull(b))for(l in b)c.hos(b,l)&&(a=a.replace("%"+l+"%",b[l]));return a};c.i18nToNode=function(a){h.defer(function(){i(".i18n",a).each(function(){var a=i(this),d="";(d=a.data("i18n-text"))?a.text(c.i18n(d)):((d=a.data("i18n-html"))&&a.html(c.i18n(d)),
...
c.removeInFocus=function(){if(document&&document.activeElement&&document.activeElement.blur){var a=i(document.activeElement);(a.is("input")||a.is("textarea"))&&document.activeElement.blur()}};c.removeSelection=function(){if(j&&j.getSelection){var a=j.getSelection();a&&a.removeAllRanges&&a.removeAllRanges()}else document&&(document.selection&&document.selection.empty)&&document.selection.empty()};c.replySubjectAdd=function(a,b){var d=null,l=c.trim(b);null!==(d=(new j.RegExp("^"+a+"[\\s]?\\:(.*)$",
"gi")).exec(b))&&!c.isUnd(d[1])?l=a+"[2]: "+d[1]:null!==(d=(new j.RegExp("^("+a+"[\\s]?[\\[\\(]?)([\\d]+)([\\]\\)]?[\\s]?\\:.*)$","gi")).exec(b))&&!c.isUnd(d[1])&&!c.isUnd(d[2])&&!c.isUnd(d[3])?(c.pInt(d[2]),l=d[1]+(c.pInt(d[2])+1)+d[3]):l=a+": "+b;return l};c.roundNumber=function(a,b){return Math.round(a*Math.pow(10,b))/Math.pow(10,b)};c.friendlySize=function(a){a=c.pInt(a);return 1073741824<=a?c.roundNumber(a/1073741824,1)+"GB":1048576<=a?c.roundNumber(a/1048576,1)+"MB":1024<=a?c.roundNumber(a/
1024,0)+"KB":a+"B"};c.log=function(a){j.console&&j.console.log&&j.console.log(a)};c.getNotification=function(a){a=c.pInt(a);return c.isUnd(u[a])?"":u[a]};c.initNotificationLanguage=function(){u[g.Notification.InvalidToken]=c.i18n("NOTIFICATIONS/INVALID_TOKEN");u[g.Notification.AuthError]=c.i18n("NOTIFICATIONS/AUTH_ERROR");u[g.Notification.AccessError]=c.i18n("NOTIFICATIONS/ACCESS_ERROR");u[g.Notification.ConnectionError]=c.i18n("NOTIFICATIONS/CONNECTION_ERROR");u[g.Notification.CaptchaError]=c.i18n("NOTIFICATIONS/CAPTCHA_ERROR");
u[g.Notification.SocialFacebookLoginAccessDisable]=c.i18n("NOTIFICATIONS/SOCIAL_FACEBOOK_LOGIN_ACCESS_DISABLE");u[g.Notification.SocialTwitterLoginAccessDisable]=c.i18n("NOTIFICATIONS/SOCIAL_TWITTER_LOGIN_ACCESS_DISABLE");u[g.Notification.SocialGoogleLoginAccessDisable]=c.i18n("NOTIFICATIONS/SOCIAL_GOOGLE_LOGIN_ACCESS_DISABLE");u[g.Notification.DomainNotAllowed]=c.i18n("NOTIFICATIONS/DOMAIN_NOT_ALLOWED");u[g.Notification.CantGetMessageList]=c.i18n("NOTIFICATIONS/CANT_GET_MESSAGE_LIST");u[g.Notification.CantGetMessage]=
c.i18n("NOTIFICATIONS/CANT_GET_MESSAGE");u[g.Notification.CantDeleteMessage]=c.i18n("NOTIFICATIONS/CANT_DELETE_MESSAGE");u[g.Notification.CantMoveMessage]=c.i18n("NOTIFICATIONS/CANT_MOVE_MESSAGE");u[g.Notification.CantSaveMessage]=c.i18n("NOTIFICATIONS/CANT_SAVE_MESSAGE");u[g.Notification.CantSendMessage]=c.i18n("NOTIFICATIONS/CANT_SEND_MESSAGE");u[g.Notification.InvalidRecipients]=c.i18n("NOTIFICATIONS/INVALID_RECIPIENTS");u[g.Notification.CantCreateFolder]=c.i18n("NOTIFICATIONS/CANT_CREATE_FOLDER");
...
u[g.Notification.LicensingServerIsUnavailable]=c.i18n("NOTIFICATIONS/LICENSING_SERVER_IS_UNAVAILABLE");u[g.Notification.LicensingExpired]=c.i18n("NOTIFICATIONS/LICENSING_EXPIRED");u[g.Notification.LicensingBanned]=c.i18n("NOTIFICATIONS/LICENSING_BANNED");u[g.Notification.AccountAlreadyExists]=c.i18n("NOTIFICATIONS/ACCOUNT_ALREADY_EXISTS");u[g.Notification.MailServerError]=c.i18n("NOTIFICATIONS/MAIL_SERVER_ERROR");u[g.Notification.UnknownError]=c.i18n("NOTIFICATIONS/UNKNOWN_ERROR")};c.getUploadErrorDescByCode=
function(a){var b="";switch(c.pInt(a)){case g.UploadErrorCode.FileIsTooBig:b=c.i18n("UPLOAD/ERROR_FILE_IS_TOO_BIG");break;case g.UploadErrorCode.FilePartiallyUploaded:b=c.i18n("UPLOAD/ERROR_FILE_PARTIALLY_UPLOADED");break;case g.UploadErrorCode.FileNoUploaded:b=c.i18n("UPLOAD/ERROR_NO_FILE_UPLOADED");break;case g.UploadErrorCode.MissingTempFolder:b=c.i18n("UPLOAD/ERROR_MISSING_TEMP_FOLDER");break;case g.UploadErrorCode.FileOnSaveingError:b=c.i18n("UPLOAD/ERROR_ON_SAVING_FILE");break;case g.UploadErrorCode.FileType:b=
c.i18n("UPLOAD/ERROR_FILE_TYPE");break;default:b=c.i18n("UPLOAD/ERROR_UNKNOWN")}return b};c.killCtrlAandS=function(a){if(a=a||j.event){var b=a.target||a.srcElement,d=a.keyCode||a.which;if(a.ctrlKey&&d===g.EventKeyCode.S)a.preventDefault();else if((!b||!b.tagName||!b.tagName.match(/INPUT|TEXTAREA/i))&&a.ctrlKey&&d===g.EventKeyCode.A)j.getSelection?j.getSelection().removeAllRanges():j.document.selection&&j.document.selection.clear&&j.document.selection.clear(),a.preventDefault()}};c.createCommand=function(a,
b,d){var l=b?function(){l.canExecute&&l.canExecute()&&b.apply(a,Array.prototype.slice.call(arguments));return!1}:function(){};l.enabled=e.observable(!0);d=c.isUnd(d)?!0:d;l.canExecute=c.isFunc(d)?e.computed(function(){return l.enabled()&&d.call(a)}):e.computed(function(){return l.enabled()&&!!d});return l};c.initDataConstructorBySettings=function(a){a.ignoreFolderSubscribe=e.observable(!1);a.editorDefaultType=e.observable(g.EditorDefaultType.Html);a.showImages=e.observable(!1);a.showAnimation=e.observable(!1);
a.desktopNotifications=e.observable(!1);a.useThreads=e.observable(!0);a.replySameFolder=e.observable(!0);a.usePreviewPane=e.observable(!0);a.useCheckboxesInList=e.observable(!0);a.showAnimation.subscribe(function(a){na?Z.removeClass("rl-anim").addClass("no-rl-anim"):Z.toggleClass("rl-anim",a).toggleClass("no-rl-anim",!a)});a.showAnimation.valueHasMutated();a.desktopNotificationsPermisions=e.computed(function(){a.desktopNotifications();var b=g.DesctopNotifications.NotSupported;if(ia&&ia.permission)switch(ia.permission.toLowerCase()){case "granted":b=
g.DesctopNotifications.Allowed;break;case "denied":b=g.DesctopNotifications.Denied;break;case "default":b=g.DesctopNotifications.NotAllowed}else j.webkitNotifications&&j.webkitNotifications.checkPermission&&(b=j.webkitNotifications.checkPermission());return b});a.useDesktopNotifications=e.computed({read:function(){return a.desktopNotifications()&&g.DesctopNotifications.Allowed===a.desktopNotificationsPermisions()},write:function(b){b?(b=a.desktopNotificationsPermisions(),g.DesctopNotifications.Allowed===
...
a.allowCustomTheme=e.observable(!0);a.allowAdditionalAccounts=e.observable(!0);a.messagesPerPage=e.observable(t.Defaults.MessagesPerPage);a.mainMessagesPerPage=a.messagesPerPage;a.mainMessagesPerPage=e.computed({read:a.messagesPerPage,write:function(b){-1<c.inArray(c.pInt(b),[10,20,30,50,100,150,200])?b!==a.messagesPerPage()&&a.messagesPerPage(b):a.messagesPerPage.valueHasMutated()}});a.facebookEnable=e.observable(!1);a.facebookAppID=e.observable("");a.facebookAppSecret=e.observable("");a.twitterEnable=
e.observable(!1);a.twitterConsumerKey=e.observable("");a.twitterConsumerSecret=e.observable("");a.googleEnable=e.observable(!1);a.googleClientID=e.observable("");a.googleClientSecret=e.observable("");a.dropboxEnable=e.observable(!1);a.dropboxApiKey=e.observable("");a.contactsIsSupported=e.observable(!1)};c.createMomentDate=function(a){return e.computed(function(){wa();return this.moment().fromNow()},a)};c.createMomentShortDate=function(a){return e.computed(function(){var a="",a=Y(),d=this.moment(),
l=this.momentDate();return a=4>=a.diff(d,"hours")?l:a.format("L")===d.format("L")?c.i18n("MESSAGE_LIST/TODAY_AT",{TIME:d.format("LT")}):a.clone().subtract("days",1).format("L")===d.format("L")?c.i18n("MESSAGE_LIST/YESTERDAY_IN",{TIME:d.format("LT")}):a.year()===d.year()?d.format("D MMM."):d.format("LL")},a)};c.isFolderExpanded=function(a){var b=f.local().get(g.ClientSideKeyName.ExpandedFolders);return h.isArray(b)&&-1!==h.indexOf(b,a)};c.setExpandedFolder=function(a,b){var d=f.local().get(g.ClientSideKeyName.ExpandedFolders);
h.isArray(d)||(d=[]);b?(d.push(a),d=h.uniq(d)):d=h.without(d,a);f.local().set(g.ClientSideKeyName.ExpandedFolders,d)};c.initLayoutResizer=function(a,b,d,c){var e=i(a),s=i(b),w=i(d),a=f.local().get(g.ClientSideKeyName.MailBoxListSize),k=function(a,b,d){if(b||d)a=w.width(),b=b?100*(b.size.width/a):null,null===b&&d&&(b=100*(e.width()/a)),null!==b&&(e.css({width:"",height:"",right:""+(100-b)+"%"}),s.css({width:"",height:"",left:""+b+"%"}))};a&&e.width(a);e.resizable({minWidth:350,maxWidth:w.width()-250,
handles:"e",resize:k,stop:k});k(null,null,!0);R.resize(h.throttle(function(a,b){if(c&&c()){var d=w.width();e.resizable("option","maxWidth",d-250);b&&(b.size&&b.size.width)&&f.local().set(g.ClientSideKeyName.MailBoxListSize,b.size.width);k(null,null,!0)}},400))};c.initBlockquoteSwitcher=function(a){if(a){var b=i("blockquote:not(.rl-bq-switcher)",a).filter(function(){return 0===i(this).parent().closest("blockquote",a).length});b&&0<b.length&&b.each(function(){var a=i(this),b=a.height();if(0===b||100<
b)a.addClass("rl-bq-switcher hidden-bq"),i('<span class="rlBlockquoteSwitcher"><i class="icon-ellipsis" /></span>').insertBefore(a).click(function(){a.toggleClass("hidden-bq");c.windowResize()}).after("<br />").before("<br />")})}};c.removeBlockquoteSwitcher=function(a){a&&(i(a).find("blockquote.rl-bq-switcher").each(function(){i(this).removeClass("rl-bq-switcher hidden-bq")}),i(a).find(".rlBlockquoteSwitcher").each(function(){i(this).remove()}))};c.extendAsViewModel=function(a,b){b&&(b.__name=a,
x.regViewModelHook(a,b),h.extend(b.prototype,C.prototype))};c.addSettingsViewModel=function(a,b,d,c,f){a.__rlSettingsData={Label:d,Template:b,Route:c,IsDefault:!!f};Da.push(a)};c.removeSettingsViewModel=function(a){Qa.push(a)};c.disableSettingsViewModel=function(a){Ra.push(a)};c.convertThemeName=function(a){return c.trim(a.replace(/[^a-zA-Z]/g," ").replace(/([A-Z])/g," $1").replace(/[\s]+/g," "))};c.fakeMd5=function(a){for(var b="",a=c.isUnd(a)?32:c.pInt(a);b.length<a;)b+="0123456789abcdefghijklmnopqrstuvwxyz".substr(j.Math.round(36*
j.Math.random()),1);return b};c.convertPlainTextToHtml=function(a){return a.toString().replace(/&/g,"&amp;").replace(/>/g,"&gt;").replace(/</g,"&lt;").replace(/\r/g,"").replace(/\n/g,"<br />")};c.draggeblePlace=function(){return i('<div class="draggablePlace"><span class="text"></span>&nbsp;<i class="icon-envelope icon-white"></i></div>').appendTo("#rl-hidden")};c.defautOptionsAfterRender=function(a,b){b&&!c.isUnd(b.disable)&&e.applyBindingsToNode(a,{disable:b.disable},b)};c.windowPopupKnockout=function(a,
...
2),b+=String.fromCharCode((c&15)<<12|(f&63)<<6|e&63),d+=3);return b}};e.bindingHandlers.tooltip={init:function(a,b){if(!na){var d=i(a).data("tooltip-class")||"";i(a).tooltip({delay:{show:500,hide:100},html:!0,trigger:"hover",title:function(){return'<span class="tooltip-class '+d+'">'+c.i18n(e.utils.unwrapObservable(b()))+"</span>"}})}}};e.bindingHandlers.tooltip2={init:function(a,b){var d=i(a).data("tooltip-class")||"";i(a).tooltip({delay:{show:500,hide:100},html:!0,title:function(){return'<span class="tooltip-class '+
d+'">'+b()()+"</span>"}})}};e.bindingHandlers.popover={init:function(a,b){var d=e.utils.unwrapObservable(b());i(a).popover({trigger:d[2]||"click",placement:d[3]||"right",title:function(){return c.i18n(d[0]||"")},content:function(){return c.i18n(d[1]||"")}})}};e.bindingHandlers.resizecrop={init:function(a){i(a).addClass("resizecrop").resizecrop({width:"100",height:"100",wrapperCSS:{"border-radius":"10px"}})},update:function(a,b){b()();i(a).resizecrop({width:"100",height:"100"})}};e.bindingHandlers.onEnter=
{init:function(a,b,d,c){e.bindingHandlers.event.init(a,function(){return{keyup:function(d,c){c&&13===j.parseInt(c.keyCode,10)&&(i(a).trigger("change"),b().call(this,d))}}},d,c)}};e.bindingHandlers.onEsc={init:function(a,b,d,c){e.bindingHandlers.event.init(a,function(){return{keyup:function(d,c){c&&27===j.parseInt(c.keyCode,10)&&(i(a).trigger("change"),b().call(this,d))}}},d,c)}};e.bindingHandlers.modal={init:function(a,b){i(a).modal({keyboard:!1,show:e.utils.unwrapObservable(b())}).on("hidden",function(){b()(!1)})},
update:function(a,b){var d=e.utils.unwrapObservable(b());i(a).modal(d?"show":"hide");h.delay(function(){i(a).toggleClass("popup-active",d)},1)}};e.bindingHandlers.onEnterChange={init:function(a,b,d,c){e.bindingHandlers.event.init(a,function(){return{keyup:function(b,d){d&&13===j.parseInt(d.keyCode,10)&&i(a).trigger("change")}}},d,c)}};e.bindingHandlers.i18nInit={init:function(a){c.i18nToNode(a)}};e.bindingHandlers.i18nUpdate={update:function(a,b){e.utils.unwrapObservable(b());c.i18nToNode(a)}};e.bindingHandlers.link=
{update:function(a,b){i(a).attr("href",e.utils.unwrapObservable(b()))}};e.bindingHandlers.title={update:function(a,b){i(a).attr("title",e.utils.unwrapObservable(b()))}};e.bindingHandlers.textF={init:function(a,b){i(a).text(e.utils.unwrapObservable(b()))}};e.bindingHandlers.initDom={init:function(a,b){b()(a)}};e.bindingHandlers.initResizeTrigger={init:function(a,b){var d=e.utils.unwrapObservable(b());i(a).css({height:d[1],"min-height":d[1]})},update:function(a,b){var d=e.utils.unwrapObservable(b()),
l=c.pInt(d[1]),f=0,f=i(a).offset().top;0<f&&(f+=c.pInt(d[2]),f=R.height()-f,l<f&&(l=f),i(a).css({height:l,"min-height":l}))}};e.bindingHandlers.appendDom={update:function(a,b){i(a).hide().empty().append(e.utils.unwrapObservable(b())).show()}};e.bindingHandlers.draggable={init:function(a,b){i(a).draggable({distance:20,handle:".dragHandle",cursorAt:{top:22,left:3},helper:function(a){return b()(a&&a.target?e.dataFor(a.target):null)}}).on("mousedown",function(){c.removeInFocus()})}};e.bindingHandlers.droppable=
{init:function(a,b){var d=b();!1!==d&&i(a).droppable({tolerance:"pointer",hoverClass:"droppableHover",drop:function(a,b){d(a,b)}})}};e.bindingHandlers.nano={init:function(a){na||i(a).addClass("nano").nanoScroller({iOSNativeScrolling:!1,preventPageScrolling:!0})}};e.bindingHandlers.saveTrigger={init:function(a){i(a).append('&nbsp;&nbsp;<i class="icon-spinner-2 animated"></i><i class="icon-remove error"></i><i class="icon-ok success"></i>').addClass("settings-saved-trigger")},update:function(a,b){var d=
e.utils.unwrapObservable(b()),c=i(a);switch(d.toString()){case "1":c.find(".animated,.error").hide().removeClass("visible").end().find(".success").show().addClass("visible");break;case "0":c.find(".animated,.success").hide().removeClass("visible").end().find(".error").show().addClass("visible");break;case "-2":c.find(".error,.success").hide().removeClass("visible").end().find(".animated").show().addClass("visible");break;default:c.find(".animated").hide().end().find(".error,.success").removeClass("visible")}}};
e.bindingHandlers.select2={init:function(a,b){var d=0,l=null,g=new j.RegExp(/[a-zA-Z0-9\.\-_]+@[a-zA-Z0-9\.\-_]+/),s=new j.RegExp(/(.+) [<]?([^\s<@]+@[a-zA-Z0-9\.\-_]+)[>]?/),w=function(){return""},k=function(a){f.getAutocomplete(a.term,a.page,function(b,d){a.callback({more:!!d,results:h.map(b,function(a){var b=a.toLine(!1);return{id:b,text:b,c:a}})})})};i(a).addClass("ko-select2").select2({query:function(a){a&&(0===d?(k(a),d=j.setTimeout(c.emptyFunction,200)):(j.clearInterval(d),d=j.setTimeout(function(){k(a)},
...
openOnEnter:!1});e.utils.domNodeDisposal.addDisposeCallback(a,function(){i(a).select2("destroy")});i(a).on("change",function(){for(var a=i(this).select2("data"),d=0,f=a.length,e=null,g=[];d<f;d++)if((e=a[d])&&e.id)e.c||(e.c=new F,(l=s.exec(c.trim(e.id)))&&!c.isUnd(l[2])?(e.c.name=l[1],e.c.email=l[2]):e.c.email=e.id),g.push(e.c);b()(g)})},update:function(a,b){for(var d=e.utils.unwrapObservable(b()),c=0,f=d.length,g=null,w="",k=[];c<f;c++)g=d[c],w=g.toLine(!1),k.push({id:w,text:w,c:g});i(a).select2("data",
k)}};e.bindingHandlers.command={init:function(a,b,d,c){var f=i(a),g=b();if(!g||!g.enabled||!g.canExecute)throw Error("You are not using command function");f.addClass("command");e.bindingHandlers[f.is("form")?"submit":"click"].init.apply(c,arguments)},update:function(a,b){var d=!0,c=i(a),f=b(),d=f.enabled();c.toggleClass("command-not-enabled",!d);d&&(d=f.canExecute(),c.toggleClass("command-can-not-be-execute",!d));c.toggleClass("command-disabled disable disabled",!d);(c.is("input")||c.is("button"))&&
c.prop("disabled",!d)}};e.extenders.trimmer=function(a){var b=e.computed({read:a,write:function(b){a(c.trim(b.toString()))},owner:this});b(a());return b};e.extenders.reversible=function(a){var b=a();a.commit=function(){b=a()};a.reverse=function(){a(b)};a.commitedValue=function(){return b};return a};e.extenders.toggleSubscribe=function(a,b){a.subscribe(b[1],b[0],"beforeChange");a.subscribe(b[2],b[0]);return a};e.extenders.falseTimeout=function(a,b){a.iTimeout=0;a.subscribe(function(d){d&&(j.clearTimeout(a.iTimeout),
a.iTimeout=j.setTimeout(function(){a(!1);a.iTimeout=0},c.pInt(b)))});return a};e.observable.fn.validateEmail=function(){this.hasError=e.observable(!1);this.subscribe(function(a){a=c.trim(a);this.hasError(""!==a&&!/^[^@\s]+@[^@\s]+$/.test(a))},this);this.valueHasMutated();return this};e.observable.fn.validateFunc=function(a){this.hasFuncError=e.observable(!1);c.isFunc(a)&&(this.subscribe(function(b){this.hasFuncError(!a(b))},this),this.valueHasMutated());return this};B.prototype.root=function(){return this.sBase};
...
(x.oSimpleHooks[a]=[]),x.oSimpleHooks[a].push(b))};x.runHook=function(a,b){c.isArray(x.oSimpleHooks[a])&&(b=b||[],h.each(x.oSimpleHooks[a],function(a){a.apply(null,b)}))};x.mainSettingsGet=function(a){return f?f.settingsGet(a):null};x.remoteRequest=function(a,b,d,c,e,g){f&&f.remote().defaultRequest(a,b,d,c,e,g)};x.settingsGet=function(a,b){var d=x.mainSettingsGet("Plugins");return(d=d&&c.isUnd(d[a])?null:d[a])?c.isUnd(d[b])?null:d[b]:null};n.prototype.initLanguage=function(a,b,d){this.oOptions.LangSwitcherConferm=
a;this.oOptions.LangSwitcherTextLabel=b;this.oOptions.LangSwitcherHtmlLabel=d};n.prototype.execCom=function(a,b,d){j.document&&(j.document.execCommand(a,b||!1,d||null),this.updateTextArea())};n.prototype.getEditorSelection=function(){var a=null;j.getSelection?a=j.getSelection():j.document.getSelection?a=j.document.getSelection():j.document.selection&&(a=j.document.selection);return a};n.prototype.getEditorRange=function(){var a=this.getEditorSelection();return!a||0===a.rangeCount?null:a.getRangeAt?
a.getRangeAt(0):a.createRange()};n.prototype.ec=function(a,b,d){this.execCom(a,b,d)};n.prototype.heading=function(a){this.ec("formatblock",!1,i.browser.msie?"Heading "+a:"h"+a)};n.prototype.insertImage=function(a){this.isHtml()&&!this.bOnlyPlain&&(this.htmlarea.focus(),this.ec("insertImage",!1,a))};n.prototype.setcolor=function(a,b){var d=null,d="";i.browser.msie&&9>c.pInt(i.browser.version)?(d=this.getEditorRange())&&d.execCommand("forecolor"===a?"ForeColor":"BackColor",!1,b):(d=i.browser.msie?"forecolor"===
...
this.switchToPlain():this.switchToHtml()};n.prototype.switchToPlain=function(a){var a=c.isUnd(a)?!0:a,b=this.getTextFromHtml(),d=h.bind(function(a){a&&(this.toolbar.addClass("editorHideToolbar"),i(".editorSwitcher",this.toolbar).text(this.switcherLinkText(!1)),this.textarea.val(b),this.textarea.show(),this.htmlarea.hide(),this.fOnSwitch&&this.fOnSwitch(!1))},this);!a||0===c.trim(b).length?d(!0):d(j.confirm(this.oOptions.LangSwitcherConferm))};n.prototype.switcherLinkText=function(a){return a?this.oOptions.LangSwitcherTextLabel:
this.oOptions.LangSwitcherHtmlLabel};n.prototype.switchToHtml=function(){this.toolbar.removeClass("editorHideToolbar");i(".editorSwitcher",this.toolbar).text(this.switcherLinkText(!0));this.textarea.val(this.getHtmlFromText());this.updateHtmlArea();this.textarea.hide();this.htmlarea.show();this.fOnSwitch&&this.fOnSwitch(!0)};n.prototype.addButton=function(a,b){var d=this;i("<div />").addClass("editorToolbarButtom").append(i('<a tabindex="-1" href="javascript:void(0);"></a>').addClass(a)).attr("title",
b).click(function(b){c.isUnd(n.htmlFunctions[a])?j.alert(a):n.htmlFunctions[a].apply(d,[i(this),b])}).appendTo(this.toolbar)};n.htmlInitToolbar=function(){if(!this.bOnlyPlain){this.addButton("bold","Bold");this.addButton("italic","Italic");this.addButton("underline","Underline");this.addButton("strikethrough","Strikethrough");this.addButton("removeformat","removeformat");this.addButton("justifyleft","justifyleft");this.addButton("justifycenter","justifycenter");this.addButton("justifyright","justifyright");
this.addButton("horizontalrule","horizontalrule");this.addButton("orderedlist","orderedlist");this.addButton("unorderedlist","unorderedlist");this.addButton("indent","indent");this.addButton("outdent","outdent");this.addButton("forecolor","forecolor");var a=this;i("<span />").addClass("editorSwitcher").text(a.switcherLinkText(!0)).click(function(){a.switchToggle()}).appendTo(a.toolbar)}};n.htmlInitEditor=function(){this.editor=this.htmlarea[0];this.editor.innerHTML=this.textarea.val()};n.htmlAttachEditorEvents=
function(){};for(var ib=n,oa=[],Za=[],W=0,Ga=0,Ha=0,Ia=0,Ja="",W=0;256>W;W+=85)Ja=W.toString(16),oa.push(1===Ja.length?"0"+Ja:Ja);Ia=oa.length;for(W=0;W<Ia;W++)for(Ga=0;Ga<Ia;Ga++)for(Ha=0;Ha<Ia;Ha++)Za.push("#"+oa[W]+""+oa[Ga]+""+oa[Ha]);ib.htmlColorPickerColors=Za;var jb=n,$a=i(j.document),ab=!1,pa=i('<div style="position: absolute;" class="editorFontStylePicker"><div class="editorFpFonts"></div></div>'),bb=pa.find(".editorFpFonts"),cb=function(){};i.each("Arial;Arial Black;Courier New;Tahoma;Times New Roman;Verdana".split(";"),
function(a,b){bb.append(i('<a href="javascript:void(0);" tabindex="-1" class="editorFpFont" style="font-family: '+b+';">'+b+"</a>").click(function(){cb(b)}));bb.append("<br />")});pa.hide();jb.htmlFontPicker=function(a,b,d){ab||(pa.appendTo(d),ab=!0);cb=b;$a.unbind("click.fpNamespace");j.setTimeout(function(){$a.one("click.fpNamespace",function(){pa.hide()})},500);b=i(a).position();pa.css("top",5+b.top+i(a).height()+"px").css("left",b.left+"px").show()};var kb=n,db=i(j.document),eb=!1,qa=i('<div style="position: absolute;" class="editorColorPicker"><div class="editorCpColors"></div></div>'),
fb=qa.find(".editorCpColors"),gb=function(){};i.each(n.htmlColorPickerColors,function(a,b){fb.append('<a href="javascript:void(0);" tabindex="-1" class="editorCpColor" style="background-color: '+b+';"></a>')});qa.hide();i(".editorCpColor",fb).click(function(a){var b=1,d="#000000",a=i(a.target).css("background-color"),d=a.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/);if(null!==d){for(delete d[0];3>=b;++b)d[b]=c.pInt(d[b]).toString(16),1===d[b].length&&(d[b]="0"+d[b]);d="#"+d.join("")}else d=a;gb(d)});
kb.htmlColorPicker=function(a,b,d){eb||(qa.appendTo(d),eb=!0);d=i(a).position();gb=b;db.unbind("click.cpNamespace");j.setTimeout(function(){db.one("click.cpNamespace",function(){qa.hide()})},100);qa.css("top",5+d.top+i(a).height()+"px").css("left",d.left+"px").show()};n.htmlFunctions={bold:function(){this.ec("bold")},italic:function(){this.ec("italic")},underline:function(){this.ec("underline")},strikethrough:function(){this.ec("strikethrough")},indent:function(){this.ec("indent")},outdent:function(){this.ec("outdent")},
justifyleft:function(){this.ec("justifyLeft")},justifycenter:function(){this.ec("justifyCenter")},justifyright:function(){this.ec("justifyRight")},horizontalrule:function(){this.ec("insertHorizontalRule",!1,"ht")},removeformat:function(){this.ec("removeFormat")},orderedlist:function(){this.ec("insertorderedlist")},unorderedlist:function(){this.ec("insertunorderedlist")},forecolor:function(a){n.htmlColorPicker(a,h.bind(function(a){this.setcolor("forecolor",a)},this),this.toolbar)},backcolor:function(a){n.htmlColorPicker(a,
h.bind(function(a){this.setcolor("backcolor",a)},this),this.toolbar)},fontname:function(a){n.htmlFontPicker(a,h.bind(function(a){this.ec("fontname",!1,a)},this),this.toolbar)}};M.prototype.init=function(a,b){this.oContentVisible=a;this.oContentScrollable=b;if(this.oContentVisible&&this.oContentScrollable){var d=this;i(this.oContentVisible).on("click",this.sItemSelector,function(a){d.actionClick(e.dataFor(this),a)}).on("click",this.sItemCheckedSelector,function(a){var b=e.dataFor(this);b&&(a&&a.shiftKey?
d.actionClick(b,a):(d.sLastUid=d.getItemUid(b),b.selected()?(b.checked(!1),d.selectedItem(null)):b.checked(!b.checked())))});i(j.document).on("keydown",h.bind(function(a){var b=!0;if(a&&this.bUseKeyboard&&!c.inFocus())if(-1<c.inArray(a.keyCode,[g.EventKeyCode.Up,g.EventKeyCode.Down,g.EventKeyCode.Insert,g.EventKeyCode.Home,g.EventKeyCode.End,g.EventKeyCode.PageUp,g.EventKeyCode.PageDown]))this.newSelectPosition(a.keyCode,a.shiftKey),b=!1;else if(g.EventKeyCode.Delete===a.keyCode&&!a.ctrlKey&&!a.shiftKey){if(this.oCallbacks.onDelete)this.oCallbacks.onDelete();
b=!1}return b},this))}};M.prototype.selectByUid=function(a,b){this.useItemSelectCallback=b=c.isUnd(b)?!0:!!b;var d=h.find(this.list(),function(b){return a===this.getItemUid(b)},this);d&&this.selectedItem(d);this.useItemSelectCallback=!0};M.prototype.useKeyboard=function(a){this.bUseKeyboard=!!a};M.prototype.getItemUid=function(a){var b="",d=this.oCallbacks.onItemGetUid||null;d&&a&&(b=d(a));return b.toString()};M.prototype.newSelectPosition=function(a,b){var d=this,c=0,f=!1,e=!1,w=null,k=this.list(),
i=k?k.length:0,o=this.selectedItem();if(0<i)if(o){if(o)if(g.EventKeyCode.Down===a||g.EventKeyCode.Up===a||g.EventKeyCode.Insert===a)h.each(k,function(b){if(!e)switch(a){case g.EventKeyCode.Up:o===b?e=!0:w=b;break;case g.EventKeyCode.Down:case g.EventKeyCode.Insert:f?(w=b,e=!0):o===b&&(f=!0)}});else if(g.EventKeyCode.Home===a||g.EventKeyCode.End===a)g.EventKeyCode.Home===a?w=k[0]:g.EventKeyCode.End===a&&(w=k[k.length-1]);else if(g.EventKeyCode.PageDown===a)for(;c<i;c++){if(o===k[c]){c+=10;c=i-1<c?
i-1:c;w=k[c];break}}else if(g.EventKeyCode.PageUp===a)for(c=i;0<=c;c--)if(o===k[c]){c-=10;c=0>c?0:c;w=k[c];break}}else if(g.EventKeyCode.Down===a||g.EventKeyCode.Insert===a||g.EventKeyCode.Home===a||g.EventKeyCode.PageUp===a)w=k[0];else if(g.EventKeyCode.Up===a||g.EventKeyCode.End===a||g.EventKeyCode.PageDown===a)w=k[k.length-1];w?(o&&(b?(g.EventKeyCode.Up===a||g.EventKeyCode.Down===a)&&o.checked(!o.checked()):g.EventKeyCode.Insert===a&&o.checked(!o.checked())),this.selectedItem(w),0!==this.iSelectTimer?
(j.clearTimeout(this.iSelectTimer),this.iSelectTimer=j.setTimeout(function(){d.iSelectTimer=0;d.actionClick(w)},300)):(this.iSelectTimer=j.setTimeout(function(){d.iSelectTimer=0},200),this.actionClick(w)),this.scrollToSelected()):o&&(b&&(g.EventKeyCode.Up===a||g.EventKeyCode.Down===a)?o.checked(!o.checked()):g.EventKeyCode.Insert===a&&o.checked(!o.checked()))};M.prototype.scrollToSelected=function(){if(!this.oContentVisible||!this.oContentScrollable)return!1;var a=i(this.sItemSelectedSelector,this.oContentScrollable),
b=a.position(),d=this.oContentVisible.height(),a=a.outerHeight();return b&&(0>b.top||b.top+a>d)?(0>b.top?this.oContentScrollable.scrollTop(this.oContentScrollable.scrollTop()+b.top-20):this.oContentScrollable.scrollTop(this.oContentScrollable.scrollTop()+b.top-d+a+20),!0):!1};M.prototype.eventClickFunction=function(a,b){var d=this.getItemUid(a),c=0,f=0,e=null,g="",k=!1,h=!1,i=[],j=!1;if(b&&b.shiftKey&&""!==d&&""!==this.sLastUid&&d!==this.sLastUid){i=this.list();j=a.checked();c=0;for(f=i.length;c<
f;c++){e=i[c];g=this.getItemUid(e);k=!1;if(g===this.sLastUid||g===d)k=!0;k&&(h=!h);(h||k)&&e.checked(j)}}this.sLastUid=""===d?"":d};M.prototype.actionClick=function(a,b){if(a){var d=!0,c=this.getItemUid(a);b&&(b.shiftKey?(d=!1,""===this.sLastUid&&(this.sLastUid=c),a.checked(!a.checked()),this.eventClickFunction(a,b)):b.ctrlKey&&(d=!1,this.sLastUid=c,a.checked(!a.checked())));d&&(this.selectedItem(a),this.sLastUid=c)}};M.prototype.on=function(a,b){this.oCallbacks[a]=b};sa.supported=function(){return!0};
sa.prototype.set=function(a,b){var d=i.cookie(t.Values.ClientSideCookieIndexName),c=null;try{(c=null===d?null:JSON.parse(d))||(c={}),c[a]=b,i.cookie(t.Values.ClientSideCookieIndexName,JSON.stringify(c),{expires:30})}catch(f){}return c};sa.prototype.get=function(a){var b=i.cookie(t.Values.ClientSideCookieIndexName),d=null;try{d=(d=null===b?null:JSON.parse(b))&&!c.isUnd(d[a])?d[a]:null}catch(f){}return d};ta.supported=function(){return!!j.localStorage};ta.prototype.set=function(a,b){var d=j.localStorage[t.Values.ClientSideCookieIndexName]||
null,c=null;try{(c=null===d?null:JSON.parse(d))||(c={}),c[a]=b,j.localStorage[t.Values.ClientSideCookieIndexName]=JSON.stringify(c)}catch(f){}return c};ta.prototype.get=function(a){var b=j.localStorage[t.Values.ClientSideCookieIndexName]||null,d=null;try{d=(d=null===b?null:JSON.parse(b))&&!c.isUnd(d[a])?d[a]:null}catch(f){}return d};ua.prototype.oDriver=null;ua.prototype.set=function(a,b){return this.oDriver?this.oDriver.set("p"+a,b):!1};ua.prototype.get=function(a){return this.oDriver?this.oDriver.get("p"+
...
function(){return this.sScreenName};J.prototype.routes=function(){return null};J.prototype.__cross=function(){return this.oCross};J.prototype.__start=function(){var a=this.routes(),b=null,d=null;c.isNonEmptyArray(a)&&(d=h.bind(this.onRoute||c.emptyFunction,this),b=Ta.create(),h.each(a,function(a){b.addRoute(a[0],d).rules=a[1]}),this.oCross=b)};E.prototype.sDefaultScreenName="";E.prototype.oScreens={};E.prototype.oBoot=null;E.prototype.oCurrentScreen=null;E.prototype.showLoading=function(){i("#rl-loading").show()};
E.prototype.hideLoading=function(){i("#rl-loading").hide()};E.prototype.routeOff=function(){P.changed.active=!1};E.prototype.routeOn=function(){P.changed.active=!0};E.prototype.setBoot=function(a){c.isNormal(a)&&(this.oBoot=a);return this};E.prototype.screen=function(a){return""!==a&&!c.isUnd(this.oScreens[a])?this.oScreens[a]:null};E.prototype.delegateRun=function(a,b,d){a&&a[b]&&a[b].apply(a,c.isArray(d)?d:[])};E.prototype.buildViewModel=function(a,b){if(a&&!a.__builded){var d=new a(b),l=d.viewModelPosition(),
g=i("#rl-content #rl-"+l.toLowerCase()),s=null;a.__builded=!0;a.__vm=d;d.data=f.data();d.viewModelName=a.__name;g&&1===g.length?(s=i("<div>").addClass("rl-view-model").addClass("RL-"+d.viewModelTemplate()).hide().attr("data-bind",'template: {name: "'+d.viewModelTemplate()+'"}, i18nInit: true'),s.appendTo(g),d.viewModelDom=s,a.__dom=s,"Popups"===l&&(d.cancelCommand=d.closeCommand=c.createCommand(d,function(){r.hideScreenPopup(a)})),x.runHook("view-model-pre-build",[a.__name,d,s]),e.applyBindings(d,
...
function(){return!!h.find(this.attachments(),function(a){return!a.isLinked})};m.prototype.findAttachmentByCid=function(a){var b=null,d=this.attachments();c.isNonEmptyArray(d)&&(a=a.replace(/^<+/,"").replace(/>+$/,""),b=h.find(d,function(b){return a===b.cidWithOutTags}));return b||null};m.prototype.messageId=function(){return this.sMessageId};m.prototype.inReplyTo=function(){return this.sInReplyTo};m.prototype.references=function(){return this.sReferences};m.prototype.fromAsSingleEmail=function(){return c.isArray(this.from)&&
...
b);m.replyHelper(this.to,a,b);m.replyHelper(this.cc,a,d);return[b,d]};m.prototype.textBodyToString=function(){return this.body?this.body.html():""};m.prototype.attachmentsToStringLine=function(){var a=h.map(this.attachments(),function(a){return a.fileName+" ("+a.friendlySize+")"});return a&&0<a.length?a.join(", "):""};m.prototype.getDataForWindowPopup=function(){return{popupFrom:this.fromToLine(!1),popupTo:this.toToLine(!1),popupCc:this.ccToLine(!1),popupBcc:this.bccToLine(!1),popupSubject:this.subject(),
popupDate:this.fullFormatDateValue(),popupAttachments:this.attachmentsToStringLine(),popupBody:this.textBodyToString()}};m.prototype.viewPopupMessage=function(a){c.windowPopupKnockout(this.getDataForWindowPopup(),"PopupsWindowSimpleMessage",this.subject(),function(b){b&&(b.document&&b.document.body)&&(i("img.lazy",b.document.body).each(function(a,b){var c=i(b),f=c.data("original"),e=c.attr("src");0<=a&&(f&&!e)&&c.attr("src",f)}),a&&j.setTimeout(function(){b.print()},100))})};m.prototype.printMessage=
...
return this};m.prototype.showExternalImages=function(a){this.body&&this.body.data("rl-has-images")&&(a=c.isUnd(a)?!1:a,this.hasImages(!1),this.body.data("rl-has-images",!1),i("[data-x-src]",this.body).each(function(){a&&i(this).is("img")?i(this).addClass("lazy").attr("data-original",i(this).attr("data-x-src")).removeAttr("data-x-src"):i(this).attr("src",i(this).attr("data-x-src")).removeAttr("data-x-src")}),i("[data-x-style-url]",this.body).each(function(){var a=c.trim(i(this).attr("style")),a=""===
a?"":";"===a.substr(-1)?a+" ":a+"; ";i(this).attr("style",a+i(this).attr("data-x-style-url")).removeAttr("data-x-style-url")}),a&&(i("img.lazy",this.body).lazyload({threshold:400,effect:"fadeIn",skip_invisible:!1,container:i(".RL-MailMessageView .messageView .messageItem .content")[0]}),R.resize()),c.windowResize(500),c.windowResize(1E3))};m.prototype.showInternalImages=function(a){if(this.body&&!this.body.data("rl-init-internal-images")){var a=c.isUnd(a)?!1:a,b=this;this.body.data("rl-init-internal-images",
!0);i("[data-x-src-cid]",this.body).each(function(){var d=b.findAttachmentByCid(i(this).attr("data-x-src-cid"));d&&d.download&&(a&&i(this).is("img")?i(this).addClass("lazy").attr("data-original",d.linkPreview()):i(this).attr("src",d.linkPreview()))});i("[data-x-style-cid]",this.body).each(function(){var a="",f="",e=b.findAttachmentByCid(i(this).attr("data-x-style-cid"));e&&e.linkPreview&&(f=i(this).attr("data-x-style-cid-name"),""!==f&&(a=c.trim(i(this).attr("style")),a=""===a?"":";"===a.substr(-1)?
a+" ":a+"; ",i(this).attr("style",a+f+": url('"+e.linkPreview()+"')")))});a&&h.delay(function(){i("img.lazy",b.body).lazyload({threshold:400,effect:"fadeIn",skip_invisible:!1,container:i(".RL-MailMessageView .messageView .messageItem .content")[0]})},300);c.windowResize(500)}};G.newInstanceFromJson=function(a){var b=new G;return b.initByJson(a)?b.initComputed():null};G.prototype.initComputed=function(){this.hasSubScribedSubfolders=e.computed(function(){return!!h.find(this.subFolders(),function(a){return a.subScribed()})},
...
g.StorageResultType.Success===a&&(b&&b.Result)&&(d=!0,this.modalVisibility()&&r.delegateRun(this,"closeCommand"));this.modalVisibility()&&!d&&(b&&g.Notification.CantSaveMessage===b.ErrorCode?(this.sendSuccessButSaveError(!0),j.alert(c.trim(c.i18n("COMPOSE/SAVED_ERROR_ON_SEND")))):(this.sendError(!0),j.alert(c.getNotification(g.Notification.CantSendMessage))))};y.prototype.saveMessageResponse=function(a,b){var d=!1,e=null;this.saving(!1);if(g.StorageResultType.Success===a&&(b&&b.Result)&&(b.Result.NewFolder&&
b.Result.NewUid)&&(this.bFromDraft&&(e=f.data().message())&&(this.draftFolder()===e.folderFullNameRaw&&this.draftUid()===e.uid)&&f.data().message(null),this.draftFolder(b.Result.NewFolder),this.draftUid(b.Result.NewUid),this.modalVisibility()))this.savedTime(j.Math.round((new j.Date).getTime()/1E3)),this.savedOrSendingText(0<this.savedTime()?c.i18n("COMPOSE/SAVED_TIME",{TIME:Y.unix(this.savedTime()-1).format("LT")}):""),d=!0,this.bFromDraft&&f.cache().setFolderHash(this.draftFolder(),"");!this.modalVisibility()&&
!d&&(this.savedError(!0),this.savedOrSendingText(c.getNotification(g.Notification.CantSaveMessage)))};y.prototype.onHide=function(){r.routeOn()};y.prototype.onShow=function(a,b,d){r.routeOff();var e=this,K="",s="",w="",k="",j="",o=null,k=o="",K=[],K={},k=f.data().accountEmail(),q=[],q=s=null,a=a||g.ComposeType.Empty;(b=b||null)&&c.isNormal(b)&&(q=c.isArray(b)&&1===b.length?b[0]:!c.isArray(b)?b:null);null!==k&&(K[k]=!0);this.reset();c.isNonEmptyArray(d)&&this.to(d);if(""!==a&&q){k=q.fullFormatDateValue();
j=q.subject();s=q.aDraftInfo;o=i(q.body).clone();c.removeBlockquoteSwitcher(o);o=o.html();switch(a){case g.ComposeType.Reply:this.to(q.replyEmails(K));this.subject(c.replySubjectAdd("Re",j));this.prepearMessageAttachments(q,a);this.aDraftInfo=["reply",q.uid,q.folderFullNameRaw];this.sInReplyTo=q.sMessageId;this.sReferences=c.trim(this.sInReplyTo+" "+q.sReferences);break;case g.ComposeType.ReplyAll:K=q.replyAllEmails(K);this.to(K[0]);this.cc(K[1]);this.subject(c.replySubjectAdd("Re",j));this.prepearMessageAttachments(q,
a);this.aDraftInfo=["reply",q.uid,q.folderFullNameRaw];this.sInReplyTo=q.sMessageId;this.sReferences=c.trim(this.sInReplyTo+" "+q.references());break;case g.ComposeType.Forward:this.subject(c.replySubjectAdd("Fwd",j));this.prepearMessageAttachments(q,a);this.aDraftInfo=["forward",q.uid,q.folderFullNameRaw];this.sInReplyTo=q.sMessageId;this.sReferences=c.trim(this.sInReplyTo+" "+q.sReferences);break;case g.ComposeType.ForwardAsAttachment:this.subject(c.replySubjectAdd("Fwd",j));this.prepearMessageAttachments(q,
a);this.aDraftInfo=["forward",q.uid,q.folderFullNameRaw];this.sInReplyTo=q.sMessageId;this.sReferences=c.trim(this.sInReplyTo+" "+q.sReferences);break;case g.ComposeType.Draft:this.to(q.to),this.cc(q.cc),this.bcc(q.bcc),this.bFromDraft=!0,this.draftFolder(q.folderFullNameRaw),this.draftUid(q.uid),this.subject(j),this.prepearMessageAttachments(q,a),this.aDraftInfo=c.isNonEmptyArray(s)&&3===s.length?s:null,this.sInReplyTo=q.sInReplyTo,this.sReferences=q.sReferences}if(this.oEditor){switch(a){case g.ComposeType.Reply:case g.ComposeType.ReplyAll:K=
q.fromToLine(!1,!0);k=c.i18n("COMPOSE/REPLY_MESSAGE_TITLE",{DATETIME:k,EMAIL:K});o="<br /><br />"+k+":<blockquote><br />"+o+"</blockquote>";break;case g.ComposeType.Forward:K=q.fromToLine(!1,!0);s=q.toToLine(!1,!0);w=q.ccToLine(!1,!0);o="<br /><br /><br />"+c.i18n("COMPOSE/FORWARD_MESSAGE_TOP_TITLE")+"<br />"+c.i18n("COMPOSE/FORWARD_MESSAGE_TOP_FROM")+": "+K+"<br />"+c.i18n("COMPOSE/FORWARD_MESSAGE_TOP_TO")+": "+s+(0<w.length?"<br />"+c.i18n("COMPOSE/FORWARD_MESSAGE_TOP_CC")+": "+w:"")+"<br />"+c.i18n("COMPOSE/FORWARD_MESSAGE_TOP_SENT")+
": "+c.encodeHtml(k)+"<br />"+c.i18n("COMPOSE/FORWARD_MESSAGE_TOP_SUBJECT")+": "+c.encodeHtml(j)+"<br /><br />"+o;break;case g.ComposeType.ForwardAsAttachment:o=""}this.oEditor.setRawText(o,q.isHtml)}}else this.oEditor&&g.ComposeType.Empty===a?this.oEditor.setRawText("<br />"+c.convertPlainTextToHtml(f.data().signature()),g.EditorDefaultType.Html===f.data().editorDefaultType()):c.isNonEmptyArray(b)&&h.each(b,function(a){e.addMessageAsAttachment(a)});q=this.getAttachmentsDownloadsForUpload();c.isNonEmptyArray(q)&&
...
this),onProgress:h.bind(function(b,d,f){var e=null;c.isUnd(a[b])?(e=this.getAttachmentById(b))&&(a[b]=e):e=a[b];e&&e.progress(" - "+Math.floor(100*(d/f))+"%")},this),onSelect:h.bind(function(a,f){this.dragAndDropOver(!1);var e=this,g=c.isUnd(f.FileName)?"":f.FileName.toString(),h=c.isNormal(f.Size)?c.pInt(f.Size):null,g=new N(a,g,h);g.cancel=function(){e.attachments.remove(function(b){return b&&b.id===a});d&&d.cancel(a)};this.attachments.push(g);return 0<h&&0<b&&b<h?(g.error(c.i18n("UPLOAD/ERROR_FILE_IS_TOO_BIG")),
!1):!0},this),onStart:h.bind(function(b){var d=null;c.isUnd(a[b])?(d=this.getAttachmentById(b))&&(a[b]=d):d=a[b];d&&(d.waiting(!1),d.uploading(!0))},this),onComplete:h.bind(function(b,d,f){var e="",g=null,h=null,i=this.getAttachmentById(b),h=d&&f&&f.Result&&f.Result.Attachment?f.Result.Attachment:null,g=f&&f.Result&&f.Result.ErrorCode?f.Result.ErrorCode:null;null!==g?e=c.getUploadErrorDescByCode(g):h||(e=c.i18n("UPLOAD/ERROR_UNKNOWN"));i&&(""!==e&&0<e.length?i.waiting(!1).uploading(!1).error(e):h&&
(i.waiting(!1).uploading(!1),i.initByUploadJson(h)),c.isUnd(a[b])&&delete a[b])},this)});d?this.addAttachmentEnabled(!0).dragAndDropEnabled(d.isDragAndDropSupported()):this.addAttachmentEnabled(!1).dragAndDropEnabled(!1)}};y.prototype.prepearAttachmentsForSendOrSave=function(){var a={};h.each(this.attachmentsInReady(),function(b){b&&(""!==b.tempName()&&b.enabled())&&(a[b.tempName()]=[b.fileName(),b.isInline?"1":"0",b.CID])});return a};y.prototype.addMessageAsAttachment=function(a){if(a){var b=this,
d=null,d=a.subject(),d=".eml"===d.substr(-4).toLowerCase()?d:d+".eml",d=new N(a.requestHash,d,a.size());d.fromMessage=!0;var c=a.requestHash;d.cancel=function(){b.attachments.remove(function(a){return a&&a.id===c})};d.waiting(!1).uploading(!0);this.attachments.push(d)}};y.prototype.addDropboxAttachment=function(a){var b=this,d=c.pInt(f.settingsGet("AttachmentLimit")),e=null,h=a.bytes,e=new N(a.link,a.name,h);e.fromMessage=!1;var s=a.link;e.cancel=function(){b.attachments.remove(function(a){return a&&
a.id===s})};e.waiting(!1).uploading(!0);this.attachments.push(e);if(0<h&&0<d&&d<h)return e.uploading(!1),e.error(c.i18n("UPLOAD/ERROR_FILE_IS_TOO_BIG")),!1;f.remote().composeUploadExternals(function(a,b){var d=!1;e.uploading(!1);g.StorageResultType.Success===a&&(b&&b.Result)&&b.Result[e.id]&&(d=!0,e.tempName(b.Result[e.id]));d||e.error(c.getUploadErrorDescByCode(g.UploadErrorCode.FileNoUploaded))},[a.link]);return!0};y.prototype.prepearMessageAttachments=function(a,b){if(a){var d=this,f=c.isNonEmptyArray(a.attachments())?
a.attachments():[],e=0,s=f.length,h=null,k=null,i=function(a){return function(){d.attachments.remove(function(b){return b&&b.id===a})}};if(g.ComposeType.ForwardAsAttachment===b)this.addMessageAsAttachment(a);else for(;e<s;e++)k=f[e],h=new N(k.download,k.fileName,k.estimatedSize,k.isInline,k.isLinked,k.cid),h.fromMessage=!0,h.cancel=i(k.download),h.waiting(!1).uploading(!0),this.attachments.push(h)}};y.prototype.removeLinkedAttachments=function(){this.attachments.remove(function(a){return a&&a.isLinked})};
y.prototype.setMessageAttachmentFailedDowbloadText=function(){h.each(this.attachments(),function(a){a&&a.fromMessage&&a.waiting(!1).uploading(!1).error(c.getUploadErrorDescByCode(g.UploadErrorCode.FileNoUploaded))},this)};y.prototype.isEmptyForm=function(a){a=(a=c.isUnd(a)?!0:!!a)?0===this.attachments().length:0===this.attachmentsInReady().length;return 0===this.to().length&&0===this.cc().length&&0===this.bcc().length&&0===this.subject().length&&a&&""===this.oEditor.getTextForRequest()};y.prototype.reset=
...
y.prototype.getAttachmentsDownloadsForUpload=function(){return h.map(h.filter(this.attachments(),function(a){return a&&""===a.tempName()}),function(a){return a.id})};y.prototype.triggerForResize=function(){this.resizer(!this.resizer())};c.extendAsViewModel("PopupsContactsViewModel",L);L.prototype.removeCheckedOrSelectedContactsFromList=function(){var a=this,b=this.contacts,d=this.currentContact(),c=this.contactsCheckedOrSelected();0<c.length&&(h.each(c,function(b){d&&d.idContact===b.idContact&&(d=
null,a.currentContact(null));b.deleted(!0)}),h.delay(function(){h.each(c,function(a){b.remove(a)})},500))};L.prototype.deleteSelectedContacts=function(){0<this.contactsCheckedOrSelected().length&&(f.remote().contactsDelete(h.bind(this.deleteResponse,this),this.contactsCheckedOrSelectedUids()),this.removeCheckedOrSelectedContactsFromList())};L.prototype.deleteResponse=function(a,b){500<(g.StorageResultType.Success===a&&b&&b.Time?c.pInt(b.Time):0)?this.reloadContactList():h.delay(function(a){return function(){a.reloadContactList()}}(this),
...
(f=h.map(d.Result.List,function(a){var b=new ja;return b.parse(a)?b:null}),f=h.compact(f));a.contacts(f);a.viewClearSearch(""!==a.search());a.contacts.loading(!1);""!==a.viewID()&&(!a.currentContact()&&a.contacts.setSelectedByUid)&&a.contacts.setSelectedByUid(""+a.viewID())},this.search())};L.prototype.onBuild=function(a){this.initUploader();this.oContentVisible=i(".b-list-content",a);this.oContentScrollable=i(".content",this.oContentVisible);this.selector.init(this.oContentVisible,this.oContentScrollable);
this.viewImageUrl.valueHasMutated();e.computed(function(){var a=this.modalVisibility(),d=f.data().useKeyboardShortcuts();this.selector.useKeyboard(a&&d)},this)};L.prototype.initUploader=function(){var a=this,b=null;j.File&&(j.FileReader&&this.imageUploader())&&(b=new ra({queueSize:1,multipleSizeLimit:1,clickElement:this.imageUploader(),disableDragAndDrop:!0,disableMultiple:!0,onSelect:function(b,f){if(f&&f.File&&f.File.type){var e=null,g=f.File;f.File.type.match(/image.*/)?(e=new j.FileReader,e.onload=
function(b){b&&(b.target&&b.target.result)&&c.resizeAndCrop(b.target.result,150,function(b){a.viewImageUrl(b);a.imageTrigger(!0)})},e.readAsDataURL(g)):j.alert("this file is not an image.")}return!1}}));return b};L.prototype.onShow=function(){r.routeOff();this.reloadContactList()};L.prototype.onHide=function(){r.routeOn();this.currentContact(null);this.emptySelection(!0);this.search("");h.each(this.contacts(),function(a){a.checked(!1)})};c.extendAsViewModel("PopupsAdvancedSearchViewModel",ca);ca.prototype.buildSearchStringValue=
...
break;case g.LoginSignMeTypeAsString.DefaultOn:this.signMeType(g.LoginSignMeType.DefaultOn);break;default:case g.LoginSignMeTypeAsString.Unused:this.signMeType(g.LoginSignMeType.Unused)}this.email(f.data().devEmail);this.login(f.data().devLogin);this.password(f.data().devPassword);this.googleLoginEnabled()&&(j["rl_"+b+"_google_login_service"]=d);this.facebookLoginEnabled()&&(j["rl_"+b+"_facebook_login_service"]=d);this.twitterLoginEnabled()&&(j["rl_"+b+"_twitter_login_service"]=d)};h.extend(Q.prototype,
C.prototype);Q.prototype.accountClick=function(a,b){if(a&&b&&!c.isUnd(b.which)&&1===b.which){var d=this;this.accountsLoading(!0);h.delay(function(){d.accountsLoading(!1)},1E3)}return!0};Q.prototype.emailTitle=function(){return f.data().accountEmail()};Q.prototype.settingsClick=function(){r.setHash(f.link().settings())};Q.prototype.addAccountClick=function(){this.allowAddAccount&&r.showScreenPopup(da)};Q.prototype.logoutClick=function(){f.remote().logout(function(){j.__rlah_clear&&j.__rlah_clear();
f.loginAndLogoutReload(!0,f.settingsGet("ParentEmail")&&0<f.settingsGet("ParentEmail").length)})};h.extend(Va.prototype,Q.prototype);h.extend(Wa.prototype,Q.prototype);c.extendAsViewModel("MailBoxFolderListViewModel",ea);ea.prototype.onBuild=function(a){a.on("click",".b-folders .e-item .e-link .e-collapsed-sign",function(a){var d=e.dataFor(this),f=!1;d&&a&&(f=d.collapsed(),c.setExpandedFolder(d.fullNameHash,f),d.collapsed(!f),a.preventDefault(),a.stopPropagation())}).on("click",".b-folders .e-item .e-link.selectable",
...
s=f.data(),i=f.cache().getFolderFromCacheList(a),k=""===d?null:f.cache().getFolderFromCacheList(d||""),j=s.currentFolderFullNameRaw(),o=s.message(),q=j===a?h.filter(s.messageList(),function(a){return a&&-1<c.inArray(a.uid,b)}):[];e||h.each(q,function(a){a&&a.unseen()&&g++});i&&!e&&(i.messageCountAll(0<=i.messageCountAll()-b.length?i.messageCountAll()-b.length:0),0<g&&i.messageCountUnread(0<=i.messageCountUnread()-g?i.messageCountUnread()-g:0));k&&!e&&(k.messageCountAll(k.messageCountAll()+b.length),
0<g&&k.messageCountUnread(k.messageCountUnread()+g));0<q.length&&(h.each(q,function(a){if(o&&o.requestHash===a.requestHash){o=null;s.message(null)}a.deleted(true)}),h.delay(function(){h.each(q,function(a){s.messageList.remove(a)})},400),e||(f.data().messageListIsNotCompleted(!0),f.cache().setFolderHash(a,""),c.isNormal(d)&&f.cache().setFolderHash(d||"","")))};z.prototype.removeCheckedOrSelectedMessagesFromList=function(a){this.removeMessagesFromList(f.data().currentFolderFullNameRaw(),h.map(f.data().messageListCheckedOrSelected(),
function(a){return a.uid}),a)};z.prototype.moveOrDeleteResponse=function(a,b){g.StorageResultType.Success===a&&f.data().currentFolder()&&(b&&c.isArray(b.Result)&&2===b.Result.length?f.cache().setFolderHash(b.Result[0],b.Result[1]):(b&&g.Notification.CantMoveMessage===b.ErrorCode&&j.alert(c.getNotification(g.Notification.CantMoveMessage)),f.cache().setFolderHash(f.data().currentFolderFullNameRaw(),"")),f.reloadMessageList(),f.quotaDebounce())};z.prototype.moveMessagesToFolder=function(a,b,d){if(a!==
d&&c.isArray(b)&&0<b.length){var e=f.cache().getFolderFromCacheList(a),g=f.cache().getFolderFromCacheList(d);if(e&&g)return f.remote().messagesMove(h.bind(this.moveOrDeleteResponse,this),e.fullNameRaw,g.fullNameRaw,b),g.actionBlink(!0),this.removeMessagesFromList(a,b,d),!0}return!1};z.prototype.moveSelectedMessagesToFolder=function(a){return this.canBeMoved()?this.moveMessagesToFolder(f.data().currentFolderFullNameRaw(),f.data().messageListCheckedOrSelectedUidsWithSubMails(),a):!1};z.prototype.deleteSelectedMessageFromCurrentFolder=
function(a,b){if(this.canBeMoved()){var b=c.isUnd(b)?!0:!!b,d=f.cache().getFolderFromCacheList(g.FolderType.Spam===a?f.data().spamFolder():f.data().trashFolder());!d&&b?r.showScreenPopup(X,[g.FolderType.Spam===a?g.SetSystemFoldersNotification.Spam:g.SetSystemFoldersNotification.Trash]):!b||d&&(t.Values.UnuseOptionValue===d.fullNameRaw||f.data().currentFolderFullNameRaw()===d.fullNameRaw)?(f.remote().messagesDelete(h.bind(this.moveOrDeleteResponse,this),f.data().currentFolderFullNameRaw(),f.data().messageListCheckedOrSelectedUidsWithSubMails()),
this.removeCheckedOrSelectedMessagesFromList()):d&&(f.remote().messagesMove(h.bind(this.moveOrDeleteResponse,this),f.data().currentFolderFullNameRaw(),d.fullNameRaw,f.data().messageListCheckedOrSelectedUidsWithSubMails()),d.actionBlink(!0),this.removeCheckedOrSelectedMessagesFromList(d.fullNameRaw))}};z.prototype.dragAndDronHelper=function(a){a&&a.checked(!0);a=c.draggeblePlace();a.data("rl-folder",f.data().currentFolderFullNameRaw());a.data("rl-uids",f.data().messageListCheckedOrSelectedUidsWithSubMails());
...
a.uid)?f.data().messageLoading(!0):c.log("Error: Unknown message request: "+a.folderFullNameRaw+" ~ "+a.uid+" [e-101]"))};z.prototype.setAction=function(a,b,d){var e=[],i=null,s=f.cache(),j=0;c.isUnd(d)&&(d=f.data().messageListChecked());e=h.map(d,function(a){return a.uid});if(""!==a&&0<e.length){switch(b){case g.MessageSetAction.SetSeen:h.each(d,function(a){a.unseen()&&j++;a.unseen(!1);s.storeMessageFlagsToCache(a)});(i=s.getFolderFromCacheList(a))&&i.messageCountUnread(i.messageCountUnread()-j);
f.remote().messageSetSeen(c.emptyFunction,a,e,!0);break;case g.MessageSetAction.UnsetSeen:h.each(d,function(a){a.unseen()&&j++;a.unseen(!0);s.storeMessageFlagsToCache(a)});(i=s.getFolderFromCacheList(a))&&i.messageCountUnread(i.messageCountUnread()-j+e.length);f.remote().messageSetSeen(c.emptyFunction,a,e,!1);break;case g.MessageSetAction.SetFlag:h.each(d,function(a){a.flagged(!0);s.storeMessageFlagsToCache(a)});f.remote().messageSetFlagged(c.emptyFunction,a,e,!0);break;case g.MessageSetAction.UnsetFlag:h.each(d,
function(a){a.flagged(!1);s.storeMessageFlagsToCache(a)}),f.remote().messageSetFlagged(c.emptyFunction,a,e,!1)}f.reloadFlagsCurrentMessageListAndMessageFromCache()}};z.prototype.setActionForAll=function(a,b){var d=null,e=f.data().messageList(),i=f.cache();if(""!==a&&(d=i.getFolderFromCacheList(a))){switch(b){case g.MessageSetAction.SetSeen:if(d=i.getFolderFromCacheList(a))h.each(e,function(a){a.unseen(!1)}),d.messageCountUnread(0),i.clearMessageFlagsFromCacheByFolder(a);f.remote().messageSetSeenToAll(c.emptyFunction,
a,!0);break;case g.MessageSetAction.UnsetSeen:if(d=i.getFolderFromCacheList(a))h.each(e,function(a){a.unseen(!0)}),d.messageCountUnread(d.messageCountAll()),i.clearMessageFlagsFromCacheByFolder(a);f.remote().messageSetSeenToAll(c.emptyFunction,a,!1)}f.reloadFlagsCurrentMessageListAndMessageFromCache()}};z.prototype.listSetSeen=function(){this.setAction(f.data().currentFolderFullNameRaw(),g.MessageSetAction.SetSeen,f.data().messageListCheckedOrSelected())};z.prototype.listSetAllSeen=function(){this.setActionForAll(f.data().currentFolderFullNameRaw(),
...
z.prototype.onBuild=function(a){var b=this,d=f.data();this.oContentVisible=i(".b-content",a);this.oContentScrollable=i(".content",this.oContentVisible);this.oContentVisible.on("click",".fullThreadHandle",function(){var a=[],b=e.dataFor(this);b&&!b.lastInCollapsedThreadLoading()&&(f.data().messageListThreadFolder(b.folderFullNameRaw),a=f.data().messageListThreadUids(),b.lastInCollapsedThread()?a.push(0<b.parentUid()?b.parentUid():b.uid):a=h.without(a,0<b.parentUid()?b.parentUid():b.uid),f.data().messageListThreadUids(h.uniq(a)),
b.lastInCollapsedThreadLoading(!0),b.lastInCollapsedThread(!b.lastInCollapsedThread()),f.reloadMessageList());return!1});this.selector.init(this.oContentVisible,this.oContentScrollable);Ca.on("keydown",function(a){var e=!0,h=a?a.keyCode:0;if(a&&b.viewModelVisibility()&&d.useKeyboardShortcuts()&&!f.popupVisibility()&&!d.messageFullScreenMode()&&!c.inFocus()&&(d.usePreviewPane()||!d.message()&&(g.EventKeyCode.Delete===h||g.EventKeyCode.A===h))&&a.ctrlKey&&g.EventKeyCode.A===h)b.checkAll(!(b.checkAll()&&
!b.isIncompleteChecked())),e=!1;return e});a.on("click",".pagenator .page",function(){var a=e.dataFor(this);a&&r.setHash(f.link().mailBox(d.currentFolderFullNameHash(),a.value,d.messageListSearch()))}).on("click",".messageList .checkboxCkeckAll",function(){b.checkAll(!b.checkAll())}).on("click",".messageList .messageListItem .flagParent",function(){var a=e.dataFor(this),f=d.messageListCheckedOrSelected(),i=[];a&&(0<f.length&&(i=h.map(f,function(a){return a.uid})),0<i.length&&-1<c.inArray(a.uid,i)?
b.setAction(a.folderFullNameRaw,a.flagged()?g.MessageSetAction.UnsetFlag:g.MessageSetAction.SetFlag,f):b.setAction(a.folderFullNameRaw,a.flagged()?g.MessageSetAction.UnsetFlag:g.MessageSetAction.SetFlag,[a]))});e.computed(function(){var a=f.data(),b=this.viewModelVisibility(),d=f.popupVisibility(),c=a.useKeyboardShortcuts(),a=a.messageFullScreenMode();this.selector.useKeyboard(b&&c&&!a&&!d)},this);this.initUploaderForAppend()};z.prototype.composeClick=function(){r.showScreenPopup(y)};z.prototype.advancedSearchClick=
function(){r.showScreenPopup(ca)};z.prototype.quotaTooltip=function(){return c.i18n("MESSAGE_LIST/QUOTA_SIZE",{SIZE:c.friendlySize(this.userUsageSize()),PROC:this.userUsageProc(),LIMIT:c.friendlySize(this.userQuota())})};z.prototype.initUploaderForAppend=function(){return!f.settingsGet("AllowAppendMessage")||!this.dragOverArea()?!1:!!new ra({action:f.link().append(),name:"AppendFile",queueSize:1,multipleSizeLimit:1,disableFolderDragAndDrop:!0,hidden:{Folder:function(){return f.data().currentFolderFullNameRaw()}},
dragAndDropElement:this.dragOverArea(),dragAndDropBodyElement:this.dragOverBodyArea(),onDragEnter:h.bind(function(){this.dragOverEnter(true)},this),onDragLeave:h.bind(function(){this.dragOverEnter(false)},this),onBodyDragEnter:h.bind(function(){this.dragOver(true)},this),onBodyDragLeave:h.bind(function(){this.dragOver(false)},this),onSelect:h.bind(function(a,b){if(a&&b&&"message/rfc822"===b.Type){f.data().messageListLoading(true);return true}return false}),onComplete:h.bind(function(){f.reloadMessageList(true,
true)},this)})};c.extendAsViewModel("MailBoxMessageViewViewModel",H);H.prototype.scrollToTop=function(){var a=i(".messageItem.nano .content",this.viewModelDom);a&&a[0]?a.scrollTop(0):i(".messageItem",this.viewModelDom).scrollTop(0);c.windowResize()};H.prototype.fullScreen=function(){this.fullScreenMode(!0);c.windowResize()};H.prototype.unFullScreen=function(){this.fullScreenMode(!1);c.windowResize()};H.prototype.toggleFullScreen=function(){c.removeSelection();this.fullScreenMode(!this.fullScreenMode());
c.windowResize()};H.prototype.replyOrforward=function(a){r.showScreenPopup(y,[a,f.data().message()])};H.prototype.onBuild=function(a){var b=this,d=f.data();Ca.on("keydown",function(a){var f=!0,a=a?a.keyCode:0;if(0<a&&(g.EventKeyCode.Backspace===a||g.EventKeyCode.Esc===a)&&b.viewModelVisibility()&&d.useKeyboardShortcuts()&&!c.inFocus()&&d.message())b.fullScreenMode(!1),d.usePreviewPane()||d.message(null),f=!1;return f});i(".attachmentsPlace",a).magnificPopup({delegate:".magnificPopupImage:visible",
...
this.oMessageScrollerDom[0]?this.oMessageScrollerDom:null};H.prototype.isDraftFolder=function(){return f.data().message()&&f.data().draftFolder()===f.data().message().folderFullNameRaw};H.prototype.isSentFolder=function(){return f.data().message()&&f.data().sentFolder()===f.data().message().folderFullNameRaw};H.prototype.isDraftOrSentFolder=function(){return this.isDraftFolder()||this.isSentFolder()};H.prototype.composeClick=function(){r.showScreenPopup(y)};H.prototype.editMessage=function(){f.data().message()&&
r.showScreenPopup(y,[g.ComposeType.Draft,f.data().message()])};H.prototype.scrollMessageToTop=function(){this.oMessageScrollerDom&&this.oMessageScrollerDom.scrollTop(0)};H.prototype.showImages=function(a){a&&a.showExternalImages&&a.showExternalImages(!0)};c.extendAsViewModel("SettingsMenuViewModel",xa);xa.prototype.link=function(a){return f.link().settings(a)};xa.prototype.backToMailBoxClick=function(){r.setHash(f.link().inbox())};c.extendAsViewModel("SettingsPaneViewModel",ya);ya.prototype.onShow=
function(){f.data().message(null)};ya.prototype.backToMailBoxClick=function(){r.setHash(f.link().inbox())};c.addSettingsViewModel(La,"SettingsGeneral","SETTINGS_LABELS/LABEL_GENERAL_NAME","general",!0);La.prototype.onBuild=function(){var a=this;h.delay(function(){var b=f.data(),d=c.settingsSaveHelperSimpleFunction(a.mppTrigger,a);b.language.subscribe(function(b){a.languageTrigger(g.SaveSettingsStep.Animate);i.ajax({url:f.link().langLink(b),dataType:"script",cache:!0}).done(function(){c.i18nToDoc();
a.languageTrigger(g.SaveSettingsStep.TrueResult)}).fail(function(){a.languageTrigger(g.SaveSettingsStep.FalseResult)}).always(function(){h.delay(function(){a.languageTrigger(g.SaveSettingsStep.Idle)},1E3)});f.remote().saveSettings(c.emptyFunction,{Language:b})});b.editorDefaultType.subscribe(function(a){f.remote().saveSettings(c.emptyFunction,{EditorDefaultType:a})});b.messagesPerPage.subscribe(function(a){f.remote().saveSettings(d,{MPP:a})});b.showImages.subscribe(function(a){f.remote().saveSettings(c.emptyFunction,
...
"");f.remote().folderSetSubscribe(c.emptyFunction,a.fullNameRaw,!0);a.subScribed(!0)};S.prototype.unSubscribeFolder=function(a){f.local().set(g.ClientSideKeyName.FoldersLashHash,"");f.remote().folderSetSubscribe(c.emptyFunction,a.fullNameRaw,!1);a.subScribed(!1)};c.addSettingsViewModel(za,"SettingsThemes","SETTINGS_LABELS/LABEL_THEMES_NAME","themes");za.prototype.removeCustomThemeImg=function(){this.customThemeImg("")};za.prototype.onBuild=function(){var a=this,b=f.data().theme();this.themesObjects(h.map(f.data().themes(),
function(a){return{name:a,nameDisplay:c.convertThemeName(a),selected:e.observable(a===b),themePreviewSrc:f.link().themePreviewLink(a)}}));h.delay(function(){a.customThemeType.subscribe(function(a){f.remote().saveSettings(function(){f.data().theme.valueHasMutated()},{CustomThemeType:a})});a.customThemeImg.subscribe(function(a){f.remote().saveSettings(function(){f.data().theme.valueHasMutated()},{CustomThemeImg:a})})},50);this.initCustomThemeUploader()};za.prototype.initCustomThemeUploader=function(){return this.customThemeUploaderButton()?
!!new ra({action:f.link().uploadBackground(),name:"uploader",queueSize:1,multipleSizeLimit:1,disableFolderDragAndDrop:!0,clickElement:this.customThemeUploaderButton(),onSelect:h.bind(function(a,b){var d=c.isUnd(b.FileName)?"":b.FileName.toString(),d=d.substring(d.length-4,d.length),f=c.isNormal(b.Size)?c.pInt(b.Size):null;return-1===c.inArray(d,["jpeg",".jpg",".png"])?(j.alert(c.i18n("SETTINGS_THEMES/ERROR_FILE_TYPE_ERROR")),!1):1048576<f?(j.alert(c.i18n("SETTINGS_THEMES/ERROR_FILE_IS_TOO_BIG")),
!1):!0},this),onStart:h.bind(function(){this.customThemeUploaderProgress(!0)},this),onComplete:h.bind(function(a,b,d){!b||!d||!d.Result?j.alert(d&&d.ErrorCode?c.getUploadErrorDescByCode(d.ErrorCode):c.getUploadErrorDescByCode(g.UploadErrorCode.Unknown)):this.customThemeImg(d.Result);this.customThemeUploaderProgress(!1)},this)}):!1};Na.prototype.populateDataOnStart=function(){var a=f.settingsGet("Languages"),b=f.settingsGet("Themes");c.isArray(a)&&this.languages(a);c.isArray(b)&&this.themes(b);this.mainLanguage(f.settingsGet("Language"));
...
this.twitterConsumerSecret(f.settingsGet("TwitterConsumerSecret"));this.googleEnable(!!f.settingsGet("AllowGoogleSocial"));this.googleClientID(f.settingsGet("GoogleClientID"));this.googleClientSecret(f.settingsGet("GoogleClientSecret"));this.dropboxEnable(!!f.settingsGet("AllowDropboxSocial"));this.dropboxApiKey(f.settingsGet("DropboxApiKey"));this.contactsIsSupported(!!f.settingsGet("ContactsIsSupported"))};h.extend(T.prototype,Na.prototype);T.prototype.populateDataOnStart=function(){Na.prototype.populateDataOnStart.call(this);
...
this.devEmail=f.settingsGet("DevEmail");this.devLogin=f.settingsGet("DevLogin");this.devPassword=f.settingsGet("DevPassword")};T.prototype.initUidNextAndNewMessages=function(a,b,d){if("INBOX"===a&&c.isNormal(b)&&""!==b){if(c.isArray(d)&&0<d.length){var e=f.cache(),g=0,i=d.length,w=function(a,b,d){var c=null;if(ia&&f.data().useDesktopNotifications()&&(c=new ia(b,{body:d,icon:a})))c.show&&c.show(),j.setTimeout(function(a){return function(){a.cancel?a.cancel():a.close&&a.close()}}(c),7E3)};h.each(d,
function(b){e.addNewMessageCache(a,b.Uid)});if(3<i)w(f.link().notificationMailIcon(),f.data().accountEmail(),c.i18n("MESSAGE_LIST/NEW_MESSAGE_NOTIFICATION",{COUNT:i}));else for(;g<i;g++)w(f.link().notificationMailIcon(),m.emailsToLine(m.initEmailsFromJson(d[g].From),!1),d[g].Subject)}f.cache().setFolderUidNext(a,b)}};T.prototype.folderResponseParseRec=function(a,b,d){for(var e=0,g=0,h=null,i=null,j="",h=[],m=[],d=!!d,e=0,g=b.length;e<g;e++)if(h=b[e]){j=h.FullNameRaw;i=f.cache().getFolderFromCacheList(j);
if(!i&&(i=G.newInstanceFromJson(h)))if(f.cache().setFolderToCacheList(j,i),f.cache().setFolderFullNameRaw(i.fullNameHash,j),i.isGmailFolder=t.Values.GmailFolderName.toLowerCase()===j.toLowerCase(),""!==a&&a===i.fullNameRaw+i.delimiter&&(i.isNamespaceFolder=!0),i.isNamespaceFolder||i.isGmailFolder)i.isUnpaddigFolder=!0;i&&(i.collapsed(!c.isFolderExpanded(i.fullNameHash)),!d&&h.Extended&&(h.Extended.Hash&&f.cache().setFolderHash(i.fullNameRaw,h.Extended.Hash),c.isNormal(h.Extended.MessageCount)&&i.messageCountAll(h.Extended.MessageCount),
c.isNormal(h.Extended.MessageUnseenCount)&&i.messageCountUnread(h.Extended.MessageUnseenCount)),(h=h.SubFolders)&&("Collection/FolderCollection"===h["@Object"]&&h["@Collection"]&&c.isArray(h["@Collection"]))&&i.subFolders(this.folderResponseParseRec(a,h["@Collection"],d)),m.push(i))}return m};T.prototype.setFolders=function(a,b){var d=[],e=f.data(),h=0===e.folderList().length,i=function(a){return""===a||t.Values.UnuseOptionValue===a||null!==f.cache().getFolderFromCacheList(a)?a:""};a&&(a.Result&&
"Collection/FolderCollection"===a.Result["@Object"]&&a.Result["@Collection"]&&c.isArray(a.Result["@Collection"]))&&(c.isUnd(a.Result.Namespace)||(e.namespace=a.Result.Namespace),d=this.folderResponseParseRec(e.namespace,a.Result["@Collection"],!!b),e.folderList(d),e.sentFolder(i(f.settingsGet("SentFolder"))),e.draftFolder(i(f.settingsGet("DraftFolder"))),e.spamFolder(i(f.settingsGet("SpamFolder"))),e.trashFolder(i(f.settingsGet("TrashFolder"))),b||f.local().set(g.ClientSideKeyName.FoldersLashHash,
a.Result.FoldersHash),h&&b&&f.folders(!1))};T.prototype.hideMessageBodies=function(){var a=this.messagesBodiesDom();a&&a.find(".b-text-part").hide()};T.prototype.setMessage=function(a,b){var d=!1,e=!1,g=!1,h=null,e=null,d="",j=this.messagesBodiesDom(),k=this.message();if(a&&k&&a.Result&&"Object/Message"===a.Result["@Object"]&&k.folderFullNameRaw===a.Result.Folder&&k.uid===a.Result.Uid){this.messageError("");k.initUpdateByMessageJson(a.Result);f.cache().addRequestedMessage(k.folderFullNameRaw,k.uid);
b||k.initFlagsByJson(a.Result);if(j=j&&j[0]?j:null)d="rl-"+k.requestHash.replace(/[^a-zA-Z0-9]/g,""),e=j.find("#"+d),!e||!e[0]?(e=!!a.Result.HasExternals,g=!!a.Result.HasInternals,h=i('<div id="'+d+'" />').hide(),c.isNormal(a.Result.Html)&&""!==a.Result.Html?(d=!0,h.html(a.Result.Html.toString()).addClass("b-text-part html")):c.isNormal(a.Result.Plain)&&""!==a.Result.Plain?(d=!1,h.html(a.Result.Plain.toString()).addClass("b-text-part plain")):d=!1,j.append(h),h.data("rl-is-html",d),h.data("rl-has-images",
...
n.messageCountAll(a.Result.MessageCount),c.isNormal(a.Result.MessageUnseenCount)&&(c.pInt(n.messageCountUnread())!==c.pInt(a.Result.MessageUnseenCount)&&(v=!0),n.messageCountUnread(a.Result.MessageUnseenCount)),this.initUidNextAndNewMessages(n.fullNameRaw,a.Result.UidNext,a.Result.NewMessages);v&&n&&f.cache().clearMessageFlagsFromCacheByFolder(n.fullNameRaw);i=0;for(j=a.Result["@Collection"].length;i<j;i++)if((t=a.Result["@Collection"][i])&&"Object/Message"===t["@Object"]){p=q[i];if(!p||!p.initByJson(t))p=
m.newInstanceFromJson(t);p&&(e.hasNewMessageAndRemoveFromCache(p.folderFullNameRaw,p.uid)&&5>=u&&(u++,p.newForAnimation(!0)),p.deleted(!1),b?f.cache().initMessageFlagsFromCache(p):f.cache().storeMessageFlagsToCache(p),p.lastInCollapsedThread(h&&-1<c.inArray(c.pInt(p.uid),h)?!0:!1),o.push(p))}d.messageListCount(k);d.messageListSearch(c.isNormal(a.Result.Search)?a.Result.Search:"");d.messageListEndSearch(c.isNormal(a.Result.Search)?a.Result.Search:"");d.messageListEndFolder(c.isNormal(a.Result.Folder)?
...
aa.prototype.oRequests={};aa.prototype.defaultResponse=function(a,b,d,c,e,h){switch(d){case "success":d=g.StorageResultType.Success;break;case "abort":d=g.StorageResultType.Abort;break;default:d=g.StorageResultType.Error}g.StorageResultType.Success===d&&(c&&!c.Result&&c.Logout)&&(j.__rlah_clear&&j.__rlah_clear(),f.loginAndLogoutReload(!0));a&&(x.runHook("ajax-default-response",[b,g.StorageResultType.Success===d?c:null,d,e,h]),a(d,g.StorageResultType.Success===d?c:null,e,b,h))};aa.prototype.ajaxRequest=
function(a,b,d,e,g){var s=this,w=""===e,k=(new j.Date).getTime(),m=null,o="",b=b||{},d=c.isNormal(d)?d:2E4,e=c.isUnd(e)?"":c.pString(e),g=c.isArray(g)?g:[];(o=b.Action||"")&&0<g.length&&h.each(g,function(a){s.oRequests[a]&&(s.oRequests[a].__aborted=!0,s.oRequests[a].abort&&s.oRequests[a].abort(),s.oRequests[a]=null)});w&&(b.XToken=f.settingsGet("Token"));m=i.ajax({type:w?"POST":"GET",url:f.link().ajax(e),async:!0,dataType:"json",data:w?b:{},headers:{},timeout:d,global:!0});m.always(function(d,f){var e=
!1;d&&d.Time&&(e=c.pInt(d.Time)>(new j.Date).getTime()-k);o&&s.oRequests[o]&&(s.oRequests[o].__aborted&&(f="abort"),s.oRequests[o]=null);s.defaultResponse(a,o,f,d,e,b)});o&&(0<g.length&&-1<c.inArray(o,g))&&(this.oRequests[o]&&(this.oRequests[o].__aborted=!0,this.oRequests[o].abort&&this.oRequests[o].abort(),this.oRequests[o]=null),this.oRequests[o]=m);return m};aa.prototype.defaultRequest=function(a,b,d,f,e,g){d=d||{};d.Action=b;e=c.pString(e);x.runHook("ajax-default-request",[b,d,e]);this.ajaxRequest(a,
d,c.isUnd(f)?t.Defaults.DefaultAjaxTimeout:c.pInt(f),e,g)};aa.prototype.noop=function(a){this.defaultRequest(a,"Noop")};aa.prototype.jsError=function(a,b,d,c){this.defaultRequest(a,"JsError",{Message:b,FileName:d,LineNo:c})};h.extend(p.prototype,aa.prototype);p.prototype.folders=function(a,b){var d=f.data().lastFoldersHash;(b=c.isUnd(b)?!1:!!b)&&""!==d?this.defaultRequest(a,"Folders",{},null,"Folders/"+f.data().projectHash()+"-"+d,["Folders"]):this.defaultRequest(a,"Folders",{},null,"",["Folders"])};
p.prototype.login=function(a,b,d,c,f){this.defaultRequest(a,"Login",{Email:b,Login:d,Password:c,SignMe:f?"1":"0"})};p.prototype.accountAdd=function(a,b,d,c){this.defaultRequest(a,"AccountAdd",{Email:b,Login:d,Password:c})};p.prototype.accountDelete=function(a,b){this.defaultRequest(a,"AccountDelete",{EmailToDelete:b})};p.prototype.accounts=function(a){this.defaultRequest(a,"Accounts")};p.prototype.messageList=function(a,b,d,e,g,h){var b=c.pString(b),i=f.data(),j=f.cache().getFolderHash(b),h=c.isUnd(h)?
!1:!!h,d=c.isUnd(d)?0:c.pInt(d),e=c.isUnd(d)?20:c.pInt(e),g=c.pString(g);""!==j?this.defaultRequest(a,"MessageList",{},""===g?t.Defaults.DefaultAjaxTimeout:t.Defaults.SearchAjaxTimeout,"MessageList/"+ga.urlsafe_encode([b,d,e,g,i.projectHash(),j,"INBOX"===b?f.cache().getFolderUidNext(b):"",i.threading&&i.useThreads()?"1":"0",i.threading&&b===i.messageListThreadFolder()?i.messageListThreadUids().join(","):""].join(String.fromCharCode(0))),h?[]:["MessageList"]):this.defaultRequest(a,"MessageList",{Folder:b,
Offset:d,Limit:e,Search:g,UidNext:"INBOX"===b?f.cache().getFolderUidNext(b):"",UseThreads:f.data().threading&&f.data().useThreads()?"1":"0",ExpandedThreadUid:i.threading&&b===i.messageListThreadFolder()?i.messageListThreadUids().join(","):""},""===g?t.Defaults.DefaultAjaxTimeout:t.Defaults.SearchAjaxTimeout,"",h?[]:["MessageList"])};p.prototype.messageUploadAttachments=function(a,b){this.defaultRequest(a,"MessageUploadAttachments",{Attachments:b},999E3)};p.prototype.message=function(a,b,d){b=c.pString(b);
d=c.pInt(d);return f.cache().getFolderFromCacheList(b)&&0<d?(this.defaultRequest(a,"Message",{},null,"Message/"+ga.urlsafe_encode([b,d,f.data().projectHash(),f.data().threading&&f.data().useThreads()?"1":"0"].join(String.fromCharCode(0))),["Message"]),!0):!1};p.prototype.composeUploadExternals=function(a,b){this.defaultRequest(a,"ComposeUploadExternals",{Externals:b},999E3)};p.prototype.folderInformation=function(a,b,d){var e=!0,g=f.cache(),i=[];c.isArray(d)&&0<d.length&&(e=!1,h.each(d,function(a){g.getMessageFlagsFromCache(a.folderFullNameRaw,
a.uid)||i.push(a.uid);0<a.threads().length&&h.each(a.threads(),function(b){g.getMessageFlagsFromCache(a.folderFullNameRaw,b)||i.push(b)})}),0<i.length&&(e=!0));e?this.defaultRequest(a,"FolderInformation",{Folder:b,FlagsUids:c.isArray(i)?i.join(","):"",UidNext:"INBOX"===b?f.cache().getFolderUidNext(b):""}):f.data().useThreads()&&f.reloadFlagsCurrentMessageListAndMessageFromCache()};p.prototype.logout=function(a){this.defaultRequest(a,"Logout")};p.prototype.messageSetFlagged=function(a,b,d,c){this.defaultRequest(a,
"MessageSetFlagged",{Folder:b,Uids:d.join(","),SetAction:c?"1":"0"})};p.prototype.messageSetSeen=function(a,b,d,c){this.defaultRequest(a,"MessageSetSeen",{Folder:b,Uids:d.join(","),SetAction:c?"1":"0"})};p.prototype.messageSetSeenToAll=function(a,b,d){this.defaultRequest(a,"MessageSetSeenToAll",{Folder:b,SetAction:d?"1":"0"})};p.prototype.saveMessage=function(a,b,d,c,f,e,g,h,i,j,m,p,n,r){this.defaultRequest(a,"SaveMessage",{MessageFolder:b,MessageUid:d,DraftFolder:c,To:f,Cc:e,Bcc:g,Subject:h,TextIsHtml:i?
"1":"0",Text:j,DraftInfo:p,InReplyTo:n,References:r,Attachments:m},t.Defaults.SaveMessageAjaxTimeout)};p.prototype.sendMessage=function(a,b,d,c,f,e,g,h,i,j,m,p,n,r){this.defaultRequest(a,"SendMessage",{MessageFolder:b,MessageUid:d,SentFolder:c,To:f,Cc:e,Bcc:g,Subject:h,TextIsHtml:i?"1":"0",Text:j,DraftInfo:p,InReplyTo:n,References:r,Attachments:m},t.Defaults.SendMessageAjaxTimeout)};p.prototype.saveSystemFolders=function(a,b){this.defaultRequest(a,"SystemFoldersUpdate",b)};p.prototype.saveSettings=
...
{}};U.prototype.getUserPic=function(a){var b="",b="",b=a.toLowerCase(),d=c.isUnd(this.oEmailsPicsHashes[a])?"":this.oEmailsPicsHashes[a];""===d?(b=b.substr(a.indexOf("@")+1),b=""!==b&&this.oServices[b]?this.oServices[b]:""):b=f.link().getUserPicUrlFromHash(d);return b};U.prototype.setServicesData=function(a){this.oServices=a};U.prototype.setEmailsPicsHashesData=function(a){this.oEmailsPicsHashes=a};h.extend(v.prototype,U.prototype);v.prototype.oFoldersCache={};v.prototype.oFoldersNamesCache={};v.prototype.oFolderHashCache=
...
(this.oMessageFlagsCache[a]={});this.oMessageFlagsCache[a][b]=c};v.prototype.clearMessageFlagsFromCacheByFolder=function(a){this.oMessageFlagsCache[a]={}};v.prototype.initMessageFlagsFromCache=function(a){if(a){var b=this,d=this.getMessageFlagsFromCache(a.folderFullNameRaw,a.uid),f=null,e=null;d&&4===d.length&&(a.unseen(d[0]),a.flagged(d[1]),a.answered(d[2]),a.forwarded(d[3]));0<a.threads().length&&(f=h.find(a.threads(),function(c){return(c=b.getMessageFlagsFromCache(a.folderFullNameRaw,c))&&4===
c.length&&!!c[0]}),e=h.find(a.threads(),function(c){return(c=b.getMessageFlagsFromCache(a.folderFullNameRaw,c))&&4===c.length&&!!c[1]}),a.hasUnseenSubMessage(f&&0<c.pInt(f)),a.hasFlaggedSubMessage(e&&0<c.pInt(e)))}};v.prototype.storeMessageFlagsToCache=function(a){a&&this.setMessageFlagsToCache(a.folderFullNameRaw,a.uid,[a.unseen(),a.flagged(),a.answered(),a.forwarded()])};v.prototype.storeMessageFlagsToCacheByFolderAndUid=function(a,b,d){c.isArray(d)&&4===d.length&&this.setMessageFlagsToCache(a,
b,d)};h.extend(fa.prototype,J.prototype);fa.prototype.onRoute=function(a){var b=this,d=null,g=null,j=null,s=null;if(g=h.find(Da,function(b){return b&&b.__rlSettingsData&&a===b.__rlSettingsData.Route}))h.find(Qa,function(a){return a&&a===g})&&(g=null),g&&h.find(Ra,function(a){return a&&a===g})&&(g=null);g&&(g.__builded&&g.__vm?d=g.__vm:(j=i("#rl-content #rl-settings-subscreen"))&&1===j.length?(d=new g,s=i("<div></div>").addClass("rl-settings-view-model").hide().attr("data-bind",'template: {name: "'+
...
"";a!==j.document.title&&(j.document.title=a)};I.prototype.loginAndLogoutReload=function(a,b){var d=c.pString(this.settingsGet("CustomLogoutLink")),e=!!this.settingsGet("InIframe"),a=c.isUnd(a)?!1:!!a,b=c.isUnd(b)?!1:!!b;a&&b&&j.close?j.close():a&&""!==d&&j.location.href!==d?h.defer(function(){e&&j.parent?j.parent.location.href=d:j.location.href=d}):(r.routeOff(),r.setHash(f.link().root(),!0),r.routeOff(),h.defer(function(){e&&j.parent?j.parent.location.reload():j.location.reload()}))};I.prototype.getAutocomplete=
function(a,b,c){c([],a)};I.prototype.bootstart=function(){c.initOnStartOrLangChange(function(){c.initNotificationLanguage()},null);h.delay(function(){c.windowResize()},1E3)};h.extend(A.prototype,I.prototype);A.prototype.oData=null;A.prototype.oRemote=null;A.prototype.oCache=null;A.prototype.data=function(){null===this.oData&&(this.oData=new T);return this.oData};A.prototype.remote=function(){null===this.oRemote&&(this.oRemote=new p);return this.oRemote};A.prototype.cache=function(){null===this.oCache&&
(this.oCache=new v);return this.oCache};A.prototype.reloadFlagsCurrentMessageListAndMessageFromCache=function(){var a=f.cache();h.each(f.data().messageList(),function(b){a.initMessageFlagsFromCache(b)});a.initMessageFlagsFromCache(f.data().message())};A.prototype.reloadMessageList=function(a,b){var d=f.data(),e=(d.messageListPage()-1)*d.messagesPerPage();(c.isUnd(b)?0:b)&&f.cache().setFolderHash(d.currentFolderFullNameRaw(),"");if(c.isUnd(a)?0:a)d.messageListPage(1),e=0;d.messageListLoading(!0);f.remote().messageList(function(a,
b,f){g.StorageResultType.Success===a&&b&&b.Result?(d.messageListError(""),d.messageListLoading(!1),d.setMessageList(b,f)):g.StorageResultType.Abort!==a&&(d.messageList([]),d.messageListLoading(!1),d.messageListError(b&&b.ErrorCode?c.getNotification(b.ErrorCode):c.i18n("NOTIFICATIONS/CANT_GET_MESSAGE_LIST")))},d.currentFolderFullNameRaw(),e,d.messagesPerPage(),d.messageListSearch())};A.prototype.recacheInboxMessageList=function(){f.remote().messageList(c.emptyFunction,"INBOX",0,f.data().messagesPerPage(),
"",!0)};A.prototype.folders=function(a,b){this.data().foldersLoading(!0);this.remote().folders(h.bind(function(a,c,e){f.data().foldersLoading(!1);g.StorageResultType.Success===a?(this.data().setFolders(c,e),b&&b(!0)):b&&b(!1)},this),a)};A.prototype.accounts=function(){f.data().accountsLoading(!0);f.remote().accounts(function(a,b){f.data().accountsLoading(!1);if(g.StorageResultType.Success===a&&c.isArray(b.Result)){var d=f.settingsGet("ParentEmail"),d=""===d?f.data().accountEmail():d;f.data().accounts(h.map(b.Result,
function(a){return new Ka(a,a!==d)}))}})};A.prototype.quota=function(){this.remote().quota(function(a,b){g.StorageResultType.Success===a&&(b&&b.Result&&c.isArray(b.Result)&&2===b.Result.length&&c.isPosNumeric(b.Result[0],!0)&&c.isPosNumeric(b.Result[1],!0))&&(f.data().userQuota(1024*c.pInt(b.Result[1])),f.data().userUsageSize(1024*c.pInt(b.Result[0])))})};A.prototype.folderInformation=function(a,b){this.remote().folderInformation(function(a,b){if(g.StorageResultType.Success===a&&b&&b.Result&&b.Result.Hash&&
b.Result.Folder){var e=f.cache().getFolderHash(b.Result.Folder),h=f.cache().getFolderFromCacheList(b.Result.Folder),i=!1,j="",m=[],m=!1,o=null;if(h){b.Result.Hash&&f.cache().setFolderHash(b.Result.Folder,b.Result.Hash);c.isNormal(b.Result.MessageCount)&&h.messageCountAll(b.Result.MessageCount);c.isNormal(b.Result.MessageUnseenCount)&&(c.pInt(h.messageCountUnread())!==c.pInt(b.Result.MessageUnseenCount)&&(m=!0),h.messageCountUnread(b.Result.MessageUnseenCount));m&&f.cache().clearMessageFlagsFromCacheByFolder(h.fullNameRaw);
...
a.folderFullNameRaw,[a.uid],!0)};A.prototype.googleConnect=function(){j.open(f.link().socialGoogle(),"Google","left=200,top=100,width=650,height=600,menubar=no,status=no,resizable=yes,scrollbars=yes")};A.prototype.twitterConnect=function(){j.open(f.link().socialTwitter(),"Twitter","left=200,top=100,width=650,height=350,menubar=no,status=no,resizable=yes,scrollbars=yes")};A.prototype.facebookConnect=function(){j.open(f.link().socialFacebook(),"Facebook","left=200,top=100,width=650,height=335,menubar=no,status=no,resizable=yes,scrollbars=yes")};
...
function(a,b,d,e,h,i,m,k,p){var o=0,q=0,n=null,r=[],p=!c.isNormal(p)?0<a.length:p,h=!c.isNormal(h)?0:h;c.isArray(d)||(d=[]);c.isArray(e)||(e=[]);o=0;for(q=e.length;o<q;o++)r.push({id:e[o][0],name:e[o][1],disable:!1});o=0;for(q=a.length;o<q;o++)if(n=a[o],c.isNormal(m)?m.call(null,n):1)r.push({id:n.fullNameRaw,system:!0,name:c.isNormal(k)?k.call(null,n):n.name(),disable:!n.selectable||-1<c.inArray(n.fullNameRaw,d)||(c.isNormal(i)?i.call(null,n):!1)});o=0;for(q=b.length;o<q;o++){n=b[o];if(!n.isGmailFolder&&
(n.subScribed()||!n.existen))if(c.isNormal(m)?m.call(null,n):1)if(g.FolderType.User===n.type()||!p||!n.isNamespaceFolder&&0<n.subFolders().length)r.push({id:n.fullNameRaw,system:!1,name:(new j.Array(n.deep+1-h)).join("\u00a0\u00a0\u00a0\u00a0")+(c.isNormal(k)?k.call(null,n):n.name()),disable:!n.selectable||-1<c.inArray(n.fullNameRaw,d)||g.FolderType.User!==n.type()||(c.isNormal(i)?i.call(null,n):!1)});n.isUnpaddigFolder&&h++;r=r.concat(f.folderListOptionsBuilder([],n.subFolders(),d,[],h,i,m,k,p))}return r};
A.prototype.getAutocomplete=function(a,b,d){var e=[];f.remote().suggestions(function(a,b){g.StorageResultType.Success===a&&b&&b.Result&&c.isArray(b.Result.List)?(e=h.map(b.Result.List,function(a){return a&&a[0]?new F(a[0],a[1]):null}),d(h.compact(e),!!b.Result.More)):g.StorageResultType.Abort!==a&&d([],!1)},a,b)};A.prototype.emailsPicsHashes=function(){f.remote().emailsPicsHashes(function(a,b){g.StorageResultType.Success===a&&(b&&b.Result)&&f.cache().setEmailsPicsHashesData(b.Result)})};A.prototype.bootstart=
function(){I.prototype.bootstart.call(this);f.data().populateDataOnStart();var a=this.settingsGet("JsHash"),b=this.settingsGet("AllowGoogleSocial"),d=this.settingsGet("AllowFacebookSocial"),e=this.settingsGet("AllowTwitterSocial");!this.settingsGet("RemoteChangePassword")&&ma&&c.removeSettingsViewModel(ma);!this.settingsGet("AllowAdditionalAccounts")&&la&&c.removeSettingsViewModel(la);!b&&(!d&&!e&&Ma)&&c.removeSettingsViewModel(Ma);c.initOnStartOrLangChange(function(){i.extend(!0,i.magnificPopup.defaults,
{tClose:c.i18n("MAGNIFIC_POPUP/CLOSE"),tLoading:c.i18n("MAGNIFIC_POPUP/LOADING"),gallery:{tPrev:c.i18n("MAGNIFIC_POPUP/GALLERY_PREV"),tNext:c.i18n("MAGNIFIC_POPUP/GALLERY_NEXT"),tCounter:c.i18n("MAGNIFIC_POPUP/GALLERY_COUNTER")},image:{tError:c.i18n("MAGNIFIC_POPUP/IMAGE_ERROR")},ajax:{tError:c.i18n("MAGNIFIC_POPUP/AJAX_ERROR")}})},this);this.settingsGet("Auth")?(this.setTitle(c.i18n("TITLES/LOADING")),this.folders(!0,h.bind(function(a){r.hideLoading();if(a){r.startScreens([V,Oa]);Ca.on("click","#rl-center a",
function(){var a=null,b=i(this).attr("href");if(b&&"mailto:"===b.toString().toLowerCase().substr(0,7)){a=new F;a.parse(j.decodeURI(b.toString().substr(7)));if(a&&a.email){r.showScreenPopup(y,[g.ComposeType.Empty,null,[a]]);return false}}return true});(b||d||e)&&f.socialUsers(true);h.delay(function(){f.emailsPicsHashes();f.remote().servicesPics(function(a,b){g.StorageResultType.Success===a&&(b&&b.Result)&&f.cache().setServicesData(b.Result)})},1E3);x.runHook("rl-start-user-screens")}else{r.startScreens([Aa]);
x.runHook("rl-start-login-screens")}},this))):(r.hideLoading(),r.startScreens([Aa]),x.runHook("rl-start-login-screens"));b&&(j["rl_"+a+"_google_service"]=function(){f.data().googleActions(true);f.socialUsers()});d&&(j["rl_"+a+"_facebook_service"]=function(){f.data().facebookActions(true);f.socialUsers()});e&&(j["rl_"+a+"_twitter_service"]=function(){f.data().twitterActions(true);f.socialUsers()});x.runHook("rl-start-screens")};f=new A;i(function(){j.setTimeout(function(){r.setBoot(f).bootstart()},
10);j.setInterval(function(){wa(!wa())},6E4);h.delay(function(){j.rainloopAppData={};j.rainloopI18N={}},100)});R.keydown(c.killCtrlAandS).keyup(c.killCtrlAandS);j.rl=j.rl||{};j.rl.addHook=x.addHook;j.rl.settingsGet=x.mainSettingsGet;j.rl.remoteRequest=x.remoteRequest;j.rl.pluginSettingsGet=x.settingsGet;j.rl.addSettingsViewModel=c.addSettingsViewModel;j.rl.createCommand=c.createCommand;j.rl.EmailModel=F;j.rl.Enums=g})(window,jQuery,ko,crossroads,hasher,moment,Jua,_);