...
N.on("error",function(a){e&&(a&&a.originalEvent&&a.originalEvent.message)&&(c.log(""+a.originalEvent.message+" ("+a.originalEvent.filename+":"+a.originalEvent.lineno+")"),e.remote().jsError(c.emptyFunction,a.originalEvent.message,a.originalEvent.filename,a.originalEvent.lineno))})}function A(){I.call(this);this.oCache=this.oRemote=this.oData=null;this.iSuggestionsLimit=c.pInt(this.settingsGet("SuggestionsLimit"));this.iSuggestionsLimit=0===this.iSuggestionsLimit?20:this.iSuggestionsLimit;this.quotaDebounce=
i.debounce(this.quota,3E4)}var t={},g={},u={},c={},x={},ga={},wa=f.observable(!0),ha=f.observable(!0),s=null,Ba=h.rainloopAppData||{},Pa=h.rainloopI18N||{},Z=j("html"),N=j(h),Ca=j(h.document),Da=[],Qa=[],Ra=[],ia=h.Notification&&h.Notification.requestPermission?h.Notification:null,Ea=(navigator.userAgent||"").toLowerCase(),Ya=!1,Za=-1<Ea.indexOf("iphone")||-1<Ea.indexOf("ipod")||-1<Ea.indexOf("ipad"),ib=-1<Ea.indexOf("android"),na=Za||ib;Z.addClass(na?"mobile":"no-mobile");var e=null;t.Defaults={};
...
b){for(var d="",l="",e=a,f=0,g=0,b=c.isUnd(b)?100:b;e.length>b;)l=e.substring(0,b),f=l.lastIndexOf(" "),g=l.lastIndexOf("\n"),-1!==g&&(f=g),-1===f&&(f=b),d+=l.substring(0,f)+"\n",e=e.substring(f+1);return d+e};var Fa={};c.timeOutAction=function(a,b,d){c.isUnd(Fa[a])&&(Fa[a]=0);h.clearTimeout(Fa[a]);Fa[a]=h.setTimeout(b,d)};var Sa={};c.timeOutActionSecond=function(a,b,d){Sa[a]||(Sa[a]=h.setTimeout(function(){b();Sa[a]=0},d))};var O=!1;c.audio=function(a,b){if(!1===O)if(Za)O=null;else{var d=!1,c=!1,
e=h.Audio?new h.Audio:null;e&&e.canPlayType&&e.play?((d=""!==e.canPlayType('audio/mpeg; codecs="mp3"'))||(c=""!==e.canPlayType('audio/ogg; codecs="vorbis"')),d||c?(O=e,O.preload="none",O.loop=!1,O.autoplay=!1,O.muted=!1,O.src=d?a:b):O=null):O=null}return O};c.hos=function(a,b){return a&&Object.hasOwnProperty?Object.hasOwnProperty.call(a,b):!1};c.i18n=function(a,b,d){var l="",a=c.isUnd(Pa[a])?c.isUnd(d)?a:d:Pa[a];if(!c.isUnd(b)&&!c.isNull(b))for(l in b)c.hos(b,l)&&(a=a.replace("%"+l+"%",b[l]));return a};
...
w.width(),b=b?100*(b.size.width/a):null,null===b&&d&&(b=100*(f.width()/a)),null!==b&&(f.css({width:"",height:"",right:""+(100-b)+"%"}),r.css({width:"",height:"",left:""+b+"%"}))};a&&f.width(a);f.resizable({minWidth:350,maxWidth:w.width()-250,handles:"e",resize:k,stop:k});k(null,null,!0);N.resize(i.throttle(function(a,b){if(c&&c()){var d=w.width();f.resizable("option","maxWidth",d-250);b&&(b.size&&b.size.width)&&e.local().set(g.ClientSideKeyName.MailBoxListSize,b.size.width);k(null,null,!0)}},400))};
...
a.__vm])}},d)}(f=e.__cross())&&f.parse(b)}))}};E.prototype.startScreens=function(a){i.each(a,function(a){var d=(a=new a)?a.screenName():"";a&&""!==d&&(""===this.sDefaultScreenName&&(this.sDefaultScreenName=d),this.oScreens[d]=a)},this);i.each(this.oScreens,function(a){a&&(!a.__started&&a.__start)&&(a.__started=!0,a.__start(),x.runHook("screen-pre-start",[a.screenName(),a]),this.delegateRun(a,"onStart"),x.runHook("screen-post-start",[a.screenName(),a]))},this);a=Ta.create();a.addRoute(/^([a-zA-Z0-9\-]*)\/?(.*)$/,
...
"");!this.modalVisibility()&&!d&&(this.savedError(!0),this.savedOrSendingText(c.getNotification(g.Notification.CantSaveMessage)))};y.prototype.onHide=function(){s.routeOn()};y.prototype.onShow=function(a,b,d){s.routeOff();var f=this,W="",r="",w="",k="",h="",o=null,k=o="",m=[],W={},k=e.data().accountEmail(),n=[],n=r=null,m=!1,a=a||g.ComposeType.Empty;(b=b||null)&&c.isNormal(b)&&(n=c.isArray(b)&&1===b.length?b[0]:!c.isArray(b)?b:null);null!==k&&(W[k]=!0);this.reset();c.isNonEmptyArray(d)&&this.to(d);
...
a===b[d].id)return b[d];return null};y.prototype.initEditor=function(){if(this.composeEditorTextArea()&&this.composeEditorHtmlArea()&&this.composeEditorToolbar()){var a=this;this.oEditor=new q(this.composeEditorTextArea(),this.composeEditorHtmlArea(),this.composeEditorToolbar(),{onSwitch:function(b){b||a.removeLinkedAttachments()}});this.oEditor.initLanguage(c.i18n("EDITOR/TEXT_SWITCHER_CONFIRM"),c.i18n("EDITOR/TEXT_SWITCHER_PLAINT_TEXT"),c.i18n("EDITOR/TEXT_SWITCHER_RICH_FORMATTING"))}};y.prototype.initUploader=
...
r=e.data(),h=e.cache().getFolderFromCacheList(a),k=""===d?null:e.cache().getFolderFromCacheList(d||""),j=r.currentFolderFullNameRaw(),o=r.message(),m=j===a?i.filter(r.messageList(),function(a){return a&&-1<c.inArray(a.uid,b)}):[];f||i.each(m,function(a){a&&a.unseen()&&g++});h&&!f&&(h.messageCountAll(0<=h.messageCountAll()-b.length?h.messageCountAll()-b.length:0),0<g&&h.messageCountUnread(0<=h.messageCountUnread()-g?h.messageCountUnread()-g:0));k&&!f&&(k.messageCountAll(k.messageCountAll()+b.length),
0<g&&k.messageCountUnread(k.messageCountUnread()+g));0<m.length&&(i.each(m,function(a){if(o&&o.requestHash===a.requestHash){o=null;r.message(null)}a.deleted(true)}),i.delay(function(){i.each(m,function(a){r.messageList.remove(a)})},400),f||(e.data().messageListIsNotCompleted(!0),e.cache().setFolderHash(a,""),c.isNormal(d)&&e.cache().setFolderHash(d||"","")))};z.prototype.removeCheckedOrSelectedMessagesFromList=function(a){this.removeMessagesFromList(e.data().currentFolderFullNameRaw(),i.map(e.data().messageListCheckedOrSelected(),
...
"SettingsAccounts","SETTINGS_LABELS/LABEL_ACCOUNTS_NAME","accounts");la.prototype.addNewAccount=function(){s.showScreenPopup(da)};la.prototype.deleteAccount=function(a){if(a&&a.deleteAccess()){this.accountForDeletion(null);var b=function(b){return a===b};a&&(e.data().accounts.remove(b),e.remote().accountDelete(function(){e.accounts()},a.email))}};c.addSettingsViewModel(Ma,"SettingsSocial","SETTINGS_LABELS/LABEL_SOCIAL_NAME","social");c.addSettingsViewModel(ma,"SettingsChangePassword","SETTINGS_LABELS/LABEL_CHANGE_PASSWORD_NAME",
...
1===h.length?(d=new g,r=j("<div></div>").addClass("rl-settings-view-model").hide().attr("data-bind",'template: {name: "'+g.__rlSettingsData.Template+'"}, i18nInit: true'),r.appendTo(h),d.data=e.data(),d.viewModelDom=r,d.__rlSettingsData=g.__rlSettingsData,g.__dom=r,g.__builded=!0,g.__vm=d,f.applyBindings(d,r[0]),s.delegateRun(d,"onBuild",[r])):c.log("Cannot find sub settings view model position: SettingsSubScreen"),d&&i.defer(function(){if(b.oCurrentSubScreen){s.delegateRun(b.oCurrentSubScreen,"onHide");
b.oCurrentSubScreen.viewModelDom.hide()}b.oCurrentSubScreen=d;if(b.oCurrentSubScreen){b.oCurrentSubScreen.viewModelDom.show();s.delegateRun(b.oCurrentSubScreen,"onShow");i.each(b.menu(),function(a){a.selected(d&&d.__rlSettingsData&&a.route===d.__rlSettingsData.Route)})}c.windowResize()}))};fa.prototype.onBuild=function(){i.each(Da,function(a){a&&(a.__rlSettingsData&&!i.find(Qa,function(b){return b&&b===a}))&&this.menu.push({route:a.__rlSettingsData.Route,label:a.__rlSettingsData.Label,selected:f.observable(!1),
...
h.SimplePace.set(70);this.settingsGet("Auth")?(this.setTitle(c.i18n("TITLES/LOADING")),this.folders(!0,i.bind(function(a){s.hideLoading();if(a){s.startScreens([U,Oa]);Ca.on("click","#rl-center a",function(){var a=null,b=j(this).attr("href");if(b&&"mailto:"===b.toString().toLowerCase().substr(0,7)){a=new F;a.parse(h.decodeURI(b.toString().substr(7)));if(a&&a.email){s.showScreenPopup(y,[g.ComposeType.Empty,null,[a]]);return false}}return true});(b||d||f)&&e.socialUsers(true);i.delay(function(){e.emailsPicsHashes();
e.remote().servicesPics(function(a,b){g.StorageResultType.Success===a&&(b&&b.Result)&&e.cache().setServicesData(b.Result)})},1E3);x.runHook("rl-start-user-screens")}else{s.startScreens([Aa]);x.runHook("rl-start-login-screens")}h.SimplePace&&h.SimplePace.set(100)},this))):(s.hideLoading(),s.startScreens([Aa]),x.runHook("rl-start-login-screens"),h.SimplePace&&h.SimplePace.set(100));b&&(h["rl_"+a+"_google_service"]=function(){e.data().googleActions(true);e.socialUsers()});d&&(h["rl_"+a+"_facebook_service"]=
function(){e.data().facebookActions(true);e.socialUsers()});f&&(h["rl_"+a+"_twitter_service"]=function(){e.data().twitterActions(true);e.socialUsers()});x.runHook("rl-start-screens")};e=new A;j(function(){h.setTimeout(function(){s.setBoot(e).bootstart()},10);h.setInterval(function(){wa(!wa())},6E4);i.delay(function(){h.rainloopAppData={};h.rainloopI18N={}},100)});N.keydown(c.killCtrlAandS).keyup(c.killCtrlAandS);N.unload(function(){Ya=!0});h.rl=h.rl||{};h.rl.addHook=x.addHook;h.rl.settingsGet=x.mainSettingsGet;
