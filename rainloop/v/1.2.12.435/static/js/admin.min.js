...
function ca(){H.call(this,[X,Y])}function u(){this.oLocal=this.oLink=this.oPlugins=this.oSettings=null;this.isLocalAutocomplete=!0;this.popupVisibility=d.observable(!1);this.iframe=j('<iframe style="display:none" src="javascript:;" />').appendTo("body");E.on("error",function(a){f&&(a&&a.originalEvent&&a.originalEvent.message&&-1===c.inArray(a.originalEvent.message,["Uncaught Error: Error calling method on NPObject."]))&&(c.log(""+a.originalEvent.message+" ("+a.originalEvent.filename+":"+a.originalEvent.lineno+
...
-1<F.indexOf("iphone")||-1<F.indexOf("ipod")||-1<F.indexOf("ipad");F=-1<F.indexOf("android");I=ea||F;l.Defaults={};l.Values={};l.DataImages={};l.Defaults.MessagesPerPage=25;l.Defaults.DefaultAjaxTimeout=2E4;l.Defaults.SearchAjaxTimeout=12E4;l.Defaults.SendMessageAjaxTimeout=2E5;l.Defaults.SaveMessageAjaxTimeout=2E5;l.Values.UnuseOptionValue="__UNUSE__";l.Values.GmailFolderName="[Gmail]";l.Values.ClientSideCookieIndexName="rlcsc";l.Values.ImapDefaulPort=143;l.Values.ImapDefaulSecurePort=993;l.Values.SmtpDefaulPort=
25;l.Values.SmtpDefaulSecurePort=465;l.DataImages.UserDotPic="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAC0lEQVQIW2P8DwQACgAD/il4QJ8AAAAASUVORK5CYII=";l.DataImages.TranspPic="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAC0lEQVQIW2NkAAIAAAoAAggA9GkAAAAASUVORK5CYII=";g.StorageResultType={Success:"success",Abort:"abort",Error:"error",Unload:"unload"};g.State={Empty:10,Login:20,Auth:30};g.StateType={Webmail:0,Admin:1};g.FolderType={Inbox:10,SentItems:11,
...
/^[1-9]+[0-9]*$/.test(a.toString()):!1};c.pInt=function(a){return c.isNormal(a)&&""!==a?h.parseInt(a,10):0};c.pString=function(a){return c.isNormal(a)?a+"":""};c.isNonEmptyArray=function(a){return c.isArray(a)&&0<a.length};c.exportPath=function(a,b,e){for(var q=null,a=a.split("."),e=e||h;a.length&&(q=a.shift());)!a.length&&!c.isUnd(b)?e[q]=b:e=e[q]?e[q]:e[q]={}};c.pImport=function(a,b,e){a[b]=e};c.pExport=function(a,b,e){return c.isUnd(a[b])?e:a[b]};c.encodeHtml=function(a){return c.isNormal(a)?a.toString().replace(/&/g,
"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""};c.splitPlainText=function(a,b){for(var e="",q="",d=a,f=0,g=0,b=c.isUnd(b)?100:b;d.length>b;)q=d.substring(0,b),f=q.lastIndexOf(" "),g=q.lastIndexOf("\n"),-1!==g&&(f=g),-1===f&&(f=b),e+=q.substring(0,f)+"\n",d=d.substring(f+1);return e+d};var W={};c.timeOutAction=function(a,b,e){c.isUnd(W[a])&&(W[a]=0);h.clearTimeout(W[a]);W[a]=h.setTimeout(b,e)};var la={};c.timeOutActionSecond=function(a,b,e){la[a]||
...
d.observable("");a.googleClientSecret=d.observable("");a.dropboxEnable=d.observable(!1);a.dropboxApiKey=d.observable("");a.contactsIsSupported=d.observable(!1)};c.createMomentDate=function(a){return d.computed(function(){fa();return this.moment().fromNow()},a)};c.createMomentShortDate=function(a){return d.computed(function(){var a="",a=moment(),e=this.moment(),d=this.momentDate();return a=4>=a.diff(e,"hours")?d:a.format("L")===e.format("L")?c.i18n("MESSAGE_LIST/TODAY_AT",{TIME:e.format("LT")}):a.clone().subtract("days",
...
c.windowResize()}).after("<br />").before("<br />")})}};c.removeBlockquoteSwitcher=function(a){a&&(j(a).find("blockquote.rl-bq-switcher").each(function(){j(this).removeClass("rl-bq-switcher hidden-bq")}),j(a).find(".rlBlockquoteSwitcher").each(function(){j(this).remove()}))};c.extendAsViewModel=function(a,b){b&&(b.__name=a,n.regViewModelHook(a,b),i.extend(b.prototype,t.prototype))};c.addSettingsViewModel=function(a,b,e,c,d){a.__rlSettingsData={Label:e,Template:b,Route:c,IsDefault:!!d};U.push(a)};
...
c.convertPlainTextToHtml=function(a){return a.toString().replace(/&/g,"&amp;").replace(/>/g,"&gt;").replace(/</g,"&lt;").replace(/\r/g,"").replace(/\n/g,"<br />")};c.draggeblePlace=function(){return j('<div class="draggablePlace"><span class="text"></span>&nbsp;<i class="icon-envelope icon-white"></i></div>').appendTo("#rl-hidden")};c.defautOptionsAfterRender=function(a,b){b&&!c.isUnd(b.disable)&&d.applyBindingsToNode(a,{disable:b.disable},b)};c.windowPopupKnockout=function(a,b,e,d){var f=null,g=
...
f.remote().defaultRequest(a,b,c,d,g,h)};n.settingsGet=function(a,b){var e=n.mainSettingsGet("Plugins");return(e=e&&c.isUnd(e[a])?null:e[a])?c.isUnd(e[b])?null:e[b]:null};L.supported=function(){return!0};L.prototype.set=function(a,b){var c=j.cookie(l.Values.ClientSideCookieIndexName),d=null;try{(d=null===c?null:JSON.parse(c))||(d={}),d[a]=b,j.cookie(l.Values.ClientSideCookieIndexName,JSON.stringify(d),{expires:30})}catch(f){}return d};L.prototype.get=function(a){var b=j.cookie(l.Values.ClientSideCookieIndexName),
e=null;try{e=(e=null===b?null:JSON.parse(b))&&!c.isUnd(e[a])?e[a]:null}catch(d){}return e};M.supported=function(){return!!h.localStorage};M.prototype.set=function(a,b){var c=h.localStorage[l.Values.ClientSideCookieIndexName]||null,d=null;try{(d=null===c?null:JSON.parse(c))||(d={}),d[a]=b,h.localStorage[l.Values.ClientSideCookieIndexName]=JSON.stringify(d)}catch(f){}return d};M.prototype.get=function(a){var b=h.localStorage[l.Values.ClientSideCookieIndexName]||null,e=null;try{e=(e=null===b?null:JSON.parse(b))&&
!c.isUnd(e[a])?e[a]:null}catch(d){}return e};N.prototype.oDriver=null;N.prototype.set=function(a,b){return this.oDriver?this.oDriver.set("p"+a,b):!1};N.prototype.get=function(a){return this.oDriver?this.oDriver.get("p"+a):null};na.prototype.bootstart=function(){};t.prototype.sPosition="";t.prototype.sTemplate="";t.prototype.viewModelName="";t.prototype.viewModelDom=null;t.prototype.viewModelTemplate=function(){return this.sTemplate};t.prototype.viewModelPosition=function(){return this.sPosition};
...
(this.key(""),this.activateText(""),this.activateText.isError(!1),this.activationSuccessed(!1),this.key.focus(!0))};P.prototype.validateSubscriptionKey=function(){var a=this.key();return""===a||!!/^RL[\d]+-[A-Z0-9\-]+Z$/.test(c.trim(a))};c.extendAsViewModel("AdminLoginViewModel",Q);Q.prototype.onShow=function(){s.routeOff();i.delay(i.bind(function(){this.loginFocus(!0)},this),100)};Q.prototype.onHide=function(){this.loginFocus(!1)};c.extendAsViewModel("AdminMenuViewModel",X);X.prototype.link=function(a){return"#/"+
a};c.extendAsViewModel("AdminPaneViewModel",Y);Y.prototype.logoutClick=function(){f.remote().adminLogout(function(){f.loginAndLogoutReload()})};c.addSettingsViewModel(oa,"AdminGeneral","General","general",!0);oa.prototype.onBuild=function(){var a=this;i.delay(function(){var b=c.settingsSaveHelperSimpleFunction(a.titleTrigger,a),e=c.settingsSaveHelperSimpleFunction(a.languageTrigger,a),d=c.settingsSaveHelperSimpleFunction(a.themeTrigger,a);a.title.subscribe(function(a){f.remote().saveAdminConfig(b,
...
f.reloadPluginList()};C.prototype.onPluginLoadRequest=function(a,b){g.StorageResultType.Success===a&&(b&&b.Result)&&s.showScreenPopup(O,[b.Result])};C.prototype.onPluginDisableRequest=function(a,b){g.StorageResultType.Success===a&&b&&!b.Result&&b.ErrorCode&&(g.Notification.UnsupportedPluginPackage===b.ErrorCode&&b.ErrorMessage&&""!==b.ErrorMessage?this.pluginsError(b.ErrorMessage):this.pluginsError(c.getNotification(b.ErrorCode)));f.reloadPluginList()};c.addSettingsViewModel(G,"AdminPackages","Packages",
"packages");G.prototype.onShow=function(){this.packagesError("")};G.prototype.onBuild=function(){f.reloadPackagesList()};G.prototype.requestHelper=function(a,b){var d=this;return function(q,j){if(g.StorageResultType.Success!==q||!j||!j.Result)j&&j.ErrorCode?d.packagesError(c.getNotification(j.ErrorCode)):d.packagesError(c.getNotification(b?g.Notification.CantInstallPackage:g.Notification.CantDeletePackage));i.each(f.data().packages(),function(b){b&&(a&&b.loading()&&a.file===b.file)&&(a.loading(!1),
b.loading(!1))});g.StorageResultType.Success===q&&j&&j.Result&&j.Result.Reload?h.location.reload():f.reloadPackagesList()}};G.prototype.deletePackage=function(a){a&&(a.loading(!0),f.remote().packageDelete(this.requestHelper(a,!1),a))};G.prototype.installPackage=function(a){a&&(a.loading(!0),f.remote().packageInstall(this.requestHelper(a,!0),a))};Z.prototype.populateDataOnStart=function(){var a=f.settingsGet("Languages"),b=f.settingsGet("Themes");c.isArray(a)&&this.languages(a);c.isArray(b)&&this.themes(b);
this.mainLanguage(f.settingsGet("Language"));this.mainTheme(f.settingsGet("Theme"));this.allowCustomTheme(!!f.settingsGet("AllowCustomTheme"));this.allowAdditionalAccounts(!!f.settingsGet("AllowAdditionalAccounts"));this.ignoreFolderSubscribe(!!f.settingsGet("IgnoreFolderSubscribe"));this.editorDefaultType(f.settingsGet("EditorDefaultType"));this.showImages(!!f.settingsGet("ShowImages"));this.showAnimation(!!f.settingsGet("ShowAnimation"));this.mainMessagesPerPage(f.settingsGet("MPP"));this.desktopNotifications(!!f.settingsGet("DesktopNotifications"));
...
this.twitterConsumerSecret(f.settingsGet("TwitterConsumerSecret"));this.googleEnable(!!f.settingsGet("AllowGoogleSocial"));this.googleClientID(f.settingsGet("GoogleClientID"));this.googleClientSecret(f.settingsGet("GoogleClientSecret"));this.dropboxEnable(!!f.settingsGet("AllowDropboxSocial"));this.dropboxApiKey(f.settingsGet("DropboxApiKey"));this.contactsIsSupported(!!f.settingsGet("ContactsIsSupported"))};i.extend(aa.prototype,Z.prototype);aa.prototype.populateDataOnStart=function(){Z.prototype.populateDataOnStart.call(this)};
D.prototype.oRequests={};D.prototype.defaultResponse=function(a,b,c,d,j,k){var l=function(){g.StorageResultType.Success!==c&&da&&(c=g.StorageResultType.Unload);if(g.StorageResultType.Success===c&&d&&!d.Result){if(d&&g.Notification.AuthError===d.ErrorCode&&R++,d.Logout||5<R)h.__rlah_clear&&h.__rlah_clear(),f.loginAndLogoutReload(!0)}else g.StorageResultType.Success===c&&(d&&d.Result)&&(R=0);a&&(n.runHook("ajax-default-response",[b,g.StorageResultType.Success===c?d:null,c,j,k]),a(c,g.StorageResultType.Success===
...
function(a,b){null===this.oSettings&&(this.oSettings=c.isNormal(T)?T:{});this.oSettings[a]=b};u.prototype.setTitle=function(a){a=(0<a.length?a+" - ":"")+this.settingsGet("Title")||"";a!==h.document.title&&(h.document.title=a)};u.prototype.loginAndLogoutReload=function(a,b){var d=c.pString(this.settingsGet("CustomLogoutLink")),g=!!this.settingsGet("InIframe"),a=c.isUnd(a)?!1:!!a,b=c.isUnd(b)?!1:!!b;a&&(b&&h.close)&&h.close();a&&""!==d&&h.location.href!==d?i.defer(function(){g&&h.parent?h.parent.location.href=
d:h.location.href=d}):(s.routeOff(),s.setHash(f.link().root(),!0),s.routeOff(),i.defer(function(){g&&h.parent?h.parent.location.reload():h.location.reload()}))};u.prototype.getAutocomplete=function(a,b,c){c([],a)};u.prototype.bootstart=function(){c.initOnStartOrLangChange(function(){c.initNotificationLanguage()},null);i.delay(function(){c.windowResize()},1E3)};i.extend(v.prototype,u.prototype);v.prototype.oData=null;v.prototype.oRemote=null;v.prototype.oCache=null;v.prototype.data=function(){null===
this.oData&&(this.oData=new aa);return this.oData};v.prototype.remote=function(){null===this.oRemote&&(this.oRemote=new p);return this.oRemote};v.prototype.cache=function(){null===this.oCache&&(this.oCache=new qa);return this.oCache};v.prototype.reloadDomainList=function(){f.data().domainsLoading(!0);f.remote().domainList(function(a,b){f.data().domainsLoading(!1);if(g.StorageResultType.Success===a&&b&&b.Result){var c=i.map(b.Result,function(a,b){return{name:b,disabled:d.observable(!a),deleteAccess:d.observable(!1)}},
this);f.data().domains(c)}})};v.prototype.reloadPluginList=function(){f.data().pluginsLoading(!0);f.remote().pluginList(function(a,b){f.data().pluginsLoading(!1);if(g.StorageResultType.Success===a&&b&&b.Result){var c=i.map(b.Result,function(a){return{name:a.Name,disabled:d.observable(!a.Enabled),configured:d.observable(!!a.Configured)}},this);f.data().plugins(c)}})};v.prototype.reloadPackagesList=function(){f.data().packagesLoading(!0);f.data().packagesReal(!0);f.remote().packagesList(function(a,
b){f.data().packagesLoading(!1);if(g.StorageResultType.Success===a&&b&&b.Result){f.data().packagesReal(!!b.Result.Real);f.data().packagesMainUpdatable(!!b.Result.MainUpdatable);var e=[],h={};i.each(f.data().packages(),function(a){a&&a.loading()&&(h[a.file]=a)});c.isArray(b.Result.List)&&(e=i.map(b.Result.List,function(a){a.loading=d.observable(!c.isUnd(h[a.file]));return a},this));f.data().packages(e)}else f.data().packagesReal(!1)})};v.prototype.reloadLicensing=function(a){a=c.isUnd(a)?!1:!!a;f.data().licensingProcess(!0);
f.data().licenseError("");f.remote().licensing(function(a,d){f.data().licensingProcess(!1);g.StorageResultType.Success===a&&d&&d.Result&&c.isNormal(d.Result.Expired)?(f.data().licenseValid(!0),f.data().licenseExpired(c.pInt(d.Result.Expired)),f.data().licenseError(""),f.data().licensing(!0)):d&&d.ErrorCode&&-1<c.inArray(c.pInt(d.ErrorCode),[g.Notification.LicensingServerIsUnavailable,g.Notification.LicensingExpired])?(f.data().licenseError(c.getNotification(c.pInt(d.ErrorCode))),f.data().licensing(!0)):
g.StorageResultType.Abort===a?(f.data().licenseError(c.getNotification(g.Notification.LicensingServerIsUnavailable)),f.data().licensing(!0)):f.data().licensing(!1)},a)};v.prototype.bootstart=function(){u.prototype.bootstart.call(this);f.data().populateDataOnStart();s.hideLoading();this.settingsGet("Auth")?s.startScreens([ca]):s.startScreens([ba]);h.SimplePace&&h.SimplePace.set(100)};f=new v;j(function(){h.setTimeout(function(){s.setBoot(f).bootstart()},10);h.setInterval(function(){fa(!fa())},6E4);
i.delay(function(){h.rainloopAppData={};h.rainloopI18N={}},100)});ha.addClass(I?"mobile":"no-mobile");E.keydown(c.killCtrlAandS).keyup(c.killCtrlAandS);E.unload(function(){da=!0});h.rl=h.rl||{};h.rl.addHook=n.addHook;h.rl.settingsGet=n.mainSettingsGet;h.rl.remoteRequest=n.remoteRequest;h.rl.pluginSettingsGet=n.settingsGet;h.rl.addSettingsViewModel=c.addSettingsViewModel;h.rl.createCommand=c.createCommand;h.rl.EmailModel=r;h.rl.Enums=g;h.SimplePace&&h.SimplePace.add(10)})(window,jQuery,ko,crossroads,
hasher,_);